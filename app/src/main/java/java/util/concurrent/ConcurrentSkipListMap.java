...
public class ConcurrentSkipListMap<K, V> extends AbstractMap<K, V> implements ConcurrentNavigableMap<K, V>, Cloneable, Serializable {
    ...
    private V doPut(K key, V value, boolean onlyIfAbsent) {
        ...
        while (true) {
            ...
            node = new Node(key, value, n);
            if (b2.casNext(n, node)) {
                int rnd2 = ThreadLocalRandom.nextSecondarySeed();
                if ((-2147483647 & rnd2) == 0) {
                    Index<K, V> idx3;
                    int j2;
                    int level2 = 1;
                    while (true) {
                    ...
                    if (level2 <= max2) {
                        ...
                        while (i2 <= level2) {
                            i2++;
                            idx22 = new Index(node, idx22, null);
                        }
                        idx3 = idx22;
                    } else {
                        Index<K, V> newh3;
                        int oldLevel2;
                        level2 = max2 + 1;
                        Index<K, V>[] idxs2 = new Index[(level2 + 1)];
                        i2 = 1;
                        idx22 = null;
                        while (i2 <= level2) {
                            idx3 = new Index(node, idx22, null);
                            idxs2[i2] = idx3;
                            i2++;
                            idx22 = idx3;
                        }
                        do {
                            ...
                            Index<K, V> newh22 = h2;
                            Node<K, V> oldbase2 = h2.node;
                            j2 = oldLevel2 + 1;
                            newh3 = newh22;
                            while (j2 <= level2) {
                                Index<K, V> headIndex2 = new HeadIndex(oldbase2, newh3, idxs2[j2], j2);
                                j2++;
                                newh3 = headIndex2;
                            }
                        } while (!casHead(h2, newh3));
                        h2 = newh3;
                        level2 = oldLevel2;
                        idx3 = idxs2[oldLevel2];
                    }
                    int insertionLevel2 = level2;
                    loop6:
                    while (true) {
                        j2 = h2.level;
                        Index<K, V> q2 = h2;
                        Index<K, V> r2 = h2.right;
                        Index<K, V> t2 = idx3;
                        while (q2 != null && t2 != null) {
                            if (r2 != null) {
                                Node<K, V> n22 = r2.node;
                                c = cpr(cmp, key, n22.key);
                                if (n22.value == null) {
                                    if (q2.unlink(r2)) {
                                        r2 = q2.right;
                                    }
                            ...
                            if (j2 == insertionLevel2) {
                                if (q2.link(r2, t2)) {
                                    if (t2.node.value == null) {
                                        findNode(key);
                                        break loop6;
                                    }
                                    insertionLevel2--;
                                    if (insertionLevel2 == 0) {
                                        break loop6;
                                    }
                                }
                                continue;
                            ...
                            j2--;
                            if (j2 >= insertionLevel2 && j2 < level2) {
                                t2 = t2.down;
                            }
                            q2 = q2.down;
                            r2 = q2.right;
