...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
                ...
                if (p != null) {
                    ...
                    for (Entry<?, ?> e : m.entrySet()) {
                        ...
                        if (mk != null) {
                            ...
                            if (mv != null) {
                                Object v2 = get(mk);
                                if (v2 != null && (mv == v2 || (mv.equals(v2) ^ 1) == 0)) {
                                }
                            }
                        }
                        return false;
    ...
    private final void transfer(java.util.concurrent.ConcurrentHashMap.Node<K, V>[] r55, java.util.concurrent.ConcurrentHashMap.Node<K, V>[] r56) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Unknown predecessor block by arg (r40_3 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>) in PHI: PHI: (r40_4 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>) = (r40_3 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>), (r40_5 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>) binds: {(r40_3 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>)=B:128:0x0161, (r40_5 'ln' java.util.concurrent.ConcurrentHashMap$Node<K, V>)=B:129:0x0161}
...
*/
    ...
    L_0x0016:
        r52 = 16;
    L_0x0018:
        if (r56 != 0) goto L_0x002e;
    L_0x001a:
        r6 = r44 << 1;
        r0 = new java.util.concurrent.ConcurrentHashMap.Node[r6];	 Catch:{ Throwable -> 0x0056 }
        r46 = r0;	 Catch:{ Throwable -> 0x0056 }
        r56 = r46;
        r0 = r46;
        r1 = r54;
        r1.nextTable = r0;
    ...
    L_0x00f6:
        monitor-enter(r28);
        r0 = r55;	 Catch:{ all -> 0x01fe }
        r1 = r37;	 Catch:{ all -> 0x01fe }
        r6 = tabAt(r0, r1);	 Catch:{ all -> 0x01fe }
        r0 = r28;	 Catch:{ all -> 0x01fe }
        if (r6 != r0) goto L_0x01a0;	 Catch:{ all -> 0x01fe }
    L_0x0103:
        if (r29 < 0) goto L_0x01a3;	 Catch:{ all -> 0x01fe }
    L_0x0105:
        r51 = r29 & r44;	 Catch:{ all -> 0x01fe }
        r38 = r28;	 Catch:{ all -> 0x01fe }
        r0 = r28;	 Catch:{ all -> 0x01fe }
        r0 = r0.next;	 Catch:{ all -> 0x01fe }
        r47 = r0;	 Catch:{ all -> 0x01fe }
    L_0x010f:
        if (r47 == 0) goto L_0x0128;	 Catch:{ all -> 0x01fe }
    L_0x0111:
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r6 = r0.hash;	 Catch:{ all -> 0x01fe }
        r24 = r6 & r44;	 Catch:{ all -> 0x01fe }
        r0 = r24;	 Catch:{ all -> 0x01fe }
        r1 = r51;	 Catch:{ all -> 0x01fe }
        if (r0 == r1) goto L_0x0121;	 Catch:{ all -> 0x01fe }
    L_0x011d:
        r51 = r24;	 Catch:{ all -> 0x01fe }
        r38 = r47;	 Catch:{ all -> 0x01fe }
    L_0x0121:
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r0 = r0.next;	 Catch:{ all -> 0x01fe }
        r47 = r0;	 Catch:{ all -> 0x01fe }
        goto L_0x010f;	 Catch:{ all -> 0x01fe }
    L_0x0128:
        if (r51 != 0) goto L_0x016c;	 Catch:{ all -> 0x01fe }
    L_0x012a:
        r40 = r38;	 Catch:{ all -> 0x01fe }
        r35 = 0;	 Catch:{ all -> 0x01fe }
    L_0x012e:
        r47 = r28;	 Catch:{ all -> 0x01fe }
        r36 = r35;	 Catch:{ all -> 0x01fe }
        r41 = r40;	 Catch:{ all -> 0x01fe }
    L_0x0134:
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r1 = r38;	 Catch:{ all -> 0x01fe }
        if (r0 == r1) goto L_0x0183;	 Catch:{ all -> 0x01fe }
    L_0x013a:
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r0 = r0.hash;	 Catch:{ all -> 0x01fe }
        r48 = r0;	 Catch:{ all -> 0x01fe }
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r0 = r0.key;	 Catch:{ all -> 0x01fe }
        r49 = r0;	 Catch:{ all -> 0x01fe }
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r0 = r0.val;	 Catch:{ all -> 0x01fe }
        r50 = r0;	 Catch:{ all -> 0x01fe }
        r6 = r48 & r44;	 Catch:{ all -> 0x01fe }
        if (r6 != 0) goto L_0x0171;	 Catch:{ all -> 0x01fe }
    L_0x0150:
        r40 = new java.util.concurrent.ConcurrentHashMap$Node;	 Catch:{ all -> 0x01fe }
        r0 = r40;	 Catch:{ all -> 0x01fe }
        r1 = r48;	 Catch:{ all -> 0x01fe }
        r2 = r49;	 Catch:{ all -> 0x01fe }
        r3 = r50;	 Catch:{ all -> 0x01fe }
        r4 = r41;	 Catch:{ all -> 0x01fe }
        r0.<init>(r1, r2, r3, r4);	 Catch:{ all -> 0x01fe }
        r35 = r36;	 Catch:{ all -> 0x01fe }
    L_0x0161:
        r0 = r47;	 Catch:{ all -> 0x01fe }
        r0 = r0.next;	 Catch:{ all -> 0x01fe }
        r47 = r0;	 Catch:{ all -> 0x01fe }
        r36 = r35;	 Catch:{ all -> 0x01fe }
        r41 = r40;	 Catch:{ all -> 0x01fe }
        goto L_0x0134;	 Catch:{ all -> 0x01fe }
    L_0x016c:
        r35 = r38;	 Catch:{ all -> 0x01fe }
        r40 = 0;	 Catch:{ all -> 0x01fe }
        goto L_0x012e;	 Catch:{ all -> 0x01fe }
    L_0x0171:
        r35 = new java.util.concurrent.ConcurrentHashMap$Node;	 Catch:{ all -> 0x01fe }
        r0 = r35;	 Catch:{ all -> 0x01fe }
        r1 = r48;	 Catch:{ all -> 0x01fe }
        r2 = r49;	 Catch:{ all -> 0x01fe }
        r3 = r50;	 Catch:{ all -> 0x01fe }
        r4 = r36;	 Catch:{ all -> 0x01fe }
        r0.<init>(r1, r2, r3, r4);	 Catch:{ all -> 0x01fe }
        r40 = r41;	 Catch:{ all -> 0x01fe }
        goto L_0x0161;	 Catch:{ all -> 0x01fe }
    L_0x0183:
        r0 = r56;	 Catch:{ all -> 0x01fe }
        r1 = r37;	 Catch:{ all -> 0x01fe }
        r2 = r41;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r1, r2);	 Catch:{ all -> 0x01fe }
        r6 = r37 + r44;	 Catch:{ all -> 0x01fe }
        r0 = r56;	 Catch:{ all -> 0x01fe }
        r1 = r36;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r6, r1);	 Catch:{ all -> 0x01fe }
        r0 = r55;	 Catch:{ all -> 0x01fe }
        r1 = r37;	 Catch:{ all -> 0x01fe }
        r2 = r31;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r1, r2);	 Catch:{ all -> 0x01fe }
        r23 = 1;
    L_0x01a0:
        monitor-exit(r28);
    ...
    L_0x01a3:
        r0 = r28;	 Catch:{ all -> 0x01fe }
        r6 = r0 instanceof java.util.concurrent.ConcurrentHashMap.TreeBin;	 Catch:{ all -> 0x01fe }
        if (r6 == 0) goto L_0x01a0;	 Catch:{ all -> 0x01fe }
    L_0x01a9:
        r0 = r28;	 Catch:{ all -> 0x01fe }
        r0 = (java.util.concurrent.ConcurrentHashMap.TreeBin) r0;	 Catch:{ all -> 0x01fe }
        r53 = r0;	 Catch:{ all -> 0x01fe }
        r42 = 0;	 Catch:{ all -> 0x01fe }
        r43 = 0;	 Catch:{ all -> 0x01fe }
        r33 = 0;	 Catch:{ all -> 0x01fe }
        r34 = 0;	 Catch:{ all -> 0x01fe }
        r39 = 0;	 Catch:{ all -> 0x01fe }
        r32 = 0;	 Catch:{ all -> 0x01fe }
        r0 = r53;	 Catch:{ all -> 0x01fe }
        r0 = r0.first;	 Catch:{ all -> 0x01fe }
        r26 = r0;	 Catch:{ all -> 0x01fe }
    L_0x01c1:
        if (r26 == 0) goto L_0x0217;	 Catch:{ all -> 0x01fe }
    L_0x01c3:
        r0 = r26;	 Catch:{ all -> 0x01fe }
        r0 = r0.hash;	 Catch:{ all -> 0x01fe }
        r18 = r0;	 Catch:{ all -> 0x01fe }
        r17 = new java.util.concurrent.ConcurrentHashMap$TreeNode;	 Catch:{ all -> 0x01fe }
        r0 = r26;	 Catch:{ all -> 0x01fe }
        r0 = r0.key;	 Catch:{ all -> 0x01fe }
        r19 = r0;	 Catch:{ all -> 0x01fe }
        r0 = r26;	 Catch:{ all -> 0x01fe }
        r0 = r0.val;	 Catch:{ all -> 0x01fe }
        r20 = r0;	 Catch:{ all -> 0x01fe }
        r21 = 0;	 Catch:{ all -> 0x01fe }
        r22 = 0;	 Catch:{ all -> 0x01fe }
        r17.<init>(r18, r19, r20, r21, r22);	 Catch:{ all -> 0x01fe }
        r6 = r18 & r44;	 Catch:{ all -> 0x01fe }
        if (r6 != 0) goto L_0x0201;	 Catch:{ all -> 0x01fe }
    L_0x01e2:
        r0 = r43;	 Catch:{ all -> 0x01fe }
        r1 = r17;	 Catch:{ all -> 0x01fe }
        r1.prev = r0;	 Catch:{ all -> 0x01fe }
        if (r43 != 0) goto L_0x01f7;	 Catch:{ all -> 0x01fe }
    L_0x01ea:
        r42 = r17;	 Catch:{ all -> 0x01fe }
    L_0x01ec:
        r43 = r17;	 Catch:{ all -> 0x01fe }
        r39 = r39 + 1;	 Catch:{ all -> 0x01fe }
    L_0x01f0:
        r0 = r26;	 Catch:{ all -> 0x01fe }
        r0 = r0.next;	 Catch:{ all -> 0x01fe }
        r26 = r0;	 Catch:{ all -> 0x01fe }
        goto L_0x01c1;	 Catch:{ all -> 0x01fe }
    L_0x01f7:
        r0 = r17;	 Catch:{ all -> 0x01fe }
        r1 = r43;	 Catch:{ all -> 0x01fe }
        r1.next = r0;	 Catch:{ all -> 0x01fe }
        goto L_0x01ec;
    L_0x01fe:
        r6 = move-exception;
        monitor-exit(r28);
        throw r6;
    L_0x0201:
        r0 = r34;	 Catch:{ all -> 0x01fe }
        r1 = r17;	 Catch:{ all -> 0x01fe }
        r1.prev = r0;	 Catch:{ all -> 0x01fe }
        if (r34 != 0) goto L_0x0210;	 Catch:{ all -> 0x01fe }
    L_0x0209:
        r33 = r17;	 Catch:{ all -> 0x01fe }
    L_0x020b:
        r34 = r17;	 Catch:{ all -> 0x01fe }
        r32 = r32 + 1;	 Catch:{ all -> 0x01fe }
        goto L_0x01f0;	 Catch:{ all -> 0x01fe }
    L_0x0210:
        r0 = r17;	 Catch:{ all -> 0x01fe }
        r1 = r34;	 Catch:{ all -> 0x01fe }
        r1.next = r0;	 Catch:{ all -> 0x01fe }
        goto L_0x020b;	 Catch:{ all -> 0x01fe }
    L_0x0217:
        r6 = 6;	 Catch:{ all -> 0x01fe }
        r0 = r39;	 Catch:{ all -> 0x01fe }
        if (r0 > r6) goto L_0x0248;	 Catch:{ all -> 0x01fe }
    L_0x021c:
        r40 = untreeify(r42);	 Catch:{ all -> 0x01fe }
    L_0x0220:
        r6 = 6;	 Catch:{ all -> 0x01fe }
        r0 = r32;	 Catch:{ all -> 0x01fe }
        if (r0 > r6) goto L_0x0257;	 Catch:{ all -> 0x01fe }
    L_0x0225:
        r35 = untreeify(r33);	 Catch:{ all -> 0x01fe }
    L_0x0229:
        r0 = r56;	 Catch:{ all -> 0x01fe }
        r1 = r37;	 Catch:{ all -> 0x01fe }
        r2 = r40;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r1, r2);	 Catch:{ all -> 0x01fe }
        r6 = r37 + r44;	 Catch:{ all -> 0x01fe }
        r0 = r56;	 Catch:{ all -> 0x01fe }
        r1 = r35;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r6, r1);	 Catch:{ all -> 0x01fe }
        r0 = r55;	 Catch:{ all -> 0x01fe }
        r1 = r37;	 Catch:{ all -> 0x01fe }
        r2 = r31;	 Catch:{ all -> 0x01fe }
        setTabAt(r0, r1, r2);	 Catch:{ all -> 0x01fe }
        r23 = 1;	 Catch:{ all -> 0x01fe }
        goto L_0x01a0;	 Catch:{ all -> 0x01fe }
    L_0x0248:
        if (r32 == 0) goto L_0x0254;	 Catch:{ all -> 0x01fe }
    L_0x024a:
        r40 = new java.util.concurrent.ConcurrentHashMap$TreeBin;	 Catch:{ all -> 0x01fe }
        r0 = r40;	 Catch:{ all -> 0x01fe }
        r1 = r42;	 Catch:{ all -> 0x01fe }
        r0.<init>(r1);	 Catch:{ all -> 0x01fe }
        goto L_0x0220;	 Catch:{ all -> 0x01fe }
    L_0x0254:
        r40 = r53;	 Catch:{ all -> 0x01fe }
        goto L_0x0220;	 Catch:{ all -> 0x01fe }
    L_0x0257:
        if (r39 == 0) goto L_0x0263;	 Catch:{ all -> 0x01fe }
    L_0x0259:
        r35 = new java.util.concurrent.ConcurrentHashMap$TreeBin;	 Catch:{ all -> 0x01fe }
        r0 = r35;	 Catch:{ all -> 0x01fe }
        r1 = r33;	 Catch:{ all -> 0x01fe }
        r0.<init>(r1);	 Catch:{ all -> 0x01fe }
        goto L_0x0229;
    L_0x0263:
        r35 = r53;
