...
public final class OPPO_RIL_Tx_Rx_info {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.rx_chain_0_valid == other.rx_chain_0_valid && HidlSupport.deepEquals(this.rx_chain_0, other.rx_chain_0) && this.rx_chain_1_valid == other.rx_chain_1_valid && HidlSupport.deepEquals(this.rx_chain_1, other.rx_chain_1) && this.tx_valid == other.tx_valid && HidlSupport.deepEquals(this.tx, other.tx);
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.tx_valid = _hidl_blob.getInt8(56 + _hidl_offset);
        this.tx.readEmbeddedFromParcel(parcel, _hidl_blob, 60 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<OPPO_RIL_Tx_Rx_info> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((OPPO_RIL_Tx_Rx_info) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 68));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8(56 + _hidl_offset, this.tx_valid);
        this.tx.writeEmbeddedToBlob(_hidl_blob, 60 + _hidl_offset);
    }
}
