...
public interface IHostapd extends IBase {
    public static final String kInterfaceName = "vendor.oppo.hardware.wifi.hostapd@1.0::IHostapd";

    @FunctionalInterface
    public interface getInterfaceCallback {
        void onValues(HostapdStatus hostapdStatus, IHostapdIface iHostapdIface);
    }

    @FunctionalInterface
    public interface listInterfacesCallback {
        void onValues(HostapdStatus hostapdStatus, ArrayList<String> arrayList);
    }
    ...
    public static final class Proxy implements IHostapd {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.oppo.hardware.wifi.hostapd@1.0::IHostapd]@Proxy";
            }
        }

        public void getInterface(String ifaceName, getInterfaceCallback _hidl_cb) throws RemoteException {
            ...
            try {
                ...
                _hidl_cb.onValues(_hidl_out_status, IHostapdIface.asInterface(_hidl_reply.readStrongBinder()));
            } finally {
                _hidl_reply.release();
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IHostapd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IHostapd.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList(Arrays.asList(new byte[][]{new byte[]{(byte) -110, (byte) -50, (byte) 116, (byte) -8, (byte) 24, (byte) -120, (byte) 99, (byte) -94, (byte) 106, (byte) -53, (byte) -114, (byte) 110, (byte) -107, (byte) -124, (byte) -97, (byte) -126, (byte) 101, (byte) -109, (byte) -108, (byte) 105, (byte) 96, (byte) 77, (byte) -85, (byte) 42, (byte) 110, (byte) 57, (byte) -52, (byte) -19, (byte) 53, (byte) -109, (byte) 44, (byte) 106}, new byte[]{(byte) -67, (byte) -38, (byte) -74, (byte) 24, (byte) 77, (byte) 122, (byte) 52, (byte) 109, (byte) -90, (byte) -96, (byte) 125, (byte) -64, (byte) -126, (byte) -116, (byte) -15, (byte) -102, (byte) 105, (byte) 111, (byte) 76, (byte) -86, (byte) 54, (byte) 17, (byte) -59, (byte) 31, (byte) 46, (byte) 20, (byte) 86, (byte) 90, (byte) 20, (byte) -76, (byte) 15, (byte) -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getInterface(_hidl_request.readString(), new getInterfaceCallback() {
                        public void onValues(HostapdStatus status, IHostapdIface iface) {
                ...
                case 2:
                    ...
                    listInterfaces(new listInterfacesCallback() {
                        public void onValues(HostapdStatus status, ArrayList<String> ifaces) {
                            hwParcel.writeStatus(0);
                            status.writeToParcel(hwParcel);
                            hwParcel.writeStringVector(ifaces);
                            hwParcel.send();
                        }
                    });
                    return;
    ...
    void getInterface(String str, getInterfaceCallback getinterfacecallback) throws RemoteException;
