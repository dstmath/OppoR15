...
public final class IoBridge {
    ...
    public static FileDescriptor open(String path, int flags) throws FileNotFoundException {
        try {
            ...
            FileNotFoundException ex = new FileNotFoundException("flags: " + flags + " mode: " + ((OsConstants.O_ACCMODE & flags) == OsConstants.O_RDONLY ? 0 : CollationFastLatin.LATIN_LIMIT) + " " + path + PluralRules.KEYWORD_RULE_SEPARATOR + errnoException.getMessage());
