            ...
            if (c == 'N') {
                ...
                if (i < len) {
                    ...
                    if (c == 'e' || c == 'E') {
                        int expSign2 = 1;
                        int expVal2 = 0;
                        boolean expOverflow2 = -assertionsDisabled;
                        i++;
                        switch (in.charAt(i)) {
                            case '+':
                                break;
                        ...
                        i--;
                        int expLimit2 = (nDigits2 + BIG_DECIMAL_EXPONENT) + nTrailZero;
                        if (expOverflow2 || expVal2 > expLimit2) {
                            decExp = expSign2 * expLimit2;
                        } else {
                            decExp += expSign2 * expVal2;
                        }
                    }
                }
                if (isZero) {
                ...
                ASCIIToBinaryConverter aSCIIToBinaryConverter2;
                if (isNegative) {
                    aSCIIToBinaryConverter2 = A2BC_NEGATIVE_ZERO;
                } else {
                    aSCIIToBinaryConverter2 = A2BC_POSITIVE_ZERO;
                }
                return aSCIIToBinaryConverter2;
            }
