...
class RFC3280CertPathUtilities {
    ...
    protected static java.util.Set processCRLF(java.security.cert.X509CRL r27, java.lang.Object r28, java.security.cert.X509Certificate r29, java.security.PublicKey r30, com.android.org.bouncycastle.jcajce.PKIXExtendedParameters r31, java.util.List r32, com.android.org.bouncycastle.jcajce.util.JcaJceHelper r33) throws com.android.org.bouncycastle.jce.provider.AnnotatedException {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Unknown predecessor block by arg (r17_2 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException) in PHI: PHI: (r17_3 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException) = (r17_2 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException), (r17_1 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException) binds: {(r17_2 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException)=B:66:0x0169, (r17_1 'lastException' com.android.org.bouncycastle.jce.provider.AnnotatedException)=B:67:0x0169}
...
*/
        ...
        r3.<init>();
        r25 = com.android.org.bouncycastle.jce.provider.PrincipalUtils.getIssuerPrincipal(r27);	 Catch:{ IOException -> 0x0070 }
        r15 = r25.getEncoded();	 Catch:{ IOException -> 0x0070 }
        r3.setSubject(r15);	 Catch:{ IOException -> 0x0070 }
        r25 = new com.android.org.bouncycastle.jcajce.PKIXCertStoreSelector$Builder;
        r0 = r25;
        r0.<init>(r3);
        r19 = r25.build();
        r25 = r31.getCertificateStores();	 Catch:{ AnnotatedException -> 0x007e }
        r0 = r19;	 Catch:{ AnnotatedException -> 0x007e }
        r1 = r25;	 Catch:{ AnnotatedException -> 0x007e }
        r7 = com.android.org.bouncycastle.jce.provider.CertPathValidatorUtilities.findCertificates(r0, r1);	 Catch:{ AnnotatedException -> 0x007e }
        r25 = r31.getCertStores();	 Catch:{ AnnotatedException -> 0x007e }
        r0 = r19;	 Catch:{ AnnotatedException -> 0x007e }
        r1 = r25;	 Catch:{ AnnotatedException -> 0x007e }
        r25 = com.android.org.bouncycastle.jce.provider.CertPathValidatorUtilities.findCertificates(r0, r1);	 Catch:{ AnnotatedException -> 0x007e }
        r0 = r25;	 Catch:{ AnnotatedException -> 0x007e }
        r7.addAll(r0);	 Catch:{ AnnotatedException -> 0x007e }
        r0 = r29;
        r7.add(r0);
        r4 = r7.iterator();
    ...
    L_0x0051:
        r21 = r4.next();
        r21 = (java.security.cert.X509Certificate) r21;
        r0 = r21;
        r1 = r29;
        r25 = r0.equals(r1);
    ...
    L_0x0070:
        ...
        r26 = "Subject criteria for certificate selector to find issuer certificate for CRL could not be set.";
        r0 = r25;
        r1 = r26;
        r0.<init>(r1, r9);
        throw r25;
    L_0x007e:
        r8 = move-exception;
        r25 = new com.android.org.bouncycastle.jce.provider.AnnotatedException;
        r26 = "Issuer certificate for CRL cannot be searched.";
        r0 = r25;
        r1 = r26;
        r0.<init>(r1, r8);
        throw r25;
    L_0x008c:
        r2 = new com.android.org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r2.<init>();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r22 = new java.security.cert.X509CertSelector;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r22.<init>();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r22;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r21;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0.setCertificate(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = new com.android.org.bouncycastle.jcajce.PKIXExtendedParameters$Builder;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r25;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r31;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0.<init>(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r26 = new com.android.org.bouncycastle.jcajce.PKIXCertStoreSelector$Builder;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r26;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r22;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0.<init>(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r26 = r26.build();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r18 = r25.setTargetConstraints(r26);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r32;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r21;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = r0.contains(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        if (r25 == 0) goto L_0x0107;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
    L_0x00c1:
        r25 = 0;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r18;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r25;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0.setRevocationEnabled(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
    L_0x00ca:
        r25 = new com.android.org.bouncycastle.jcajce.PKIXExtendedBuilderParameters$Builder;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r26 = r18.build();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25.<init>(r26);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r13 = r25.build();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = r2.engineBuild(r13);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = r25.getCertPath();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r5 = r25.getCertificates();	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r23;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r21;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0.add(r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = 0;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r0 = r25;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r1 = r33;	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r25 = com.android.org.bouncycastle.jce.provider.CertPathValidatorUtilities.getNextWorkingKey(r5, r0, r1);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        r24.add(r25);	 Catch:{ CertPathBuilderException -> 0x00f9, CertPathValidatorException -> 0x0111, Exception -> 0x011f }
        goto L_0x004b;
    L_0x00f9:
        r11 = move-exception;
        r25 = new com.android.org.bouncycastle.jce.provider.AnnotatedException;
        r26 = "CertPath for CRL signer failed to validate.";
        r0 = r25;
        r1 = r26;
        r0.<init>(r1, r11);
        throw r25;
    ...
    L_0x0111:
        r12 = move-exception;
        r25 = new com.android.org.bouncycastle.jce.provider.AnnotatedException;
        r26 = "Public key of issuer certificate of CRL could not be retrieved.";
        r0 = r25;
        r1 = r26;
        r0.<init>(r1, r12);
        throw r25;
    ...
    L_0x013a:
        r0 = r23;
        r20 = r0.get(r14);
        r20 = (java.security.cert.X509Certificate) r20;
        r16 = r20.getKeyUsage();
    ...
    L_0x015d:
        ...
        r25 = "Issuer certificate key usage extension does not permit CRL signing.";
        r0 = r17;
        r1 = r25;
        r0.<init>(r1);
    L_0x0169:
    ...
    L_0x0180:
        r25 = new com.android.org.bouncycastle.jce.provider.AnnotatedException;
        r26 = "Cannot find a valid issuer certificate.";
        r25.<init>(r26);
        throw r25;
    L_0x0189:
        r25 = r6.isEmpty();
    ...
    protected static Set[] processCRLA1ii(Date currentDate, PKIXExtendedParameters paramsPKIX, X509Certificate cert, X509CRL crl) throws AnnotatedException {
        ...
        try {
            ...
            PKIXCRLStoreSelector extSelect = new Builder(crlselect).setCompleteCRLEnabled(true).build();
    ...
    protected static PKIXPolicyNode processCertD(CertPath certPath, int index, Set acceptablePolicies, PKIXPolicyNode validPolicyTree, List[] policyNodes, int inhibitAnyPolicy) throws CertPathValidatorException {
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                pInfo = PolicyInformation.getInstance(e.nextElement());
                if (ANY_POLICY.equals(pInfo.getPolicyIdentifier().getId())) {
                    Set _apq2 = CertPathValidatorUtilities.getQualifierSet(pInfo.getPolicyQualifiers());
                    List _nodes2 = policyNodes[i - 1];
                    for (k = 0; k < _nodes2.size(); k++) {
                        PKIXPolicyNode _node2 = (PKIXPolicyNode) _nodes2.get(k);
                        for (String _tmp2 : _node2.getExpectedPolicies()) {
                            String _policy2;
                            if (_tmp2 instanceof String) {
                                _policy2 = _tmp2;
                            } else if (_tmp2 instanceof ASN1ObjectIdentifier) {
                                _policy2 = ((ASN1ObjectIdentifier) _tmp2).getId();
                            }
                            boolean _found2 = false;
                            Iterator _childrenIter2 = _node2.getChildren();
                            while (_childrenIter2.hasNext()) {
                                if (_policy2.equals(((PKIXPolicyNode) _childrenIter2.next()).getValidPolicy())) {
                                    _found2 = true;
                                }
                            }
                            if (!_found2) {
                                Set _newChildExpectedPolicies2 = new HashSet();
                                _newChildExpectedPolicies2.add(_policy2);
                                PKIXPolicyNode _newChild2 = new PKIXPolicyNode(new ArrayList(), i, _newChildExpectedPolicies2, _node2, _apq2, _policy2, false);
                                _node2.addChild(_newChild2);
                                policyNodes[i].add(_newChild2);
                            }
                        }
                    }
                }
            ...
            for (j = i - 1; j >= 0; j--) {
                nodes = policyNodes[j];
                for (k = 0; k < nodes.size(); k++) {
                    PKIXPolicyNode node2 = (PKIXPolicyNode) nodes.get(k);
            ...
            criticalExtensionOids = cert.getCriticalExtensionOIDs();
            if (criticalExtensionOids != null) {
                boolean critical2 = criticalExtensionOids.contains(CERTIFICATE_POLICIES);
                nodes = policyNodes[i];
                for (j = 0; j < nodes.size(); j++) {
                    ((PKIXPolicyNode) nodes.get(j)).setCritical(critical2);
                }
            }
            return _validPolicyTree;
        } catch (Throwable e2) {
