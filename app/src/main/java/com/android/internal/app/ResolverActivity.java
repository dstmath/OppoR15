...
public class ResolverActivity extends AlertActivity {
    ...
    private boolean mIsOshareOn = false;
    ...
    private IColorOshareCallback mOShareCallback = new Stub() {
        public void onDeviceChanged(List<ColorOshareDevice> deviceList) throws RemoteException {
            ...
            ResolverActivity.this.runOnUiThread(new Runnable() {
                public void run() {
                    ResolverActivity.this.updateOShareUI();
    ...
    private class ResolverOshareingAdapter extends Adapter<MyViewHolder> {
        private static final /* synthetic */ int[] -com-color-oshare-ColorOshareStateSwitchesValues = null;
        ...
        private static /* synthetic */ int[] -getcom-color-oshare-ColorOshareStateSwitchesValues() {
            if (-com-color-oshare-ColorOshareStateSwitchesValues != null) {
                return -com-color-oshare-ColorOshareStateSwitchesValues;
            }
            ...
            -com-color-oshare-ColorOshareStateSwitchesValues = iArr;
            return iArr;
        }
        ...
        private String getStateString(ColorOshareState state) {
            String stringId = "";
            switch (-getcom-color-oshare-ColorOshareStateSwitchesValues()[state.ordinal()]) {
                case 1:
            ...
            if (!this.mFromRestart || this.mResolverDialogHelper == null) {
                ...
                if (this.mIsActionSend) {
                    ...
                    this.mOpenWifiBlueToothView.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            if (ResolverActivity.this.mOShareServiceUtil != null && (ResolverActivity.this.mIsOshareOn ^ 1) != 0) {
                                ResolverActivity.this.mIsOshareOn = true;
