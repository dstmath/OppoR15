...
public class SubscriptionController extends Stub {
    ...
    static /* synthetic */ int lambda$-com_android_internal_telephony_SubscriptionController_7553(SubscriptionInfo arg0, SubscriptionInfo arg1) {
            ...
            if (isSubInfoReady()) {
                ...
                if (subList != null) {
                    for (SubscriptionInfo si : subList) {
                        ...
                        if (currentSubId != null && currentSubId.intValue() == subId) {
                            if ((SubscriptionManager.isValidSubscriptionId(currentSubId.intValue()) ^ 1) == 0) {
                            }
                        }
                        sSlotIndexToSubId.put(Integer.valueOf(slotIndex), Integer.valueOf(subId));
                        logdl("[refreshCachedActiveSubscriptionInfoList] sSlotIndexToSubId.size=" + sSlotIndexToSubId.size() + " slotIndex=" + slotIndex + " subId=" + subId);
                    }
                }
    ...
    /* synthetic */ boolean lambda$-com_android_internal_telephony_SubscriptionController_36514(String callingPackage, SubscriptionInfo subscriptionInfo) {
    ...
    public int addSubInfoRecord(java.lang.String r29, int r30) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.android.internal.telephony.SubscriptionController.addSubInfoRecord(java.lang.String, int):int, dom blocks: [B:2:0x0048, B:10:0x0086, B:19:0x00cb]
...
*/
        ...
        r5 = r5.append(r6);
        r6 = android.telephony.SubscriptionInfo.givePrintableIccid(r29);
        r5 = r5.append(r6);
        r6 = " slotIndex:";
        r5 = r5.append(r6);
        r0 = r30;
    ...
    L_0x0048:
        r5 = "[addSubInfoRecord]- null iccId";	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = -1;
        android.os.Binder.restoreCallingIdentity(r14);
        return r5;
    L_0x0055:
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r5 = r0.mContext;	 Catch:{ all -> 0x0271 }
        r4 = r5.getContentResolver();	 Catch:{ all -> 0x0271 }
        r5 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0271 }
        r6 = 3;	 Catch:{ all -> 0x0271 }
        r6 = new java.lang.String[r6];	 Catch:{ all -> 0x0271 }
        r7 = "_id";	 Catch:{ all -> 0x0271 }
        r8 = 0;	 Catch:{ all -> 0x0271 }
        r6[r8] = r7;	 Catch:{ all -> 0x0271 }
        r7 = "sim_id";	 Catch:{ all -> 0x0271 }
        r8 = 1;	 Catch:{ all -> 0x0271 }
        r6[r8] = r7;	 Catch:{ all -> 0x0271 }
        r7 = "name_source";	 Catch:{ all -> 0x0271 }
        r8 = 2;	 Catch:{ all -> 0x0271 }
        r6[r8] = r7;	 Catch:{ all -> 0x0271 }
        r7 = "icc_id=?";	 Catch:{ all -> 0x0271 }
        r8 = 1;	 Catch:{ all -> 0x0271 }
        r8 = new java.lang.String[r8];	 Catch:{ all -> 0x0271 }
        r9 = 0;	 Catch:{ all -> 0x0271 }
        r8[r9] = r29;	 Catch:{ all -> 0x0271 }
        r9 = 0;	 Catch:{ all -> 0x0271 }
        r11 = r4.query(r5, r6, r7, r8, r9);	 Catch:{ all -> 0x0271 }
        r19 = 0;
        if (r11 == 0) goto L_0x008e;
    L_0x0086:
        r5 = r11.moveToFirst();	 Catch:{ all -> 0x026a }
        r5 = r5 ^ 1;	 Catch:{ all -> 0x026a }
        if (r5 == 0) goto L_0x0207;	 Catch:{ all -> 0x026a }
    L_0x008e:
        r19 = 1;	 Catch:{ all -> 0x026a }
        r25 = r28.insertEmptySubInfoRecord(r29, r30);	 Catch:{ all -> 0x026a }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x026a }
        r5.<init>();	 Catch:{ all -> 0x026a }
        r6 = "[addSubInfoRecord] New record created: ";	 Catch:{ all -> 0x026a }
        r5 = r5.append(r6);	 Catch:{ all -> 0x026a }
        r0 = r25;	 Catch:{ all -> 0x026a }
        r5 = r5.append(r0);	 Catch:{ all -> 0x026a }
        r5 = r5.toString();	 Catch:{ all -> 0x026a }
        r0 = r28;	 Catch:{ all -> 0x026a }
        r0.logdl(r5);	 Catch:{ all -> 0x026a }
    L_0x00af:
        if (r11 == 0) goto L_0x00b4;
    L_0x00b1:
        r11.close();	 Catch:{ all -> 0x0271 }
    L_0x00b4:
        r5 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0271 }
        r7 = "sim_id=?";	 Catch:{ all -> 0x0271 }
        r6 = 1;	 Catch:{ all -> 0x0271 }
        r8 = new java.lang.String[r6];	 Catch:{ all -> 0x0271 }
        r6 = java.lang.String.valueOf(r30);	 Catch:{ all -> 0x0271 }
        r9 = 0;	 Catch:{ all -> 0x0271 }
        r8[r9] = r6;	 Catch:{ all -> 0x0271 }
        r6 = 0;	 Catch:{ all -> 0x0271 }
        r9 = 0;	 Catch:{ all -> 0x0271 }
        r11 = r4.query(r5, r6, r7, r8, r9);	 Catch:{ all -> 0x0271 }
        if (r11 == 0) goto L_0x01d4;
    L_0x00cb:
        r5 = r11.moveToFirst();	 Catch:{ all -> 0x028c }
        if (r5 == 0) goto L_0x01d4;	 Catch:{ all -> 0x028c }
    L_0x00d1:
        r5 = "_id";	 Catch:{ all -> 0x028c }
        r5 = r11.getColumnIndexOrThrow(r5);	 Catch:{ all -> 0x028c }
        r22 = r11.getInt(r5);	 Catch:{ all -> 0x028c }
        r5 = sSlotIndexToSubId;	 Catch:{ all -> 0x028c }
        r6 = java.lang.Integer.valueOf(r30);	 Catch:{ all -> 0x028c }
        r10 = r5.get(r6);	 Catch:{ all -> 0x028c }
        r10 = (java.lang.Integer) r10;	 Catch:{ all -> 0x028c }
        if (r10 == 0) goto L_0x00f2;	 Catch:{ all -> 0x028c }
    L_0x00ea:
        r5 = r10.intValue();	 Catch:{ all -> 0x028c }
        r0 = r22;	 Catch:{ all -> 0x028c }
        if (r5 == r0) goto L_0x0276;	 Catch:{ all -> 0x028c }
    L_0x00f2:
        r5 = sSlotIndexToSubId;	 Catch:{ all -> 0x028c }
        r6 = java.lang.Integer.valueOf(r30);	 Catch:{ all -> 0x028c }
        r7 = java.lang.Integer.valueOf(r22);	 Catch:{ all -> 0x028c }
        r5.put(r6, r7);	 Catch:{ all -> 0x028c }
        r23 = r28.getActiveSubInfoCountMax();	 Catch:{ all -> 0x028c }
        r12 = r28.getDefaultSubId();	 Catch:{ all -> 0x028c }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028c }
        r5.<init>();	 Catch:{ all -> 0x028c }
        r6 = "[addSubInfoRecord] sSlotIndexToSubId.size=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r6 = sSlotIndexToSubId;	 Catch:{ all -> 0x028c }
        r6 = r6.size();	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r6 = " slotIndex=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r0 = r30;	 Catch:{ all -> 0x028c }
        r5 = r5.append(r0);	 Catch:{ all -> 0x028c }
        r6 = " subId=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r0 = r22;	 Catch:{ all -> 0x028c }
        r5 = r5.append(r0);	 Catch:{ all -> 0x028c }
        r6 = " defaultSubId=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r5 = r5.append(r12);	 Catch:{ all -> 0x028c }
        r6 = " simCount=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r0 = r23;	 Catch:{ all -> 0x028c }
        r5 = r5.append(r0);	 Catch:{ all -> 0x028c }
        r5 = r5.toString();	 Catch:{ all -> 0x028c }
        r0 = r28;	 Catch:{ all -> 0x028c }
        r0.logdl(r5);	 Catch:{ all -> 0x028c }
        r5 = android.telephony.SubscriptionManager.isValidSubscriptionId(r12);	 Catch:{ all -> 0x028c }
        if (r5 == 0) goto L_0x0163;	 Catch:{ all -> 0x028c }
    L_0x015e:
        r5 = 1;	 Catch:{ all -> 0x028c }
        r0 = r23;	 Catch:{ all -> 0x028c }
        if (r0 != r5) goto L_0x0293;	 Catch:{ all -> 0x028c }
    L_0x0163:
        r0 = r28;	 Catch:{ all -> 0x028c }
        r1 = r22;	 Catch:{ all -> 0x028c }
        r0.setDefaultFallbackSubId(r1);	 Catch:{ all -> 0x028c }
    L_0x016a:
        r5 = 1;	 Catch:{ all -> 0x028c }
        r0 = r23;	 Catch:{ all -> 0x028c }
        if (r0 != r5) goto L_0x019f;	 Catch:{ all -> 0x028c }
    L_0x016f:
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028c }
        r5.<init>();	 Catch:{ all -> 0x028c }
        r6 = "[addSubInfoRecord] one sim set defaults to subId=";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r0 = r22;	 Catch:{ all -> 0x028c }
        r5 = r5.append(r0);	 Catch:{ all -> 0x028c }
        r5 = r5.toString();	 Catch:{ all -> 0x028c }
        ...
        r0 = r28;	 Catch:{ all -> 0x028c }
        r1 = r22;	 Catch:{ all -> 0x028c }
        r0.setDefaultDataSubId(r1);	 Catch:{ all -> 0x028c }
        r0 = r28;	 Catch:{ all -> 0x028c }
        r1 = r22;	 Catch:{ all -> 0x028c }
        r0.setDefaultSmsSubId(r1);	 Catch:{ all -> 0x028c }
        r0 = r28;	 Catch:{ all -> 0x028c }
        r1 = r22;	 Catch:{ all -> 0x028c }
        r0.setDefaultVoiceSubId(r1);	 Catch:{ all -> 0x028c }
    L_0x019f:
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028c }
        r5.<init>();	 Catch:{ all -> 0x028c }
        r6 = "[addSubInfoRecord] hashmap(";	 Catch:{ all -> 0x028c }
        r5 = r5.append(r6);	 Catch:{ all -> 0x028c }
        r0 = r30;	 Catch:{ all -> 0x028c }
        r5 = r5.append(r0);	 Catch:{ all -> 0x028c }
        r6 = ",";	 Catch:{ all -> 0x028c }
        ...
        r0 = r28;	 Catch:{ all -> 0x028c }
        r0.logdl(r5);	 Catch:{ all -> 0x028c }
        r5 = r11.moveToNext();	 Catch:{ all -> 0x028c }
    ...
    L_0x01d9:
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r1 = r30;	 Catch:{ all -> 0x0271 }
        r22 = r0.getSubIdUsingPhoneId(r1);	 Catch:{ all -> 0x0271 }
        r5 = android.telephony.SubscriptionManager.isValidSubscriptionId(r22);	 Catch:{ all -> 0x0271 }
        if (r5 != 0) goto L_0x029f;	 Catch:{ all -> 0x0271 }
    L_0x01e7:
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord]- getSubId failed invalid subId = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r22;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = -1;
        android.os.Binder.restoreCallingIdentity(r14);
    ...
    L_0x0207:
        r5 = 0;
        r22 = r11.getInt(r5);	 Catch:{ all -> 0x026a }
        r5 = 1;	 Catch:{ all -> 0x026a }
        r18 = r11.getInt(r5);	 Catch:{ all -> 0x026a }
        r5 = 2;	 Catch:{ all -> 0x026a }
        r16 = r11.getInt(r5);	 Catch:{ all -> 0x026a }
        r26 = new android.content.ContentValues;	 Catch:{ all -> 0x026a }
        r26.<init>();	 Catch:{ all -> 0x026a }
        r0 = r30;	 Catch:{ all -> 0x026a }
        r1 = r18;	 Catch:{ all -> 0x026a }
        if (r0 == r1) goto L_0x022d;	 Catch:{ all -> 0x026a }
    L_0x0221:
        r5 = "sim_id";	 Catch:{ all -> 0x026a }
        r6 = java.lang.Integer.valueOf(r30);	 Catch:{ all -> 0x026a }
        r0 = r26;	 Catch:{ all -> 0x026a }
        r0.put(r5, r6);	 Catch:{ all -> 0x026a }
    L_0x022d:
        r5 = 2;	 Catch:{ all -> 0x026a }
        r0 = r16;	 Catch:{ all -> 0x026a }
        if (r0 == r5) goto L_0x0234;	 Catch:{ all -> 0x026a }
    L_0x0232:
        r19 = 1;	 Catch:{ all -> 0x026a }
    L_0x0234:
        r5 = r26.size();	 Catch:{ all -> 0x026a }
        if (r5 <= 0) goto L_0x0260;	 Catch:{ all -> 0x026a }
    L_0x023a:
        r5 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x026a }
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x026a }
        r6.<init>();	 Catch:{ all -> 0x026a }
        r7 = "_id=";	 Catch:{ all -> 0x026a }
        r6 = r6.append(r7);	 Catch:{ all -> 0x026a }
        r0 = r22;	 Catch:{ all -> 0x026a }
        r8 = (long) r0;	 Catch:{ all -> 0x026a }
        r7 = java.lang.Long.toString(r8);	 Catch:{ all -> 0x026a }
        r6 = r6.append(r7);	 Catch:{ all -> 0x026a }
        r6 = r6.toString();	 Catch:{ all -> 0x026a }
        r7 = 0;	 Catch:{ all -> 0x026a }
        r0 = r26;	 Catch:{ all -> 0x026a }
        r4.update(r5, r0, r6, r7);	 Catch:{ all -> 0x026a }
        r28.refreshCachedActiveSubscriptionInfoList();	 Catch:{ all -> 0x026a }
    L_0x0260:
        r5 = "[addSubInfoRecord] Record already exists";	 Catch:{ all -> 0x026a }
        r0 = r28;	 Catch:{ all -> 0x026a }
        r0.logdl(r5);	 Catch:{ all -> 0x026a }
        goto L_0x00af;
    L_0x026a:
    ...
    L_0x0276:
        r5 = r10.intValue();	 Catch:{ all -> 0x028c }
        r5 = android.telephony.SubscriptionManager.isValidSubscriptionId(r5);	 Catch:{ all -> 0x028c }
        r5 = r5 ^ 1;	 Catch:{ all -> 0x028c }
        if (r5 != 0) goto L_0x00f2;	 Catch:{ all -> 0x028c }
    L_0x0282:
        r5 = "[addSubInfoRecord] currentSubId != null && currentSubId is valid, IGNORE";	 Catch:{ all -> 0x028c }
        r0 = r28;	 Catch:{ all -> 0x028c }
        r0.logdl(r5);	 Catch:{ all -> 0x028c }
        goto L_0x019f;
    L_0x028c:
    ...
    L_0x0293:
        r0 = r28;	 Catch:{ all -> 0x028c }
        r5 = r0.isActiveSubId(r12);	 Catch:{ all -> 0x028c }
        r5 = r5 ^ 1;
    ...
    L_0x02a1:
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r5 = r0.mTelephonyManager;	 Catch:{ all -> 0x0271 }
        r0 = r22;	 Catch:{ all -> 0x0271 }
        r20 = r5.getSimOperatorName(r0);	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r5 = r0.mTelephonyManager;	 Catch:{ all -> 0x0271 }
        r0 = r22;	 Catch:{ all -> 0x0271 }
        r13 = r5.getSubscriberId(r0);	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r1 = r22;	 Catch:{ all -> 0x0271 }
        r24 = r0.getSubState(r1);	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] subState = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r24;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] simCarrierName = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r20;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r1 = r30;	 Catch:{ all -> 0x0271 }
        r21 = r0.getSimStateForSlotIndex(r1);	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] simState = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r21;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = 6;	 Catch:{ all -> 0x0271 }
        r0 = r21;	 Catch:{ all -> 0x0271 }
        if (r0 == r5) goto L_0x031d;	 Catch:{ all -> 0x0271 }
    L_0x031b:
        if (r24 != 0) goto L_0x041f;	 Catch:{ all -> 0x0271 }
    L_0x031d:
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r5 = r0.mContext;	 Catch:{ all -> 0x0271 }
        r6 = "";	 Catch:{ all -> 0x0271 }
        r7 = "";	 Catch:{ all -> 0x0271 }
        r0 = r29;	 Catch:{ all -> 0x0271 }
        r1 = r30;	 Catch:{ all -> 0x0271 }
        r17 = getCarrierName(r5, r6, r7, r0, r1);	 Catch:{ all -> 0x0271 }
    L_0x032f:
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] nameToSet = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r17;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] carrier name = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r20;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
        r5 = "ro.oppo.version";	 Catch:{ all -> 0x0271 }
        r6 = "CN";	 Catch:{ all -> 0x0271 }
        r27 = android.os.SystemProperties.get(r5, r6);	 Catch:{ all -> 0x0271 }
        r5 = "US";	 Catch:{ all -> 0x0271 }
        r0 = r27;	 Catch:{ all -> 0x0271 }
        r5 = r0.equalsIgnoreCase(r5);	 Catch:{ all -> 0x0271 }
        if (r5 == 0) goto L_0x0382;	 Catch:{ all -> 0x0271 }
    L_0x037a:
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r1 = r30;	 Catch:{ all -> 0x0271 }
        r17 = r0.getExportSimDefaultName(r1);	 Catch:{ all -> 0x0271 }
    L_0x0382:
        r26 = new android.content.ContentValues;	 Catch:{ all -> 0x0271 }
        r26.<init>();	 Catch:{ all -> 0x0271 }
        r5 = "display_name";	 Catch:{ all -> 0x0271 }
        r0 = r26;	 Catch:{ all -> 0x0271 }
        r1 = r17;	 Catch:{ all -> 0x0271 }
        r0.put(r5, r1);	 Catch:{ all -> 0x0271 }
        r5 = "color";	 Catch:{ all -> 0x0271 }
        r6 = 0;	 Catch:{ all -> 0x0271 }
        r0 = r29;	 Catch:{ all -> 0x0271 }
        r6 = com.android.internal.telephony.OemConstant.getCardType(r6, r0);	 Catch:{ all -> 0x0271 }
        r6 = java.lang.Integer.valueOf(r6);	 Catch:{ all -> 0x0271 }
        r0 = r26;	 Catch:{ all -> 0x0271 }
        r0.put(r5, r6);	 Catch:{ all -> 0x0271 }
        r5 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0271 }
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r6.<init>();	 Catch:{ all -> 0x0271 }
        r7 = "_id=";	 Catch:{ all -> 0x0271 }
        r6 = r6.append(r7);	 Catch:{ all -> 0x0271 }
        r0 = r22;	 Catch:{ all -> 0x0271 }
        r8 = (long) r0;	 Catch:{ all -> 0x0271 }
        r7 = java.lang.Long.toString(r8);	 Catch:{ all -> 0x0271 }
        r6 = r6.append(r7);	 Catch:{ all -> 0x0271 }
        r6 = r6.toString();	 Catch:{ all -> 0x0271 }
        r7 = 0;	 Catch:{ all -> 0x0271 }
        r0 = r26;	 Catch:{ all -> 0x0271 }
        r4.update(r5, r0, r6, r7);	 Catch:{ all -> 0x0271 }
        r28.refreshCachedActiveSubscriptionInfoList();	 Catch:{ all -> 0x0271 }
        r5 = "-1";	 Catch:{ all -> 0x0271 }
        r6 = java.lang.Integer.toString(r22);	 Catch:{ all -> 0x0271 }
        r7 = "CARDTYPE";	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.broadcastSubInfoUpdateIntent(r5, r6, r7);	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord] sim name = ";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r0 = r17;	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r0);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        ...
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
    L_0x03f4:
        r5 = sPhones;	 Catch:{ all -> 0x0271 }
        r5 = r5[r30];	 Catch:{ all -> 0x0271 }
        r5.updateDataConnectionTracker();	 Catch:{ all -> 0x0271 }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0271 }
        r5.<init>();	 Catch:{ all -> 0x0271 }
        r6 = "[addSubInfoRecord]- info size=";	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r6 = sSlotIndexToSubId;	 Catch:{ all -> 0x0271 }
        r6 = r6.size();	 Catch:{ all -> 0x0271 }
        r5 = r5.append(r6);	 Catch:{ all -> 0x0271 }
        r5 = r5.toString();	 Catch:{ all -> 0x0271 }
        r0 = r28;	 Catch:{ all -> 0x0271 }
        r0.logdl(r5);	 Catch:{ all -> 0x0271 }
    ...
    L_0x041f:
        ...
        r5 = r0.mContext;	 Catch:{ all -> 0x0271 }
        r0 = r20;	 Catch:{ all -> 0x0271 }
        r1 = r29;	 Catch:{ all -> 0x0271 }
        r2 = r30;	 Catch:{ all -> 0x0271 }
        r17 = getCarrierName(r5, r0, r13, r1, r2);	 Catch:{ all -> 0x0271 }
        goto L_0x032f;
        */
    ...
    public void setDefaultSmsSubId(int subId) {
        ...
        if (isHasSoftSimCard()) {
            ...
            if (softSimSlotId > -1) {
                ...
                logdl("[setDefaultSmsSubId]- Soft sim slot id: " + softSimSlotId + "Soft sim subId: " + subIds[0]);
    ...
    public void setDefaultVoiceSubId(int subId) {
        ...
        if (isHasSoftSimCard()) {
            ...
            if (softSimSlotId > -1) {
                ...
                if (subIds == null || subIds.length <= 0) {
                    logdl("[setDefaultVoiceSubId]- getSubId failed subIds == null || length == 0 subIds=" + subIds);
                } else if (subIds[0] == subId) {
