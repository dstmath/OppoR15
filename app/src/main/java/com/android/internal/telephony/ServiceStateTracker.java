...
public class ServiceStateTracker extends Handler {
    ...
    public void updatePhoneType() {
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            if (this.mPhone.getSwitchPhoneTypeStatus()) {
                log("colin updatePhoneType  Switch Phonetype nofity oos");
                this.mPhone.setSwitchPhoneTypeStatus(false);
    ...
    protected void updateSpnDisplay() {
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            log("simNumeric = " + simNumeric);
            if (simNumeric != null) {
                if (simNumeric.equals("334020")) {
                    mSIMRecords = (SIMRecords) iccRecords;
                    if (mSIMRecords != null) {
                        log("spnDisplayCondition = " + mSIMRecords.getSpnDisplayCondition());
                        log("isRoam = " + this.mSS.getRoaming());
                        if ((mSIMRecords.getSpnDisplayCondition() & 2) != 0) {
                            log("do not satisfy the requirement of Mexico");
                        } else if ((mSIMRecords.getSpnDisplayCondition() & 1) == 1) {
                            showPlmn = true;
                            showSpn = false;
                            plmn = plmn + " " + spn;
                        } else if (this.mSS.getRoaming()) {
                            showPlmn = true;
                            showSpn = false;
                        } else {
                            showPlmn = false;
            ...
            if (showPlmn && (plmn == null || SpnOverride.MVNO_TYPE_NONE.equals(plmn))) {
                ...
                if (OppoGsmServiceStateTracker.isOperatorCheck(getSIMOperatorNumeric())) {
                    ...
                    if (mSIMRecords != null) {
                        ...
                        } else if (mSIMRecords.getEFpnnNetworkNames(1) != null) {
    ...
    private void pollStateDone() {
        ...
        if (OemConstant.EXP_VERSION && RegionLockConstant.IS_REGION_LOCK && RegionLockConstant.getRegionLockStatus() && (oppoIsTestCard() ^ 1) != 0) {
            ...
            if (TextUtils.isEmpty(plmn)) {
                ...
                if (this.mCi.getRadioState() == RadioState.RADIO_OFF && (this.oppoNeedSetRadio ^ 1) != 0) {
    ...
    protected int oppoOosDelayState() {
        ...
        } else if (inSwitchingDss || mSimState != 5) {
            if (DBG) {
    ...
    public String[] getPnnFromEons(String plmn, boolean longName) {
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            Object simOperatorNumeric = r != null ? r.getOperatorNumeric() : null;
            ...
            if (plmn == null || !(plmn.equals("50503") || plmn.equals("50502") || plmn.equals("50501"))) {
    ...
    public boolean isHPlmn(String plmn) {
        ...
        if (mccmnc == null || mccmnc.equals(SpnOverride.MVNO_TYPE_NONE)) {
            ...
            if (this.mPhone.getPhoneType() == 1 && plmn != null && mccmnc == null) {
    ...
    private void oppoSetPowerRadioOff(int phoneId) {
        ...
        this.mCi.setUiccSubscription(this.mPhone.getPhoneId(), 0, this.mPhone.getPhoneId(), 0, null);
    }
