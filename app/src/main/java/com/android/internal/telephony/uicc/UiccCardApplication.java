...
public class UiccCardApplication {
    ...
    private static /* synthetic */ int[] -getcom-android-internal-telephony-uicc-IccCardApplicationStatus$PersoSubStateSwitchesValues() {
        ...
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_NETWORK.ordinal()] = 31;
        } catch (NoSuchFieldError e19) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_NETWORK_PUK.ordinal()] = 32;
        } catch (NoSuchFieldError e20) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_NETWORK_SUBSET.ordinal()] = 33;
        } catch (NoSuchFieldError e21) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_NETWORK_SUBSET_PUK.ordinal()] = 34;
        } catch (NoSuchFieldError e22) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SERVICE_PROVIDER.ordinal()] = 35;
        } catch (NoSuchFieldError e23) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SERVICE_PROVIDER_PUK.ordinal()] = 36;
        } catch (NoSuchFieldError e24) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SIM.ordinal()] = 37;
        } catch (NoSuchFieldError e25) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SIM_PUK.ordinal()] = 38;
        } catch (NoSuchFieldError e26) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SPN.ordinal()] = 39;
        } catch (NoSuchFieldError e27) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SPN_PUK.ordinal()] = 40;
        } catch (NoSuchFieldError e28) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SP_EHPLMN.ordinal()] = 41;
        } catch (NoSuchFieldError e29) {
        }
        try {
            iArr[PersoSubState.PERSOSUBSTATE_SIM_SP_EHPLMN_PUK.ordinal()] = 42;
