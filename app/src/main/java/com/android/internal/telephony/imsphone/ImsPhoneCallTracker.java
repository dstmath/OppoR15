...
public class ImsPhoneCallTracker extends CallTracker implements ImsPullCall {
            ...
            if (intent.getAction().equals("com.android.ims.IMS_INCOMING_CALL")) {
                ...
                if (ImsPhoneCallTracker.this.mImsManager != null && ImsPhoneCallTracker.this.mServiceId >= 0) {
                    try {
                        ...
                        if (ImsPhoneCallTracker.this.mPhone != null && ImsPhoneCallTracker.this.isOemAutoAnswer(ImsPhoneCallTracker.this.mPhone.getDefaultPhone())) {
    ...
    /* synthetic */ void lambda$-com_android_internal_telephony_imsphone_ImsPhoneCallTracker_35112() {
        try {
    ...
    /* synthetic */ int lambda$-com_android_internal_telephony_imsphone_ImsPhoneCallTracker_36184() {
