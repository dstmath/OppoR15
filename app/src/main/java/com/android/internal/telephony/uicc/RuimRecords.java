...
public class RuimRecords extends IccRecords {
        ...
        public void onRecordLoaded(AsyncResult ar) {
            ...
            if (ar.exception == null) {
                ...
                if (data.length < 3) {
                    ...
                    RuimRecords.this.mIsTestCard = !RuimRecords.this.mIsTestCard ? OemConstant.isTestCard(RuimRecords.this.mContext, data[0]) : true;
    ...
    private class EfCsimImsimLoaded implements IccRecordLoaded {
        ...
        public void onRecordLoaded(AsyncResult ar) {
            ...
            PhoneFactory.getPhone(RuimRecords.this.mParentApp.getPhoneId()).oppoSetSimType(RuimRecords.this.mIsTestCard ? 2 : 1);
