...
public class SubscriptionInfoUpdater extends Handler {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case 1:
                ...
                ((TelephonyManager) mContext.getSystemService("phone")).setSimOperatorNameForPhone(slotId, "");
    ...
    private void updateCarrierServices(int slotId, String simState) {
        ...
        if (simState == "LOADED") {
            configManager.notifyConfigChangedForSubId(mPhone[slotId].getSubId());
        } else {
    ...
    protected synchronized void updateSubscriptionInfoByIccId() {
        ...
        if (mHM != null) {
            mHM.hypnusSetAction(12, RegionLockConstant.EVENT_NETWORK_LOCK_STATUS);
