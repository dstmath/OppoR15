...
public final class ColorFloatingToolbarPopup {
    ...
    /* synthetic */ void lambda$-com_android_internal_widget_ColorFloatingToolbarPopup_5455(InternalInsetsInfo info) {
    ...
    private void openOverflow() {
        ...
        final float targetLeft = (left + startLeftMargin) - ((((float) targetWidth) * startLeftMargin) / ((float) startWidth));
    ...
    /* synthetic */ void lambda$-com_android_internal_widget_ColorFloatingToolbarPopup_65010(View v) {
        if (this.mIsOverflowOpen) {
            closeOverflow();
        } else {
            openOverflow();
    ...
    private AnimationListener createOverflowAnimationListener() {
        return new AnimationListener() {
            ...
            /* synthetic */ void lambda$-com_android_internal_widget_ColorFloatingToolbarPopup$10_68393() {
                ColorFloatingToolbarPopup.this.setPanelsStatesAtRestingPosition();
                ColorFloatingToolbarPopup.this.setContentAreaAsTouchableSurface();
            }
    ...
    private void showIndicatorPanel(Rect contentRectOnScreen) {
        if (this.mMainPanel != null && this.mMainPanel.getChildCount() != 0) {
            ...
            if (this.mIndicatorPanel.getView().getParent() == null) {
                this.mIndicatorPanel.getView().setLayoutParams(new LayoutParams(-2, -2));
    ...
    private void positionIndicationPanel(Rect contentRectOnScreen) {
        ...
        this.mIndicatorPanel.getView().setLayoutParams(params);
        ViewGroup parent;
        ...
        this.mContentContainer.setLayoutParams(paramsContainer);
    }
