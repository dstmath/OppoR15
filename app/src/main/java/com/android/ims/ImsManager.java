...
public class ImsManager {
    ...
    /* synthetic */ void lambda$-com_android_ims_ImsManager_41891(int value) {
        try {
    ...
    /* synthetic */ void lambda$-com_android_ims_ImsManager_45227(int value) {
        try {
    ...
    public int open(int serviceClass, PendingIntent incomingCallPendingIntent, ImsConnectionStateListener listener) throws ImsException {
        ...
        if (incomingCallPendingIntent == null) {
            ...
            try {
                int result = this.mImsServiceProxy.startSession(incomingCallPendingIntent, new ImsRegistrationListenerBase());
    ...
    /* synthetic */ void lambda$-com_android_ims_ImsManager_89494() {
