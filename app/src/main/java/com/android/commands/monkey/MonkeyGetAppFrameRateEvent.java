...
public class MonkeyGetAppFrameRateEvent extends MonkeyEvent {
    ...
    private void writeAverageFrameRate() {
        ...
        try {
            ...
            try {
                ...
                if (writer != null) {
                    try {
                        ...
                        Log.e(TAG, "IOException " + e2222.toString());
                    }
                }
                throw th;
            }
            ...
            e2222 = e4;
            Log.w(TAG, "Can't write sdcard log file", e2222);
            if (writer != null) {
                try {
                    writer.close();
                } catch (IOException e22222) {
                    Log.e(TAG, "IOException " + e22222.toString());
                }
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (result != null) {
                    try {
                        ...
                        Logger.err.println(e2222.toString());
                        throw th;
                    }
                }
                if (process != null) {
            ...
            if (result != null) {
                try {
                    ...
                    Logger.err.println(e22222.toString());
                }
            }
            if (process != null) {
                process.destroy();
