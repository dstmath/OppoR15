...
class LaunchingTaskPositioner {
    ...
    void configure(Rect stackBounds) {
        ...
        this.mDefaultFreeformWidth = DEFAULT_FREEFORM_WIDTH * DENSITY;
        this.mDefaultFreeformHeight = DEFAULT_FREEFORM_HEIGHT * DENSITY;
        if (this.mRotation == 0 || this.mRotation == 2) {
            this.mDefaultFreeformStartX = DEFAULT_FREEFORM_X_0 * DENSITY;
            this.mDefaultFreeformStartY = DEFAULT_FREEFORM_Y_0 * DENSITY;
        } else if (this.mRotation == 1) {
            this.mDefaultFreeformStartX = DEFAULT_FREEFORM_X_90 * DENSITY;
            this.mDefaultFreeformStartY = DEFAULT_FREEFORM_Y_90 * DENSITY;
        } else if (this.mRotation == 3) {
            this.mDefaultFreeformStartX = (SCREEN_HEIGHT - this.mDefaultFreeformWidth) - (DEFAULT_FREEFORM_X_90 * DENSITY);
            this.mDefaultFreeformStartY = DEFAULT_FREEFORM_Y_90 * DENSITY;
        }
