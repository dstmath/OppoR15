    ...
    void logWindowState() {
        ...
        if (stack == null || stack.shouldBeVisible(null) == 0) {
            ...
            if (StackId.isHomeOrRecentsStack(stack.mStackId) || stack.mStackId == 1) {
                ...
                this.mWindowState = 3;
            } else if (StackId.isStaticStack(stack.mStackId) && stack.mStackId != 7) {
    ...
    private void logAppTransitionMultiEvents() {
        ...
        while (index >= 0) {
            ...
            if (type != -1) {
                ...
                builder.addTaggedData(OppoProcessManager.MSG_SUSPEND_PROCESS, Integer.valueOf(this.mCurrentTransitionDelayMs));
