...
public class OppoAamUtils {
        ...
        try {
            ...
            try {
                ...
                if (stream != null) {
                    try {
                        ...
                        Log.e(TAG, "Failed to close state FileInputStream " + e62222222);
                    }
                }
                throw th;
            }
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e622222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e6222222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e62222222222);
                }
            }
            return list;
        } catch (IOException e15) {
            e62222222222 = e15;
            Log.e(TAG, "failed IOException ", e62222222222);
            if (stream != null) {
                try {
                    stream.close();
                } catch (IOException e622222222222) {
                    Log.e(TAG, "Failed to close state FileInputStream " + e622222222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e6222222222222);
                }
            }
            return list;
        }
    ...
    private void writeToFileLocked(File file, List<String> list) {
        ...
        try {
            ...
            try {
                ...
                if (stream != null) {
                    try {
                        ...
                        Log.e(TAG, "Failed to close state FileInputStream " + e2222);
                    }
                }
                throw th;
            }
            ...
            e2222 = e4;
            Log.e(TAG, "Failed to write IOException: " + e2222);
            if (stream != null) {
                try {
                    stream.close();
                } catch (IOException e22222) {
                    Log.e(TAG, "Failed to close state FileInputStream " + e22222);
                }
            }
        }
    }
