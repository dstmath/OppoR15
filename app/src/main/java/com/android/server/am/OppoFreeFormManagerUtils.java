        ...
        try {
            ...
            try {
                ...
                if (fileInputStream != null) {
                    try {
                        ...
                        Slog.e("OppoFreeFormManagerService", "Failed to close state FileInputStream " + e2222);
                    }
                }
                throw th;
            }
            ...
            if (fileInputStream != null) {
                try {
                    ...
                    Slog.e("OppoFreeFormManagerService", "Failed to close state FileInputStream " + e22222);
                }
            }
        }
    }
