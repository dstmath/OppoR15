    ...
    private class ActStartupAccelerator {
        ...
        private Runnable mSpeepupCallbackForGame01 = new Runnable() {
            public void run() {
                ...
                if (ActStartupAccelerator.this.mHypnus != null) {
                    if (OppoAmsUtils.DEBUG_AMS) {
                        Slog.d(OppoAmsUtils.TAG, "mSpeepupCallbackForGame01");
                    }
                    ActStartupAccelerator.this.mHypnus.hypnusSetAction(12, 60000);
                }
