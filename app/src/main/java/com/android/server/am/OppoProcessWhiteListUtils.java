        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (stream != null) {
                        try {
                            ...
                            Log.e(TAG, "Failed to close state FileInputStream " + e3);
                        }
                    }
                    ...
                    if (stream != null) {
                        try {
                            ...
                            Log.e(TAG, "Failed to close state FileInputStream " + e32);
                        }
                    }
                    throw th;
                }
                ...
                if (stream != null) {
                    try {
                        ...
                        Log.e(TAG, "Failed to close state FileInputStream " + e322);
                    }
                }
                if (processWhiteList.isEmpty()) {
                    synchronized (this.mProcessWhiteListLock) {
                ...
                if (stream != null) {
                    try {
                        ...
                        Log.e(TAG, "Failed to close state FileInputStream " + e3222);
                    }
                }
                throw th;
            }
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e32222);
                }
            }
            if (processWhiteList.isEmpty()) {
                synchronized (this.mProcessWhiteListLock) {
            ...
            if (stream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e322222);
                }
            }
            if (processWhiteList.isEmpty()) {
                synchronized (this.mProcessWhiteListLock) {
