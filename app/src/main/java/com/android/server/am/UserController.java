...
final class UserController {
    ...
    /* synthetic */ void lambda$-com_android_server_am_UserController_18552(UserState uss) {
        finishUserUnlockedCompleted(uss);
    }
    ...
    int restartUser(int userId, final boolean foreground) {
        return stopUser(userId, true, new IStopUserCallback.Stub() {
            /* synthetic */ void lambda$-com_android_server_am_UserController$4_25149(int userId, boolean foreground) {
