...
public class OppoFreeFormManagerService {
    ...
    public static final String FEATURE_OPPO_FREEFORM = "oppo.freeform.support";
    ...
    public void init(ActivityManagerService ams) {
        this.mAms = ams;
        this.mSupportFreeform = this.mAms.mContext.getPackageManager().hasSystemFeature(FEATURE_OPPO_FREEFORM);
