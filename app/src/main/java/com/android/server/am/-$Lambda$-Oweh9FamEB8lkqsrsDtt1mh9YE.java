...
final /* synthetic */ class -$Lambda$-Oweh9FamEB8lkqsrsDtt1mh9YE implements Runnable {
    ...
    private final /* synthetic */ void $m$0() {
        ((BatteryStatsService) this.-$f8).lambda$-com_android_server_am_BatteryStatsService_35112(this.-$f0, this.-$f1, this.-$f2, this.-$f3, this.-$f4, this.-$f5, this.-$f6, this.-$f7);
    }

    private final /* synthetic */ void $m$1() {
        ((BatteryStatsService) this.-$f8).lambda$-com_android_server_am_BatteryStatsService_33725(this.-$f0, this.-$f1, this.-$f2, this.-$f3, this.-$f4, this.-$f5, this.-$f6, this.-$f7);
    }
