    ...
    void findTaskLocked(ActivityRecord target, FindTaskResult result) {
        ...
        for (int taskNdx = this.mTaskHistory.size() - 1; taskNdx >= 0; taskNdx--) {
            ...
            if (task.voiceSession != null) {
                ...
                if ((task != null && OppoMultiAppManagerUtil.getInstance().isMultiApp(task.affinity)) || (r != null && OppoMultiAppManagerUtil.getInstance().isMultiApp(r.packageName))) {
                    isSkip = false;
                }
...
*/
            ...
            int shouldBeVisible(ActivityRecord starting) {
                ...
                if (this.mStackId == 3) {
                    if (topStack.isAssistantStack()) {
                        ...
                        return i;
                    } else if (topStack.mStackId == 1 && topStack.mFullscreen && topStack.mBounds == null) {
                        return 0;
                    } else {
                        return 1;
                    }
                    ...
                    if (topStackId == 3 || StackId.isAlwaysOnTop(topStackId) || topStackId == 7 || topStackId == 2) {
                    ...
                    if (StackId.isBackdropToTranslucentActivity(topStackId) && topStack.isStackTranslucent(starting, stackBehindTopId)) {
                        ...
                        if (stackBehindTopIndex >= 0 && ((stackBehindTopId == 3 || stackBehindTopId == 4 || stackBehindTopId == 7) && stackIndex == stackBehindTopIndex - 1)) {
                            return 1;
                        }
                    }
            ...
            boolean checkKeyguardVisibility(ActivityRecord r, boolean shouldBeVisible, boolean isTop) {
                ...
                if (!this.mClosedSuperFirewall && this.mService.mFinishWhenLockedState == 2) {
                ...
                if (keyguardShowing) {
                    if (!(this.mClosedSuperFirewall || !r.visible || r.realActivity == null || r.realActivity.getClassName() == null || (r.realActivity.getClassName().contains(ActivityRecord.COLOROS_RECENTS_PACKAGE_NAME) ^ 1) == 0 || r.packageName == null)) {
                        if (r.packageName.equals("com.oppo.reader") || r.packageName.equals("com.et.market") || r.packageName.equals("com.appon.worldofcricket") || r.packageName.equals("jp.shopping7net.shopapp_7net") || r.packageName.equals("com.balaji.alt")) {
                            i = 1;
                        } else {
                            i = r.packageName.equals("com.tencent.ig");
                        }
                        if ((i ^ 1) != 0) {
                            return true;
                        }
                    ...
                    if (!this.mClosedSuperFirewall && isTop && r.visible && (r.shortComponentName.equals("com.coloros.alarmclock/.AlarmClock") || r.shortComponentName.equals("com.android.calculator2/.Calculator") || r.shortComponentName.equals("com.oppo.camera/.Camera"))) {
                        return true;
                    }
                    if (shouldBeVisible) {
            ...
            public void makeInvisible(ActivityRecord r) {
                if (r.visible) {
                    if (ActivityManagerDebugConfig.DEBUG_VISIBILITY) {
            ...
            final boolean finishActivityLocked(ActivityRecord r, int resultCode, Intent resultData, String reason, boolean oomAdj, boolean pauseImmediately) {
                ...
                int transit;
                ActivityRecord top = topRunningActivityLocked();
                if (!(r.shortComponentName.equals("com.oppo.camera/.Camera") || r.shortComponentName.equals("com.android.calculator2/.Calculator") || r.shortComponentName.equals("com.tencent.mobileqq/.activity.QQLSActivity"))) {
                    ...
                    if (!r.shortComponentName.equals("com.coloros.alarmclock/.AlarmClock")) {
                        if (!r.shortComponentName.equals("com.coloros.speechassist/.Main")) {
                            if (!top.shortComponentName.contains("com.android.settings/.ChooseLock")) {
                            }
                            if (!r.shortComponentName.equals("com.coloros.alarmclock/.timer.TimerAlertFullScreen")) {
                                if (!r.shortComponentName.equals("com.coloros.pictorial/.ui.PictorialDetailsActivity")) {
                                    if (!r.shortComponentName.equals("com.coloros.alarmclock/.alert.AlarmAlertFullScreen")) {
                                        if (!top.shortComponentName.equals("com.android.incallui/.OppoInCallActivity")) {
                                        }
                                        ...
                                        topTaskNdx = this.mTaskHistory.size() - 1;
                                        if (r.frontOfTask && task.isOverHomeStack() && taskNdx < topTaskNdx) {
                                            nextTask = (TaskRecord) this.mTaskHistory.get(taskNdx + 1);
                                        ...
                                        endTask = index > 0 ? task.isClearingToReuseTask() ^ 1 : 0;
                                        transit = endTask == 0 ? 9 : 7;
                ...
                try {
                    ...
                    if (this.mResumedActivity == r) {
                        ...
                        boolean removedActivity2 = finishCurrentActivityLocked(r, finishMode2, oomAdj) == null;
                        if (task.onlyHasTaskOverlayActivities(true)) {
                            for (ActivityRecord taskOverlay2 : task.mActivities) {
                                if (taskOverlay2.mTaskOverlay) {
                                    prepareActivityHideTransitionAnimation(taskOverlay2, transit);
                                }
                            }
                        }
                        this.mWindowManager.continueSurfaceLayout();
                        return removedActivity2;
                    } else if (ActivityManagerDebugConfig.DEBUG_PAUSE) {
                        Slog.v(TAG_PAUSE, "Finish waiting for pause of: " + r);
                    }
                    this.mWindowManager.continueSurfaceLayout();
            ...
            final ActivityRecord finishCurrentActivityLocked(ActivityRecord r, int mode, boolean oomAdj) {
                ...
                if (mode != 2 || (!(r.visible || r.nowVisible) || next == null || (next.nowVisible && (next.fullscreen ^ 1) == 0))) {
                    ...
                    if (mode == 0 || ((prevState == ActivityState.PAUSED && (mode == 1 || this.mStackId == 4 || this.mStackId == 7)) || finishingActivityInNonFocusedStack || prevState == ActivityState.STOPPING || prevState == ActivityState.STOPPED || prevState == ActivityState.INITIALIZING)) {
                        r.makeFinishingLocked();
            ...
            final boolean moveTaskToBackLocked(int taskId) {
                ...
                if (tr.affinity != null && (tr.affinity.equals("com.android.incallui") || tr.affinity.equals("com.coloros.speechassist"))) {
                    hideAppSurfaceUntilKeyguardAppears();
                }
                    ...
                    if (task.isOverHomeStack()) {
                        if (task.topRunningActivityLocked() != null) {
                            ...
                            if (prevIsHome && ((task != tr || !canGoHome) && (numTasks > 1 || !isOnHomeDisplay()))) {
                                if (!(this.mFullscreen || this.mStackId != 1 || this.mStackSupervisor.getStack(3, false, false) == null || this.mStackSupervisor.mFocusedStack == null)) {
                                ...
                                if (this.mStackId == 2) {
                                    ...
                                    return true;
                                } else if (this.mFullscreen || this.mStackSupervisor.getStack(3, false, false) == null) {
                ...
                if (this.mStackId == 2) {
                    startPausingLocked(false, false, null, true, "exit-freeform");
                    this.mStackSupervisor.moveTasksToFullscreenStackLocked(2, false);
                    ActivityStack focusCandidate2 = this.mStackSupervisor.getNextFocusableStackLocked(this);
                    this.mStackSupervisor.setFocusStackUnchecked("moveTaskToFullLocked", focusCandidate2);
                    this.mStackSupervisor.resumeFocusedStackTopActivityLocked();
                    if (ActivityManagerDebugConfig.DEBUG_FOCUS) {
                        Slog.v(TAG, "oppo freeform: focusCandidate==" + focusCandidate2);
                    }
                    return true;
                } else if (this.mFullscreen || this.mStackSupervisor.getStack(3, false, false) == null) {
                    boolean resumedHome2 = this.mStackSupervisor.resumeHomeStackTask(null, "moveTaskToBack");
                    this.mWindowManager.setLockOrientation(false);
                    return resumedHome2;
                } else {
                    if (this.mService.getGlobalConfiguration() != null && this.mService.getGlobalConfiguration().orientation == 1) {
            ...
            void hideAppSurfaceUntilKeyguardAppears() {
                if (this.mStackSupervisor.mKeyguardController.isKeyguardLocked()) {
                    ...
                    this.mService.mHandler.sendMessageDelayed(this.mService.mHandler.obtainMessage(420), 300);
                }
            }
        }
