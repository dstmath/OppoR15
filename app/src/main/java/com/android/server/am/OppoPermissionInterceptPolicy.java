...
public class OppoPermissionInterceptPolicy {
    ...
    private static volatile boolean sIsPermissionInterceptEnabled = SystemProperties.getBoolean(KEY_PERMISSION_PROPERTIES, SystemProperties.getBoolean(KEY_CTSVERSION_PROPERTIES, false) ^ 1);
                ...
                synchronized (OppoPermissionInterceptPolicy.this) {
                    ...
                    if (pkgPm != null) {
                        ...
                        if (this.mPermission.equals(OppoPermissionConstants.PERMISSION_SEND_SMS) && (pkgPm.mReject & mask) == 0) {
                            if (OppoPermissionInterceptPolicy.sIsExVersion && (pkgPm.mAccept & mask) != 0 && OppoPermissionInterceptPolicy.isDefaultMmsRegion(OppoPermissionInterceptPolicy.this.mContext)) {
                            ...
                            if (OppoPermissionInterceptPolicy.sPermissionCheckMsgList.size() >= 1) {
                                ...
                                if (pcm != null) {
                                    ...
                                    if ((OppoPermissionInterceptPolicy.this.mKeyguardManager != null && OppoPermissionInterceptPolicy.this.mKeyguardManager.inKeyguardRestrictedInputMode()) || (isScreenOn ^ 1) != 0) {
                                        ...
                                        if (currentFocus.equals("com.android.systemui") || currentFocus.equals(OppoPermissionInterceptPolicy.PERMISSION_PACKGE_NAME) || currentFocus.equals(pcm.mPr.info.packageName) || (isScreenOn ^ 1) != 0) {
