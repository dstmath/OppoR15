...
public final class JobSchedulerService extends SystemService implements StateChangedListener, JobCompletedListener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.PACKAGE_CHANGED".equals(action)) {
                ...
                if (!(doCancel || pkgUid == 1000)) {
                    ...
                    if (JobSchedulerService.this.mJobs.countJobsForUid(pkgUid) > 100) {
    ...
    static /* synthetic */ int lambda$-com_android_server_job_JobSchedulerService_24882(JobStatus o1, JobStatus o2) {
    ...
    /* synthetic */ void lambda$-com_android_server_job_JobSchedulerService_52414() {
    ...
    void dumpInternal(PrintWriter pw, String[] args) {
        ...
        if (!ArrayUtils.isEmpty(args)) {
            ...
            if (opti < args.length) {
                String pkg2 = args[opti];
                try {
                    filterUid = getContext().getPackageManager().getPackageUid(pkg2, DumpState.DUMP_CHANGES);
                } catch (NameNotFoundException e2) {
                    pw.println("Invalid package: " + pkg2);
                    return;
                }
            }
        }
            ...
            try {
                ...
                if (reader != null) {
                    try {
                        ...
                        Slog.e(TAG, "readStrFromFile io close exception :" + e1222.getMessage());
                    }
                }
                throw th;
            }
