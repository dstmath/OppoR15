...
public class AccessibilityShortcutController {
    ...
    /* synthetic */ void lambda$-com_android_server_policy_AccessibilityShortcutController_10031(int userId, DialogInterface d, int which) {
        Secure.putStringForUser(this.mContext.getContentResolver(), "accessibility_shortcut_target_service", "", userId);
    }

    /* synthetic */ void lambda$-com_android_server_policy_AccessibilityShortcutController_10363(int userId, DialogInterface d) {
