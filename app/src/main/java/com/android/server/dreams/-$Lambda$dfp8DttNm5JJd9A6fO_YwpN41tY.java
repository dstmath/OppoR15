...
final /* synthetic */ class -$Lambda$dfp8DttNm5JJd9A6fO_YwpN41tY implements Runnable {
    ...
    private final /* synthetic */ void $m$0() {
        ((DreamManagerService) this.-$f3).lambda$-com_android_server_dreams_DreamManagerService_16642((Binder) this.-$f4, (ComponentName) this.-$f5, this.-$f0, this.-$f1, this.-$f2, (WakeLock) this.-$f6);
    }
