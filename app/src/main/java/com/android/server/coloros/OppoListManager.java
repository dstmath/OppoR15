    ...
    public ArrayList<String> getOppoTestToolList(Context context) {
        ...
        if (pkgList != null) {
            for (String pkg : pkgList) {
                if (pkg != null && pkg.startsWith("com.oppo.autotest.")) {
                    tempList.add(pkg);
                }
            }
        }
        ...
        try {
            ...
            try {
                ...
                if (fileInputStream != null) {
                    try {
                        ...
                        Log.e(TAG, "Failed to close state FileInputStream " + e522222);
                    }
                }
                throw th;
            }
            ...
            if (fileInputStream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e5222222);
                }
            }
            ...
            if (fileInputStream != null) {
                try {
                    ...
                    Log.e(TAG, "Failed to close state FileInputStream " + e52222222);
                }
            }
        } catch (IOException e11) {
            e52222222 = e11;
            Log.e(TAG, "failed IOException ", e52222222);
            if (fileInputStream != null) {
                try {
                    fileInputStream.close();
                } catch (IOException e522222222) {
                    Log.e(TAG, "Failed to close state FileInputStream " + e522222222);
                }
            }
        }
    }
