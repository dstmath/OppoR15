...
public class FaceRecognition implements IPreviewCallback {
    private static final /* synthetic */ int[] -android-hardware-face-ClientModeSwitchesValues = null;
    ...
    private static final int TIME_OUT_OF_FACE_FILTER = 200;
    ...
    private final IBiometricsFaceClientCallback mDaemonCallback = new Stub() {
        ...
        public void onFilterFailedAcquired(long devId, int acquiredInfo) {
            ...
            if (!(FaceRecognition.this.mAuthPreviewStartTime == 0 || SystemClock.uptimeMillis() - FaceRecognition.this.mAuthPreviewStartTime <= 200 || (FaceRecognition.this.mHasUnblockScreenOn ^ 1) == 0)) {
    ...
    private static /* synthetic */ int[] -getandroid-hardware-face-ClientModeSwitchesValues() {
        if (-android-hardware-face-ClientModeSwitchesValues != null) {
            return -android-hardware-face-ClientModeSwitchesValues;
        }
        ...
        -android-hardware-face-ClientModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private long getTimeoutForNextRecognition(ClientMode mode) {
        switch (-getandroid-hardware-face-ClientModeSwitchesValues()[mode.ordinal()]) {
            case 1:
                return 0;
            case 2:
