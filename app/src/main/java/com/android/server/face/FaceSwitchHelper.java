                ...
                try {
                    ...
                    try {
                        ...
                        if (strReader != null) {
                            try {
                                ...
                                FaceSwitchHelper.this.log("Got execption close permReader.", e32222);
                            }
                        }
                        throw th;
                    }
                    ...
                    if (strReader != null) {
                        try {
                            ...
                            FaceSwitchHelper.this.log("Got execption close permReader.", e322222);
                        }
                    }
                    this.mISwitchUpdateListener.onFaceSwitchUpdate();
                } catch (IOException e7) {
                    e322222 = e7;
                    FaceSwitchHelper.this.log("Got execption parsing permissions.", e322222);
                    if (strReader != null) {
                        try {
                            strReader.close();
                        } catch (IOException e3222222) {
                            FaceSwitchHelper.this.log("Got execption close permReader.", e3222222);
                        }
                    }
                    this.mISwitchUpdateListener.onFaceSwitchUpdate();
                }
