...
public class StatusBarManagerService extends Stub {
    ...
    /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_25681() {
    ...
    static /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_27798(boolean safeMode) {
        if (safeMode) {
