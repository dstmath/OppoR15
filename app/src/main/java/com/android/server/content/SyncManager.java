...
public class SyncManager {
    ...
    class SyncHandler extends Handler {
        ...
        private void updateRunningAccountsH(EndPoint syncTargets) {
            ...
            AccountAndUser[] -get15 = SyncManager.this.mRunningAccounts;
            int i = 0;
            int length = -get15.length;
            while (i < length) {
                AccountAndUser aau = -get15[i];
        ...
        /* synthetic */ void lambda$-com_android_server_content_SyncManager$SyncHandler_138289(EndPoint target, long pollFrequency, long flex, Bundle extras, Bundle result) {
        ...
        private boolean dispatchSyncOperation(SyncOperation op) {
            ...
            if (OppoAbnormalAppManager.getInstance().isScreenOffRestrictApp(pkgName)) {
                ...
                return false;
            } else if (!SyncManager.this.mColorOsLowPowerModeEnabled.get() || op == null || op.reason != -4 || targetUid < 10000 || (SyncManager.this.mTopPkg.equals(pkgName) ^ 1) == 0) {
    ...
    /* synthetic */ void lambda$-com_android_server_content_SyncManager_28501(Account account, int uid) {
    ...
    /* synthetic */ void lambda$-com_android_server_content_SyncManager_45398(AccountAndUser account, int userId, int reason, String authority, Bundle finalExtras, int targetSyncState, long minDelayMillis, Bundle result) {
        if (result != null) {
    ...
    static /* synthetic */ int lambda$-com_android_server_content_SyncManager_83161(SyncOperation op1, SyncOperation op2) {
    ...
    static /* synthetic */ int lambda$-com_android_server_content_SyncManager_84215(SyncOperation op1, SyncOperation op2) {
