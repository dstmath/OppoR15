...
public class OppoAlarmManagerHelper {
    ...
    private static final List<String> REMOVE_FILTER_LIST_NOT_COVERED = Arrays.asList(new String[]{"com.coloros.weather.service", "com.android.providers.media", "com.coloros.childrenspace", "com.coloros.sauhelper", "com.nearme.instant.platform", "com.coloros.athena"});
        ...
        try {
            ...
            if (xmlReader2 != null) {
                try {
                    ...
                    Log.w(TAG, "getDataFromLocal: Got execption close xmlReader. ", e3222);
                }
            }
            xmlReader = xmlReader2;
        } catch (Exception e4) {
            ...
            if (xmlReader != null) {
                try {
                    ...
                    Log.w(TAG, "getDataFromLocal: Got execption close xmlReader. ", e32222);
                }
            }
        }
    }
