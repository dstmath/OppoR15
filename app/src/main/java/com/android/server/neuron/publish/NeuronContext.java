...
public final class NeuronContext {
    ...
    public static final class NeoConfig {
        ...
        private int mGpsUpdatePeriod = 300000;
        private int mRssiUpdatePeriod = OppoArpPeer.ARP_DUP_RESPONSE_TIMEOUT;
        private int mSensorUpdatePeriod = 300000;

        private boolean checkPeriod(int period) {
            return period >= 60000 && period <= MAX_PERIOD;
        }
