...
public class OppoBrightUtils {
    ...
    public static final String HIGH_BRIGHTNESS_NODE = "/sys/class/graphics/fb0/hbm";
    ...
    public static final String OUTDOOR_BL_NODE = "/sys/devices/virtual/graphics/fb0/outdoorbl";
    ...
    public void configAutoBrightness() {
        ...
        if (3 == mBrightnessBitsConfig) {
            ...
            DisplayPowerController.BRIGHTNESS_RAMP_RATE_SLOW = 320;
    ...
    public int caclurateRateForIndex(float lux, int originBrightness, int targetBrightness) {
        ...
        if (3 == mBrightnessBitsConfig) {
            if (targetBrightness >= originBrightness) {
                rate = Math.round(((150.0f * lux) + 809850.0f) / 9000.0f);
