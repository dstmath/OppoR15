...
final class WifiDisplayController implements Dump {
    ...
    private void connect(WifiP2pDevice device) {
        ...
        if (this.mConnectedDevice != null && (this.mConnectedDevice.deviceAddress.equals(device.deviceAddress) ^ 1) != 0 && this.mDesiredDevice == null) {
            return;
        }
        if (this.mWfdEnabled) {
        ...
        if ((this.mRemoteDisplay != null || this.mExtRemoteDisplay != null) && this.mConnectedDevice != this.mDesiredDevice) {
            ...
            if (this.mConnectedDevice != null && this.mConnectedDevice != this.mDesiredDevice) {
                ...
                if (this.mConnectingDevice != null && (this.mConnectingDevice.equals(this.mDesiredDevice) ^ 1) != 0) {
                    ...
                    if (this.mConnectedDevice != null && this.mRemoteDisplay == null && this.mExtRemoteDisplay == null) {
    ...
    private WifiDisplaySessionInfo getSessionInfo(WifiP2pGroup info, int session) {
        ...
        return new WifiDisplaySessionInfo(equals, session, str, passphrase, hostAddress);
    }
