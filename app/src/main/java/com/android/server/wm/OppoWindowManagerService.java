...
public class OppoWindowManagerService extends WindowManagerService {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_OppoWindowManagerService_15013(int uid, ArrayList windows, WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_OppoWindowManagerService_17035(ArrayList mWaitingToRemove, WindowState w) {
    ...
    public void disableKeyguard(IBinder token, String tag) {
        ...
        } else if (this.mContext.getPackageManager().isFullFunctionMode() || (isSystemApp(Binder.getCallingUid()) ^ 1) == 0) {
    ...
    public Rect getFloatWindowRect(int displayId) {
        ...
        synchronized (this.mWindowMap) {
            try {
                ...
                r = new Rect();
                if (dc != null) {
                    WindowState win = dc.getWindow(-$Lambda$6vWlz1P88lMkMG4g2BvX9ZYCNN0.$INST$4);
                    if (win != null) {
                        r = win.mVisibleFrame;
                    }
                }
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_OppoWindowManagerService_23016(WindowState w) {
