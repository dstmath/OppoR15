...
public class ColorLongshotWindowCompatible {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_ColorLongshotWindowCompatible_2048(WindowTraversalListener listener, DisplayMetrics dispMetrics, DisplayMetrics realMetrics, int statusbarHeight, WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_ColorLongshotWindowCompatible_5973(int type, WindowState w) {
