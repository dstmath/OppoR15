...
final /* synthetic */ class -$Lambda$eBBEuGZ8VbEXJy0r5EYYbvnl-8w implements Consumer {
    ...
    final /* synthetic */ class AnonymousClass1 implements Runnable {
        ...
        private final /* synthetic */ void $m$0() {
            WindowManagerService.sInstance = new OppoWindowManagerService((Context) this.-$f3, (InputManagerService) this.-$f4, this.-$f0, this.-$f1, this.-$f2, (WindowManagerPolicy) this.-$f5);
        }
