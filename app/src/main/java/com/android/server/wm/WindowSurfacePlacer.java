...
class WindowSurfacePlacer {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_WindowSurfacePlacer_5868() {
    ...
    private void handleClosingApps(int transit, LayoutParams animLp, boolean voiceInteraction, LayerAndToken layerAndToken) {
        ...
        if (this.mService.mOpeningApps.size() > 0 && appsCount > 0) {
            OppoAppTransition.setAppWindowTokenLocked((AppWindowToken) this.mService.mClosingApps.valueAt(0), (AppWindowToken) this.mService.mOpeningApps.valueAt(0));
        }
