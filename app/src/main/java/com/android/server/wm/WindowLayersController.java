...
class WindowLayersController {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_WindowLayersController_4322(WindowState w) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_WindowLayersController_6502(WindowState w) {
    ...
    private void collectSpecialWindows(WindowState w) {
        ...
        if (mAdjustLauncherLayer && w.mHasSurface && (w.mIsImWindow ^ 1) != 0 && w.mWinAnimator != null && w.mWinAnimator.getShown()) {
            ...
            } else if (w.getOwningPackage() != null && w.getOwningPackage().contains(ActivityManagerService.OPPO_LAUNCHER)) {
                this.mLanucherWin = w;
