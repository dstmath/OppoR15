...
public class AppWindowContainerController extends WindowContainerController<AppWindowToken, AppWindowContainerListener> {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_AppWindowContainerController_4331() {
        if (this.mListener != null) {
            ((AppWindowContainerListener) this.mListener).onWindowsVisible();
        }
    }

    /* synthetic */ void lambda$-com_android_server_wm_AppWindowContainerController_4622() {
        if (this.mListener != null) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_AppWindowContainerController_4911() {
    ...
    public void setOrientationOnly(int requestedOrientation) {
        synchronized (this.mWindowMap) {
            try {
                WindowManagerService.boostPriorityForLockedSection();
                if (this.mContainer == null) {
            ...
            try {
                ...
                if (this.mContainer == null) {
                    ...
                    if (visible || !wtoken.hiddenRequested) {
                        if (WindowManagerDebugConfig.DEBUG_APP_TRANSITIONS || WindowManagerDebugConfig.DEBUG_ORIENTATION || WindowManagerService.DEBUG_WMS) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_AppWindowContainerController_33663(StartingSurface surface) {
        if (WindowManagerDebugConfig.DEBUG_STARTING_WINDOW) {
