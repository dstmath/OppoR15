...
class AppWindowToken extends WindowToken implements AppFreezeListener {
    ...
    int getOrientation(int candidate) {
        ...
        if (this.mOrientation != 1 || this.token == null || this.token.toString() == null || !this.token.toString().contains("com.tencent.connect.common.AssistActivity")) {
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_AppWindowToken_71641(WindowState w) {
        boolean z = false;
