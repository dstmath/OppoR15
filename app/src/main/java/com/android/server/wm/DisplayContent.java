...
import com.oppo.roundcorner.OppoRoundConerWindowManager;
...
class DisplayContent extends WindowContainer<DisplayChildWindowContainer> {
    ...
    private final class NonAppWindowContainers extends DisplayChildWindowContainer<WindowToken> {
        private final Predicate<WindowState> mGetOrientingWindow = -$Lambda$6vWlz1P88lMkMG4g2BvX9ZYCNN0.$INST$0;
        private final String mName;
        private final Comparator<WindowToken> mWindowComparator = new -$Lambda$LEqle-ue9vesHjZva-SwvAvwBx8((byte) 0, this);

        /* synthetic */ int lambda$-com_android_server_wm_DisplayContent$NonAppWindowContainers_176921(WindowToken token1, WindowToken token2) {
        ...
        static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent$NonAppWindowContainers_177360(WindowState w) {
    ...
    private final class TaskStackContainers extends DisplayChildWindowContainer<TaskStack> {
        ...
        void positionChildAt(int position, TaskStack child, boolean includingParents) {
            if (!(position == Integer.MIN_VALUE || child == null || child.mStackId != 7)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_17516(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_20420(WindowState w) {
        WindowStateAnimator winAnimator = w.mWinAnimator;
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_22369(WindowState w) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_22865(WindowState w) {
        ...
        if (isPreloadStack(w) || !w.canReceiveKeys()) {
            return false;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_25908(WindowState w) {
        boolean gone;
            ...
            if (w != null && w.toString().contains("VColorFullScreenDisplay")) {
                ...
                if (w.isDisplayCompat() && (DumpState.DUMP_FROZEN & fl) == 0 && (w.isInMultiWindowMode() ^ 1) != 0) {
                    ...
                    if (this.mService.mPolicy.getTopFullscreenOpaqueWindowState() == w) {
                        int contains = this.mService.mCurrentFocus != null ? !this.mService.mCurrentFocus.toString().contains("ChooserActivity") ? this.mService.mCurrentFocus.toString().contains("ResolverActivity") : 1 : 0;
                        if ((contains ^ 1) != 0) {
                            msg = Message.obtain();
                ...
                if (this.mRotation == 2 || this.mRotation == 0) {
                    ...
                    if (w.toString() != null && ((w.toString().contains("com.ku6.kankan.view.activity.DetailVideoPlayerActivity") || w.toString().contains("com.tencent.mm.plugin.voip.ui.VideoActivity")) && w.isDisplayNonImmersive())) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_38474(WindowState w) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_42213(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_42498(WindowState w) {
        this.mService.mPolicy.applyPostLayoutPolicyLw(w, w.mAttrs, w.getParentWindow(), this.mService.mInputMethodTarget);
    }

    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_42703(WindowState w) {
    ...
    boolean updateRotationUnchecked(boolean inTransaction) {
        ...
        if (screenRotationAnimation != null && screenRotationAnimation.isAnimating()) {
            ...
            if (mayRotateSeamlessly) {
                if (getWindow(-$Lambda$6vWlz1P88lMkMG4g2BvX9ZYCNN0.$INST$3) != null) {
                    return false;
                }
            ...
            if (deltaRotation(rotation, oldRotation) != 2) {
                ...
                OppoRoundConerWindowManager.UpdateOrientation(rotation);
            }
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_64353(boolean rotateSeamlessly, WindowState w) {
        if (w.mAppToken != null) {
    ...
    int getLayerForAnimationBackground(WindowStateAnimator winAnimator) {
        WindowState visibleWallpaper = this.mBelowAppWindowsContainers.getWindow(-$Lambda$6vWlz1P88lMkMG4g2BvX9ZYCNN0.$INST$1);
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_109349(WindowState w) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_115879(int x, int y, WindowState w) {
        boolean z = true;
        int flags = w.mAttrs.flags;
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_117743(int uid, WindowState w) {
        return w.mOwnerUid == uid ? w.isFocused() : false;
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_117942(int uid, WindowState w) {
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_118164(int uid, WindowState w) {
        if (w.mAttrs.type == 2005 && w.mOwnerUid == uid && (w.mPermanentlyHidden ^ 1) != 0) {
            return w.mWindowRemovalAllowed ^ 1;
        }
        return false;
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_120379(WindowState w) {
    ...
    WindowState computeImeTarget(boolean updateImeTarget) {
        ...
        if (curTarget == null || !curTarget.isDisplayedLw() || !curTarget.isClosing() || (target != null && curTarget.mWinAnimator.mAnimLayer <= target.mWinAnimator.mAnimLayer)) {
            if (WindowManagerDebugConfig.DEBUG_INPUT_METHOD) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_128425(WindowState top, WindowState bottom, WindowState w) {
        if (w == top) {
            this.mTmpWindow = w;
        }
        if (this.mTmpWindow == null) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_130192(PrintWriter pw, String subPrefix, int[] index, WindowState w) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_131045(WindowManagerPolicy policy, boolean onWallpaper, boolean goingToShade, WindowState w) {
    ...
    boolean checkWaitingForWindows() {
        ...
        if (getWindow(new AnonymousClass1((byte) 1, this)) != null) {
            return true;
        }
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_131611(WindowState w) {
    ...
    boolean hasSecureWindowOnScreen() {
        return getWindow(-$Lambda$6vWlz1P88lMkMG4g2BvX9ZYCNN0.$INST$2) != null;
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_135795(WindowState w) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_135981(int visibility, int globalDiff, WindowState w) {
        try {
    ...
    void onWindowFreezeTimeout() {
        ...
        if (!this.mService.mSimulateWindowFreezing) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_137268(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_137832(WindowManagerPolicy policy, WindowState w) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_150793(int aboveAppLayer, boolean wallpaperOnly, IBinder appToken, MutableBoolean mutableIncludeFullDisplay, boolean includeDecor, Rect frame, Rect stackBounds, WindowState w) {
        if (!w.mHasSurface) {
            return false;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_159009(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_161510(WindowState w) {
