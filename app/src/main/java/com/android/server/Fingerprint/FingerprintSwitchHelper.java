            ...
            if (content != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        strReader = strReader2;
                        try {
                            FingerprintSwitchHelper.this.log("Got execption parsing permissions.", e32);
                            if (strReader != null) {
                                try {
                                    strReader.close();
                        ...
                        if (strReader != null) {
                            try {
                                ...
                                FingerprintSwitchHelper.this.log("Got execption close permReader.", e32222);
                            }
                        }
                        throw th;
                    }
                    ...
                    if (strReader != null) {
                        try {
                            ...
                            FingerprintSwitchHelper.this.log("Got execption close permReader.", e322222);
                        }
                    }
                    this.mISwitchUpdateListener.onFingerprintSwitchUpdate();
                } catch (IOException e7) {
                    e322222 = e7;
                    FingerprintSwitchHelper.this.log("Got execption parsing permissions.", e322222);
                    if (strReader != null) {
                        try {
                            strReader.close();
                        } catch (IOException e3222222) {
                            FingerprintSwitchHelper.this.log("Got execption close permReader.", e3222222);
                        }
                    }
                    this.mISwitchUpdateListener.onFingerprintSwitchUpdate();
                }
