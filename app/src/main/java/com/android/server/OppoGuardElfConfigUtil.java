        ...
        try {
            ...
            try {
                ...
                if (fileReader != null) {
                    try {
                        ...
                        Log.w(TAG, "Got execption close permReader.", e42222);
                    }
                }
                throw th;
            }
            ...
            if (fileReader != null) {
                try {
                    ...
                    Log.w(TAG, "Got execption close permReader.", e422222);
                }
            }
        } catch (IOException e8) {
            e422222 = e8;
            Log.w(TAG, "Got execption parsing permissions.", e422222);
            if (fileReader != null) {
                try {
                    fileReader.close();
                } catch (IOException e4222222) {
                    Log.w(TAG, "Got execption close permReader.", e4222222);
                }
            }
        }
    }
