...
public class UnlockController implements IFingerprintSensorEventListener {
    private static final /* synthetic */ int[] -com-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues = null;
    ...
    private static /* synthetic */ int[] -getcom-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues() {
        if (-com-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues != null) {
            return -com-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues;
        }
        ...
        -com-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues = iArr;
        return iArr;
    }
    ...
    public void dispatchTouchDown() {
        ...
        switch (-getcom-android-server-fingerprint-wakeup-UnlockController$OrderedEventsSwitchesValues()[this.mOrderedEvent.ordinal()]) {
            case 1:
