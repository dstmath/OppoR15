...
public class FingerprintKeyEventDetector implements IFingerprintKeyEventListener {
    private static final /* synthetic */ int[] -com-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] -getcom-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues() {
        if (-com-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues != null) {
            return -com-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues;
        }
        ...
        -com-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void dealKeyEventHappenend(FingerprintKeyEventData keyeventData) {
        switch (-getcom-android-server-fingerprint-detect-FingerprintKeyEventTypeSwitchesValues()[keyeventData.getKeyEventType().ordinal()]) {
            case 1:
