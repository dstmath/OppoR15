...
public final class OppoPowerConsumedMonitorService extends SystemService {
    ...
    private double mAodOnDelta = 30.0d;
    ...
    private double mFlashLightOnDelta = 120.0d;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 5:
                    ...
                    return;
                case 6:
                    OppoPowerConsumedMonitorService.this.mAodState = Secure.getInt(OppoPowerConsumedMonitorService.this.mContext.getContentResolver(), "Setting_AodEnableImediate", 0);
                    OppoPowerConsumedMonitorService.this.mAodDurationSetted = Secure.getInt(OppoPowerConsumedMonitorService.this.mContext.getContentResolver(), "Setting_AodUserSetTime", 0);
            ...
            try {
                ...
                if (reader != null) {
                    try {
                        ...
                        Slog.d(TAG, "readFileByLines io close exception :" + e12222.getMessage());
                    }
                }
                this.mModemInfo = modemInfo.toString();
                return;
        ...
        try {
            ...
            if (reader != null) {
                try {
                    ...
                    Slog.e(TAG, "batterystats. failed closing reader  " + e3222);
                }
            }
            if (process != null) {
                try {
                    ...
                    Slog.e(TAG, "batterystats. failed process waitfor " + e4222);
                }
                process.destroy();
            }
        } catch (IOException e5) {
            e3222 = e5;
            Slog.e(TAG, "failed parsing batterystats  " + e3222);
            if (bufferedReader != null) {
                try {
                    bufferedReader.close();
                } catch (IOException e32222) {
                    Slog.e(TAG, "batterystats. failed closing reader  " + e32222);
                }
            }
            if (process != null) {
                try {
                    ...
                    Slog.e(TAG, "batterystats. failed process waitfor " + e42222);
                }
                process.destroy();
            }
            return isDumpValid;
            ...
            try {
                ...
                if (reader != null) {
                    try {
                        ...
                        Slog.d(TAG, "readFileByLines io close exception :" + e122222.getMessage());
                    }
                }
                return -1;
            }
            ...
            try {
                ...
                if (reader != null) {
                    try {
                        ...
                        Slog.d(TAG, "readFileByLines io close exception :" + e1222222.getMessage());
                    }
                }
                return;
            }
