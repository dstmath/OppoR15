            ...
            try {
                ...
                try {
                    ...
                    if (fileos != null) {
                        try {
                            ...
                            Log.i(TAG, "failed close stream " + e52222222);
                        }
                    }
                    throw th;
                }
                ...
                if (fileos != null) {
                    try {
                        ...
                        Log.i(TAG, "failed close stream " + e522222222);
                    }
                }
                ...
                if (fileos != null) {
                    try {
                        ...
                        Log.i(TAG, "failed close stream " + e5222222222);
                    }
                }
            } catch (IOException e12) {
                e5222222222 = e12;
                Log.i(TAG, "failed write file " + e5222222222);
                if (fileos != null) {
                    try {
                        fileos.close();
                    } catch (IOException e52222222222) {
                        Log.i(TAG, "failed close stream " + e52222222222);
                    }
                }
            } catch (Exception e13) {
                e4 = e13;
                ...
                if (fileos != null) {
                    try {
                        ...
                        Log.i(TAG, "failed close stream " + e522222222222);
                    }
                }
            }
        }
        ...
        try {
            ...
            try {
                ...
                if (stream != null) {
                    try {
                        ...
                        Log.i(TAG, "Failed to close state FileInputStream " + e62222222);
                    }
                }
                throw th;
            }
            ...
            if (stream != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to close state FileInputStream " + e622222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to close state FileInputStream " + e6222222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to close state FileInputStream " + e62222222222);
                }
            }
            return list;
        } catch (IOException e15) {
            e62222222222 = e15;
            Log.i(TAG, "failed IOException " + e62222222222);
            if (stream != null) {
                try {
                    stream.close();
                } catch (IOException e622222222222) {
                    Log.i(TAG, "Failed to close state FileInputStream " + e622222222222);
                }
            }
            return list;
            ...
            if (stream != null) {
                try {
                    ...
                    Log.i(TAG, "Failed to close state FileInputStream " + e6222222222222);
                }
            }
            return list;
        }
