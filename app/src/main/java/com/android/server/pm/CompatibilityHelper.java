...
public class CompatibilityHelper extends RomUpdateHelper {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (strReader != null) {
                            try {
                                ...
                                CompatibilityHelper.this.log("Got execption close permReader.", e32222);
                            }
                        }
                        throw th;
                    }
                    ...
                    if (strReader != null) {
                        try {
                            ...
                            CompatibilityHelper.this.log("Got execption close permReader.", e322222);
                        }
                    }
                    throw th;
                }
                ...
                if (strReader != null) {
                    try {
                        ...
                        CompatibilityHelper.this.log("Got execption close permReader.", e3222222);
                    }
                }
                return -1;
            } catch (IOException e7) {
                e3222222 = e7;
                CompatibilityHelper.this.log("Got execption parsing permissions.", e3222222);
                if (strReader != null) {
                    try {
                        strReader.close();
                    } catch (IOException e32222222) {
                        CompatibilityHelper.this.log("Got execption close permReader.", e32222222);
                    }
                }
                return -1;
            }
    ...
    private boolean isInWhiteList(int type, String verifyStr, boolean b) {
        ...
        if (type == 18 || type == 27 || type == MM_MONEY_LUCKY_CHECK) {
            b = true;
        }
        if (!b) {
