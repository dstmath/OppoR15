...
public class HalDeviceManager {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_50913(MutableInt chipIdIfProvided, MutableBoolean statusOk, WifiStatus status, int id) {
        if (status.code == 0) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_68871(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiStaIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_69250(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiApIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_69630(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiP2pIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_70011(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiNanIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_79364(MutableInt typeResp, WifiStatus status, int type) {
        if (status.code == 0) {
            typeResp.value = type;
        } else {
