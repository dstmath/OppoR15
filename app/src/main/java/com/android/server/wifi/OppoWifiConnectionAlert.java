...
public class OppoWifiConnectionAlert {
    ...
    private final class ConnectTimeoutHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT /*1000*/:
                    if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect || OppoWifiConnectionAlert.this.mNetworksDisabledDuringAutoConnect) {
                        ...
                        if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect) {
                            OppoWifiConnectionAlert.this.mWifiConfigManager.disableAndRemoveNetwork(OppoWifiConnectionAlert.this.mConnectNetworkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, 2);
                        }
                        ...
                        OppoWifiConnectionAlert.this.mWifiStateMachine.setManuConnect(false);
                        return;
                    }
                    return;
                ...
                case OppoWifiConnectionAlert.AUTHENTICATION_FAILURE_EVENT_TIMEOUT /*1002*/:
                    if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect || OppoWifiConnectionAlert.this.mNetworksDisabledDuringAutoConnect) {
                        OppoWifiConnectionAlert.this.mWifiConfigManager.enableAllNetworks();
                        if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect) {
                            OppoWifiConnectionAlert.this.mWifiConfigManager.disableAndRemoveNetwork(OppoWifiConnectionAlert.this.mConnectNetworkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, 3);
                        }
                        OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect = false;
                        OppoWifiConnectionAlert.this.mNetworksDisabledDuringAutoConnect = false;
                        OppoWifiConnectionAlert.this.mWifiStateMachine.setManuConnect(false);
                ...
                case OppoWifiConnectionAlert.EVENT_AUTO_CONNECT_TIMEOUT /*1004*/:
                    if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringAutoConnect) {
                        ...
                        OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(OppoWifiConnectionAlert.this.mThirdAPKConnectNetworkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, StatusCode.MCCA_TRACK_LIMIT_EXCEEDED);
                ...
                case OppoWifiConnectionAlert.WRONG_KEY_EVENT_TIMEOUT /*1005*/:
                    if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect) {
                        OppoWifiConnectionAlert.this.mWifiConfigManager.enableAllNetworks();
                        OppoWifiConnectionAlert.this.mWifiConfigManager.disableAndRemoveNetwork(OppoWifiConnectionAlert.this.mConnectNetworkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, 12);
            ...
            if (msg != null) {
                ...
                if (hidden == null) {
                    ...
                    if (!OppoWifiConnectionAlert.this.getAddAndConnectHiddenAp()) {
                        ...
                        OppoWifiConnectionAlert.this.mWifiConfigManager.disableAndRemoveNetwork(netId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, reason);
                        OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect = false;
                        OppoWifiConnectionAlert.this.mWifiStateMachine.setManuConnect(false);
                        ...
                        if (isWep || isWpa) {
                            if (isWep) {
                                ...
                                if (psk == null || psk.length() < 8) {
                                    ...
                                    if (noNeedRemove) {
                                        OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(hidden.networkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, reason);
                                        OppoWifiConnectionAlert.this.mWifiConfigManager.addOrUpdateNetwork(OppoWifiConnectionAlert.this.mBackupWifiConfiguration, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                            ...
                            if (savedConfig != null) {
                                ...
                                OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(savedConfig.networkId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                            }
                            NetworkUpdateResult result = OppoWifiConnectionAlert.this.mWifiConfigManager.addOrUpdateNetwork(newConfig, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                            if (result != null) {
                            ...
                            if (newNetId == -1) {
                                ...
                                if (savedConfig != null) {
                                    OppoWifiConnectionAlert.this.mWifiConfigManager.enableNetwork(savedConfig.networkId, false, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                                }
                                OppoWifiConnectionAlert.this.mBackupWifiConfiguration = null;
                                OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect = false;
                                OppoWifiConnectionAlert.this.mWifiStateMachine.setManuConnect(false);
                            ...
                            mMsg.sendingUid = OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT;
                            ...
                            if (noNeedRemove) {
                                ...
                                OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(netId, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                                return;
                            }
                            if (OppoWifiConnectionAlert.DEBUG) {
                            ...
                            OppoWifiConnectionAlert.this.mWifiConfigManager.removeNetwork(OppoWifiConnectionAlert.this.mOldNetIdCreatedByManuConnect.intValue(), OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                            return;
                        }
                        if (found) {
                            reason = 3;
                        ...
                        if (noNeedRemove) {
                            ...
                            OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(OppoWifiConnectionAlert.this.mNewNetIdCreateByManuConnect.intValue(), OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, StatusCode.MCCA_TRACK_LIMIT_EXCEEDED);
                            OppoWifiConnectionAlert.this.mWifiConfigManager.addOrUpdateNetwork(OppoWifiConnectionAlert.this.mBackupWifiConfiguration, OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                            OppoWifiConnectionAlert.this.mBackupWifiConfiguration = null;
                        } else {
                            if (OppoWifiConnectionAlert.DEBUG) {
                            ...
                            OppoWifiConnectionAlert.this.mWifiConfigManager.disableNetwork(OppoWifiConnectionAlert.this.mNewNetIdCreateByManuConnect.intValue(), OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT, StatusCode.MCCA_TRACK_LIMIT_EXCEEDED);
                            OppoWifiConnectionAlert.this.mWifiConfigManager.removeNetwork(OppoWifiConnectionAlert.this.mNewNetIdCreateByManuConnect.intValue(), OppoWifiConnectionAlert.EVENT_ASSOC_REJECT_TIMEOUT);
                        }
    ...
    private void handleAssociationRejectionEvent(Message message) {
        ...
        removeTimeoutEvent();
        this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(EVENT_ASSOC_REJECT_TIMEOUT, message.obj), (long) this.mWifiStateMachine.getRomUpdateIntegerValue("CONNECT_TIMEOUT_ASSOC_REJECT", Integer.valueOf(WifiConnectivityManager.PERIODIC_SCAN_INTERVAL_MS)).intValue());
    }
    ...
    private void handleDisconnected(StateChangeResult stateChangeResult) {
        ...
        if (this.mNetworksDisabledDuringConnect) {
            if (mWrongkeyCount >= this.mWifiStateMachine.getRomUpdateIntegerValue("CONNECT_MAX_RETRIES_MANUAL_WRONG_KEY_COUNT", Integer.valueOf(2)).intValue()) {
                handleNetworkConnectionFailure(stateChangeResult.networkId, 12);
                this.mWifiConfigManager.clearDisableReasonCounter(config.networkId);
                ...
                handleNetworkConnectionFailure(stateChangeResult.networkId, 3);
                this.mWifiConfigManager.clearDisableReasonCounter(config.networkId);
                ...
                handleNetworkConnectionFailure(stateChangeResult.networkId, 2);
                this.mWifiConfigManager.clearDisableReasonCounter(config.networkId);
            }
            ...
            handleNetworkConnectionFailure(stateChangeResult.networkId, 12);
            this.mWifiConfigManager.clearDisableReasonCounter(12, config.networkId);
            ...
            handleNetworkConnectionFailure(stateChangeResult.networkId, 3);
            this.mWifiConfigManager.clearDisableReasonCounter(3, config.networkId);
            ...
            handleNetworkConnectionFailure(stateChangeResult.networkId, 2);
            this.mWifiConfigManager.clearDisableReasonCounter(2, config.networkId);
        }
    }
    ...
    private void handleConnectCompleted() {
        ...
        if (this.mNetworksDisabledDuringConnect || this.mNetworksDisabledDuringAutoConnect) {
            if (this.mNetworksDisabledDuringConnect) {
                if (this.mWifiStateMachine.getManuConnectNetId() == this.mConnectingNetId) {
        ...
        if (this.mNetworksDisabledDuringConnect) {
            ...
            if (this.mNewNetIdCreateByManuConnect.intValue() == netId) {
                ...
                if (isConnectingExistNetwork(this.mNewNetIdCreateByManuConnect.intValue())) {
                    ...
                    this.mWifiConfigManager.disableNetwork(this.mNewNetIdCreateByManuConnect.intValue(), EVENT_ASSOC_REJECT_TIMEOUT, StatusCode.MCCA_TRACK_LIMIT_EXCEEDED);
                    this.mWifiConfigManager.removeNetwork(this.mNewNetIdCreateByManuConnect.intValue(), EVENT_ASSOC_REJECT_TIMEOUT);
                }
                ...
                this.mWifiConfigManager.addOrUpdateNetwork(this.mBackupWifiConfiguration, EVENT_ASSOC_REJECT_TIMEOUT);
                this.mWifiConfigManager.disableNetwork(netId, EVENT_ASSOC_REJECT_TIMEOUT, StatusCode.MCCA_TRACK_LIMIT_EXCEEDED);
                this.mWifiConfigManager.sendAlertNetworksChangedBroadcast(netId, this.mBackupWifiConfiguration, disableReason);
                this.mBackupWifiConfiguration = null;
            } else {
                this.mWifiConfigManager.disableAndRemoveNetwork(netId, EVENT_ASSOC_REJECT_TIMEOUT, disableReason);
            }
            this.mNetworksDisabledDuringConnect = false;
            this.mWifiStateMachine.setManuConnect(false);
            removeTimeoutEvent();
