            ...
            if (content != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        e322 = e5;
                        strReader = strReader2;
                        OppoWifiAssistantUpdateHelper.this.log("Got execption parsing permissions.", e322);
                        if (strReader != null) {
                            try {
                                strReader.close();
                        ...
                        if (strReader != null) {
                            try {
                                ...
                                OppoWifiAssistantUpdateHelper.this.log("Got execption close permReader.", e32222);
                            }
                        }
                        throw th;
                    }
                    ...
                    if (strReader != null) {
                        try {
                            ...
                            OppoWifiAssistantUpdateHelper.this.log("Got execption close permReader.", e322222);
                        }
                    }
                    Log.d(OppoWifiAssistantUpdateHelper.TAG, "parseContentFromXML " + dumpToString());
                } catch (IOException e7) {
                    e322222 = e7;
                    OppoWifiAssistantUpdateHelper.this.log("Got execption parsing permissions.", e322222);
                    if (strReader != null) {
                        try {
                            strReader.close();
                        } catch (IOException e3222222) {
                            OppoWifiAssistantUpdateHelper.this.log("Got execption close permReader.", e3222222);
                        }
                    }
                    Log.d(OppoWifiAssistantUpdateHelper.TAG, "parseContentFromXML " + dumpToString());
                }
