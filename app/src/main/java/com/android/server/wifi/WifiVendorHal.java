...
public class WifiVendorHal {
    ...
    private class ChipEventCallback extends Stub {
        ...
        /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_102388(WifiDebugRingBufferStatus status, ArrayList data) {
        ...
        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_104051(ArrayList debugData, int errorCode) {
            synchronized (WifiVendorHal.sLock) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_19419(ScanCapabilities out, MutableBoolean ans, WifiStatus status, StaBackgroundScanCapabilities cap) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_28982(AnonymousClass1AnswerBox answer, WifiStatus status, StaLinkLayerStats stats) {
        if (ok(status)) {
            answer.value = stats;
        }
    }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_36775(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
            feat.value = wifiFeatureMaskFromChipCapabilities(capabilities);
        }
    }

    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_37079(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_38571(AnonymousClass2AnswerBox box, WifiStatus status, android.hardware.wifi.V1_0.RttCapabilities capabilities) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_54953(AnonymousClass3AnswerBox answer, WifiStatus status, RttResponder info) {
        if (ok(status)) {
            answer.value = info;
        }
    }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_59707(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_60220(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
            this.mChannelsForBandSupport = Boolean.valueOf(false);
        }
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_62107(AnonymousClass5AnswerBox box, WifiStatus status, StaApfPacketFilterCapabilities capabilities) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_69024(WifiStatus status, ChipDebugInfo chipDebugInfo) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_71967(AnonymousClass6AnswerBox ans, WifiStatus status, ArrayList ringBuffers) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_73238(AnonymousClass7AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_73932(AnonymousClass8AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
            ans.value = NativeUtil.byteArrayFromArrayList(blob);
        }
    }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_78799(TxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_80586(RxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_88027(AnonymousClass9AnswerBox ans, WifiStatus status, WifiDebugHostWakeReasonStats stats) {
        if (ok(status)) {
            ans.value = stats;
        }
    }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_89654(RoamingCapabilities out, MutableBoolean ok, WifiStatus status, StaRoamingCapabilities cap) {
        if (ok(status)) {
