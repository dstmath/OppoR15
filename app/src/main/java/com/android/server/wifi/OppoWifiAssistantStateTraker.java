...
class OppoWifiAssistantStateTraker extends StateMachine {
    ...
    private int mOperateUid = TCP_STAT_BASE_COUNT;
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case WifiMonitor.WRONG_KEY_EVENT /*147648*/:
                    ...
                    if (OppoWifiAssistantStateTraker.this.mManualConnect) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case OppoWifiAssistantStateTraker.EVENT_ADD_UPDATE_NETWORK /*200714*/:
                    ...
                    if (!(netMintent == null || (OppoWifiAssistantStateTraker.this.mIsSoftAP && OppoWifiAssistantStateTraker.this.isThirdAppOperate()))) {
                        ...
                        if (!(updateWifiInfo == null || netStateSsid == null || (updateWifiInfo.getSSID().equals(netStateSsid) ^ 1) != 0)) {
                            ...
                            if (OppoWifiAssistantStateTraker.this.mGotInternetResult < 4 || netValid != OppoWifiAssistantStateTraker.this.mInterResult) {
                ...
                case OppoWifiAssistantStateTraker.EVENT_CONNECT_NETWORK /*200715*/:
                    ...
                    if (curWifiInfo != null && curSsid != null && (curWifiInfo.getSSID().equals(curSsid) ^ 1) == 0) {
                        ...
                        if (curSsid.equals(OppoWifiAssistantStateTraker.this.mConnectSSID)) {
                            if (!OppoWifiAssistantStateTraker.this.mManualConnect) {
                                OppoWifiAssistantStateTraker.this.mManualConnect = conIntent.getBooleanExtra(OppoWifiAssistantStateTraker.EXTRA_WIFI_MANUAL, true);
                            } else if (OppoWifiAssistantStateTraker.this.mConnectId != -1 && OppoWifiAssistantStateTraker.this.mConnectId == curWifiInfo.getNetworkId()) {
                                OppoWifiAssistantStateTraker.this.mManualConnect = conIntent.getBooleanExtra(OppoWifiAssistantStateTraker.EXTRA_WIFI_MANUAL, true);
                            }
                ...
                case OppoWifiAssistantStateTraker.EVENT_INTERNET_CHANGE /*200722*/:
                    ...
                    } else if (!OppoWifiAssistantStateTraker.this.mManualConnect) {
            ...
            switch (msg.what) {
                ...
                case OppoWifiAssistantStateTraker.CMD_RSSI_FETCH /*200708*/:
                    if (msg.arg1 == OppoWifiAssistantStateTraker.this.mRssiFetchToken) {
                        OppoWifiAssistantStateTraker.this.mWsmChannel.sendMessage(151572);
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker = OppoWifiAssistantStateTraker.this;
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker3 = OppoWifiAssistantStateTraker.this;
    ...
    class VerifyInternetState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoWifiAssistantStateTraker.EVENT_NETWORK_MONITOR_CHANGE /*200707*/:
                    if (OppoWifiAssistantStateTraker.this.mManualConnect || OppoWifiAssistantStateTraker.this.mInterResult) {
                        OppoWifiAssistantStateTraker.this.transitionTo(OppoWifiAssistantStateTraker.this.mNetworkMonitorState);
                    }
                    return true;
                default:
                ...
                if (OppoWifiAssistantStateTraker.this.mFeatureState && (OppoWifiAssistantStateTraker.this.getRomUpdateBooleanValue("OPPO_WIFI_ASSISTANT_FEATURE", Boolean.valueOf(true)).booleanValue() ^ 1) == 0) {
                    ...
                    if (action.equals(OppoWifiAssistantStateTraker.ACTION_WIFI_NETWORK_CONNECT)) {
                        ...
                        if (action.equals("android.net.wifi.STATE_CHANGE")) {
                            ...
                            if (config != null && config.status == 1 && changeReason == 2 && config.networkId != -1 && config.networkId == OppoWifiAssistantStateTraker.this.mConnectId && OppoWifiAssistantStateTraker.this.mManualConnect) {
                                OppoWifiAssistantStateTraker.this.logD("DISABLED, set mManualConnect false");
                                OppoWifiAssistantStateTraker.this.mManualConnect = false;
                                OppoWifiAssistantStateTraker.this.mOperateUid = OppoWifiAssistantStateTraker.TCP_STAT_BASE_COUNT;
                            }
                                        ...
                                        if (curWifiInfo != null && netStateSsid != null && (curWifiInfo.getSSID().equals(netStateSsid) ^ 1) == 0) {
                                            ...
                                            if (netConf != null && netConf.networkId == OppoWifiAssistantStateTraker.this.mConnectedId) {
                                                ...
                                                if ((OppoWifiAssistantStateTraker.this.mGotInternetResult & 4) != 4) {
                                                    ...
                                                    int newConfig = 0;
                                                    if (OppoWifiAssistantStateTraker.this.mManualConnect && OppoWifiAssistantStateTraker.this.mConnectId == netConf.networkId && OppoWifiAssistantStateTraker.this.mConnectId != -1) {
    ...
    private void transitionSupplicantState(StateChangeResult stateChangeResult) {
        ...
        int i = -getandroid-net-wifi-SupplicantStateSwitchesValues()[supState.ordinal()];
    }
    ...
    public void updateWifiState(int state) {
        ...
        if (state == 3) {
            ...
            this.mOperateUid = TCP_STAT_BASE_COUNT;
        ...
        if (configKey != null) {
            synchronized (this.mWifiNetworkRecord) {
                if (this.mWifiNetworkRecord.containsKey(configKey)) {
                    ...
                    if (save) {
                        if (this.mManualConnect || !this.mCaptivePortal || (this.mGotInternetResult & 8) == 8) {
                            saveWifiNetworkRecord();
                        } else {
                    ...
                    if (this.mWifiNetworkRecord.containsKey(configKey)) {
                        ...
                        if (disableId == -1) {
                            ...
                            if (this.mWifiStateMachine == null || (this.mWifiStateMachine.isSupplicantAvailable() ^ 1) == 0) {
                                this.mWifiConfigManager.disableNetwork(disableId, TCP_STAT_BASE_COUNT, 9);
                            } else {
        ...
        if (!(mLastRecord == null || info == null)) {
            if (info.rssi > WifiConfiguration.INVALID_RSSI) {
                ...
                if (netQualityIndex == 0) {
                    int badRssiScore = getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_BAD_RSSI_SCORE_THRESHOLD", Integer.valueOf(15)).intValue();
                    ...
                    int lowRssiScore = getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_LOW_RSSI_SCORE_THRESHOLD", Integer.valueOf(10)).intValue();
                    if (this.mToData || (tcpAvailable ^ 1) != 0) {
                ...
                if (this.mAutoSwitch && (this.mFeatureState ^ 1) == 0 && (getRomUpdateBooleanValue("OPPO_WIFI_ASSISTANT_FEATURE", Boolean.valueOf(true)).booleanValue() ^ 1) == 0) {
                    ...
                    if (currentQuality <= 79 - trigWlanDetectCore) {
                        if (score <= 79 - trigWlanDetectCore && this.mLastScanTime != 0 && now - this.mLastScanTime > STAIC_SCAN_RESULT_AGE && this.mTrigScanCount < 3 && (this.mTriggerScan ^ 1) != 0) {
                    ...
                    if (this.mAlertDialog != null && this.mManualConnect && (this.mToData ^ 1) != 0 && mLastRecord.mNetworkValid) {
                        if (currentQuality > 79 - trigWlanDetectCore) {
                    ...
                    if (this.mChangeNetwork || currentQuality > 79 - wlanBadThreshold || score > 79 - wlanBadThreshold) {
                        if (this.mChangeNetwork && this.mToData) {
                            ...
                            if (mLastRecord.mNetworkValid && (this.mInterResult ^ 1) != 0 && this.mChangeRssi != 0 && rssi >= -77 && currentQuality >= 50 && score >= 50 && this.mChangeScore == 10) {
    ...
    private void broadcastInfotoTestapk(String info) {
        ...
        if (getRomUpdateBooleanValue("OPPO_WIFI_ASSISTANT_TEST", Boolean.valueOf(false)).booleanValue()) {
            ...
            if ((pm == null || pm.getPackageUid(this.mTestApk, 65536, 0) >= TCP_STAT_BASE_COUNT) && this.mBroadHandle != null) {
    ...
    private int getQulityIndex(boolean is5G, int rssi) {
        if (is5G) {
            ...
            int lowRssi5 = getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_LOW_RSSI_5", Integer.valueOf(-77)).intValue();
            int badRssi5 = getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_BAD_RSSI_5", Integer.valueOf(-83)).intValue();
            if (rssi >= goodRssi5) {
                return 3;
            }
        ...
        int lowRssi24 = getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_LOW_RSSI_24", Integer.valueOf(-77)).intValue();
    ...
    private void selectCandidateNetwork(OppoWifiAssistantRecord lastRecord) {
        ...
        if (this.mWifiStateMachine == null || (this.mWifiStateMachine.isSupplicantAvailable() ^ 1) == 0) {
            ...
            this.mWifiStateMachine.startConnectToNetwork(selectConf.networkId, TCP_STAT_BASE_COUNT, "any");
    ...
    private OppoWifiAssistantRecord detectNetworkAvailable(OppoWifiAssistantRecord lastRecord, int curScore, int curRssi, boolean force) {
        ...
        } else if ((this.mAutoSwitch && (this.mFeatureState ^ 1) != 0) || (lastRecord == null && candidate == null && this.mInitAutoConnect)) {
    ...
    private boolean sendParallelHttpProbes() {
        ...
        try {
            ...
            try {
                url = new URL((String) publicServers.get(1));
                ...
                this.mInterThread.post(new Runnable() {
                    public void run() {
                        ...
                        if (dectConfig == null || (dectConfig.equals(OppoWifiAssistantStateTraker.this.mLastConfigkey) ^ 1) == 0) {
                            ...
                            } else if (!OppoWifiAssistantStateTraker.this.mInterResult || OppoWifiAssistantStateTraker.this.mLastPkgInfo == null || OppoWifiAssistantStateTraker.this.mLastPkgInfo.rssi < -77) {
                                OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
    ...
    private boolean detectTcpStatus() {
        ...
        if (this.mTcpLinkStatus == 16) {
            if (this.mTcpStatistics < 0 || this.mTcpStatistics >= TCP_STAT_BASE_COUNT) {
            ...
            if (this.mTcpStatistics < TCP_STAT_BASE_COUNT || this.mTcpStatistics >= TCP_STAT_POOR_COUNT) {
                this.mTcpStatistics = TCP_STAT_BASE_COUNT;
            } else {
                this.mTcpStatistics++;
            }
    ...
    private boolean isThirdAppOperate() {
        ...
        if (getRomUpdateBooleanValue("OPPO_WIFI_ASSISTANT_CONTROL_SOFTAP", Boolean.valueOf(true)).booleanValue()) {
            ...
            if (this.mOperateUid == TCP_STAT_BASE_COUNT || this.mOperateUid == 1010) {
                z = false;
            }
            return z;
        }
