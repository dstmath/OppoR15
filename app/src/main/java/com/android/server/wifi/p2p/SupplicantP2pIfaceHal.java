...
public class SupplicantP2pIfaceHal {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5061(long cookie) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5451(long cookie) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_10564(ArrayList supplicantIfaces, SupplicantStatus status, ArrayList ifaces) {
        if (status.code != 0) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_11670(SupplicantResult supplicantIface, SupplicantStatus status, ISupplicantIface iface) {
        if (status.code != 0) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_44235(SupplicantResult result, SupplicantStatus status, byte[] address) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_45867(SupplicantResult result, SupplicantStatus status, ArrayList ssid) {
