...
public class WifiInjector {
    ...
    private final OppoSlienceReCovery mOppoSlienceReCovery;
    ...
    public WifiInjector(Context context) {
        if (context == null) {
            ...
            this.mCountryCode = new WifiCountryCode(this.mWifiNative, SystemProperties.get(BOOT_DEFAULT_WIFI_COUNTRY_CODE), this.mContext.getResources().getBoolean(17957073));
            ...
            this.mWifiConfigManager = new WifiConfigManager(this.mContext, this.mClock, UserManager.get(this.mContext), TelephonyManager.from(this.mContext), this.mWifiKeyStore, this.mWifiConfigStore, this.mWifiPermissionsUtil, this.mWifiPermissionsWrapper, new NetworkListStoreData(this.mContext), new DeletedEphemeralSsidsStoreData());
            ...
            this.mOppoSlienceReCovery = new OppoSlienceReCovery(this.mContext, this, this.mWifiNative);
