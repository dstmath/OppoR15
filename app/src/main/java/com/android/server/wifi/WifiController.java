...
public class WifiController extends StateMachine {
            ...
            switch (msg.what) {
                ...
                case WifiController.CMD_SET_AP /*155658*/:
                    if (!WifiController.this.mStaAndApConcurrency) {
                        ...
                        WifiController.this.log("StaDisabledWithScanState:CMD_SET_AP: SoftApConfig obj null. Do nothing!");
                        break;
                    } else {
        ...
        this.mContext.registerReceiver(new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals(WifiController.ACTION_DEVICE_IDLE)) {
                    ...
                    } else if (state == 11 || state == 111) {
                        WifiController.this.sendMessage(WifiController.CMD_AP_STOPPED);
                    } else if (state == 13 || state == StatusCode.UNKNOWN_AUTHENTICATION_SERVER) {
    ...
    public void setStaSoftApConcurrencyForSharing(boolean enable) {
        ...
        this.mStaAndApConcurrency = enable;
        this.mWifiStateMachine.setStaSoftApConcurrencyForSharing(enable);
    }

    public boolean isSharingEnabing() {
        if (getCurrentState() == this.mQcApStaEnablingState || getCurrentState() == this.mQcApStaEnabledState) {
            return true;
        }
        return false;
    }
