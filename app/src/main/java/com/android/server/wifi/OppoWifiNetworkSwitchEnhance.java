        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 2000:
                    ...
                    if (!OppoWifiNetworkSwitchEnhance.this.mIsSoftAP && available != null && handlerCurrentInfo != null && !WifiSsid.NONE.equals(handlerCurrentInfo.getSSID())) {
                ...
                case OppoWifiNetworkSwitchEnhance.EVENT_NETWORK_NOT_AVAILABLE /*2002*/:
                    ...
                    if (unavailable != null && handlerCurrentInfo != null && !WifiSsid.NONE.equals(handlerCurrentInfo.getSSID())) {
                ...
                switch (msg.what) {
                    case OppoWifiNetworkSwitchEnhance.EVENT_NETWORK_STATE_CHANGE /*3000*/:
                        if (OppoWifiNetworkSwitchEnhance.this.mNetworkInfo != null) {
                            ...
                            switch (-getandroid-net-NetworkInfo$DetailedStateSwitchesValues()[OppoWifiNetworkSwitchEnhance.this.mNetworkInfo.getDetailedState().ordinal()]) {
                                case 1:
                ...
                if (OppoWifiNetworkSwitchEnhance.this.mFeature) {
                    ...
                    if (action.equals(OppoWifiNetworkSwitchEnhance.ACTION_WIFI_NETWORK_CONNECT)) {
                        ...
                        if (actionConnectInfo != null && curSsid != null && (curSsid.equals(actionConnectInfo.getSSID()) ^ 1) == 0) {
                            ...
                            OppoWifiNetworkSwitchEnhance.this.mManualConnect = intent.getBooleanExtra(OppoWifiNetworkSwitchEnhance.EXTRA_WIFI_MANUAL, true);
                        ...
                        if (action.equals("android.net.wifi.STATE_CHANGE")) {
                            ...
                            if (intent.getIntExtra("wifi_state", 1) == 1) {
                                OppoWifiNetworkSwitchEnhance.this.mManualConnect = false;
                            ...
                            if (config != null && config.status == 1) {
                                OppoWifiNetworkSwitchEnhance.this.logE("DISABLED, set mManualConnect false");
                                OppoWifiNetworkSwitchEnhance.this.mManualConnect = false;
                            }
