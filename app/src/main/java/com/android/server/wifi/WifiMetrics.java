    ...
    private void consolidateProto(boolean incremental) {
        ...
        synchronized (this.mLock) {
            ...
            for (i = 0; i < this.mConnectToNetworkNotificationActionCount.size(); i++) {
                ...
                keyVal2.notification = key / CONNECT_TO_NETWORK_NOTIFICATION_ACTION_KEY_MULTIPLIER;
                keyVal2.action = key % CONNECT_TO_NETWORK_NOTIFICATION_ACTION_KEY_MULTIPLIER;
                keyVal2.recommender = 1;
