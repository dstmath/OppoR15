...
public class WifiScanningServiceImpl extends Stub {
    ...
    class WifiSingleScanStateMachine extends StateMachine implements ScanEventHandler {
        ...
        class DefaultState extends State {
            ...
            static /* synthetic */ boolean lambda$-com_android_server_wifi_scanner_WifiScanningServiceImpl$WifiSingleScanStateMachine$DefaultState_31149(long currentTimeInMillis, ScanResult scanResult) {
