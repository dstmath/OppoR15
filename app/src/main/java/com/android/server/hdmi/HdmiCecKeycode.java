...
final class HdmiCecKeycode {
    ...
    private static class KeycodeEntry {
        ...
        /* synthetic */ KeycodeEntry(int androidKeycode, int cecKeycode, KeycodeEntry -this2) {
            this(androidKeycode, cecKeycode);
        }

        /* synthetic */ KeycodeEntry(int androidKeycode, int cecKeycode, boolean isRepeatable, KeycodeEntry -this3) {
