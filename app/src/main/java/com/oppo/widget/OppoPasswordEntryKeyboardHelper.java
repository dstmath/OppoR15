...
public class OppoPasswordEntryKeyboardHelper implements OnKeyboardActionListener {
    ...
    public OppoPasswordEntryKeyboardHelper(Context context, KeyboardView keyboardView, View targetView, boolean useFullScreenWidth, int[] layouts) {
        ...
        this.mType = 0;
        this.mLockLayouts = new int[]{202048513, 202048512, 202048512, 202048516};
        this.mLayouts = new int[]{202048513, 202048514, 202048514, 202048515};
    ...
    private void createSecurtiyKeyboards() {
        if (isUnLockKeyboard()) {
            this.mQwertyKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLockLayouts[1], 201458761, this.mType, false);
            this.mQwertyKeyboard.enableShiftLock();
            this.mQwertyKeyboardShifted = new OppoPasswordEntryKeyboard(this.mContext, this.mLockLayouts[2], 201458761, this.mType, false);
            this.mQwertyKeyboardShifted.enableShiftLock();
            this.mQwertyKeyboardShifted.setShifted(true);
            this.mSymbolsKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLockLayouts[3], this.mType, false);
            this.mSymbolsKeyboard.enableShiftLock();
            return;
        }
        this.mQwertyKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[1], 201458761, this.mType, false);
        this.mQwertyKeyboard.enableShiftLock();
        this.mQwertyKeyboardShifted = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[2], 201458761, this.mType, false);
        this.mQwertyKeyboardShifted.enableShiftLock();
        this.mQwertyKeyboardShifted.setShifted(true);
        this.mSymbolsKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[3], this.mType, false);
        this.mSymbolsKeyboard.enableShiftLock();
    }
    ...
    private void createKeyboardsWithSpecificSize(int width, int height) {
        ...
        this.mQwertyKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[1], 201458761, width, height);
        this.mQwertyKeyboard.enableShiftLock();
        this.mQwertyKeyboardShifted = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[2], 201458761, width, height);
        this.mQwertyKeyboardShifted.enableShiftLock();
        this.mQwertyKeyboardShifted.setShifted(true);
        this.mSymbolsKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[3], width, height);
        this.mSymbolsKeyboard.enableShiftLock();
    }
    ...
    private void createKeyboardsWithDefaultWidth() {
        ...
        this.mQwertyKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[1], 201458761);
        this.mQwertyKeyboard.enableShiftLock();
        this.mQwertyKeyboardShifted = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[2], 201458761);
        this.mQwertyKeyboardShifted.enableShiftLock();
        this.mQwertyKeyboardShifted.setShifted(true);
        this.mSymbolsKeyboard = new OppoPasswordEntryKeyboard(this.mContext, this.mLayouts[3]);
        this.mSymbolsKeyboard.enableShiftLock();
    }
