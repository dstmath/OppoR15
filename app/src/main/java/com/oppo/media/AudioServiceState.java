...
public class AudioServiceState {
    ...
    public boolean isInCallMode() {
        DebugLog.d(TAG, "mIsHasCallMode :" + this.mIsHasCallMode);
        return this.mIsHasCallMode;
    }
    ...
    public void checkAllModes() {
        ...
        synchronized (this.mAudioServiceLock) {
            ...
            } else if (isAudioPlayEffectByMode()) {
    ...
    public boolean checkAudioSystem(boolean isCheck) {
        ...
        if (!isNeedCheckAudioSystem() && isCheck) {
            ...
            return false;
        } else if (getActiveAudioPids() != null || (getRecordThreadState() ^ 1) == 0) {
    ...
    public void setSystemPhoneState(int mode) {
        DebugLog.d(TAG, "setSystemPhoneState mode = " + mode);
        synchronized (this.mAudioServiceLock) {
