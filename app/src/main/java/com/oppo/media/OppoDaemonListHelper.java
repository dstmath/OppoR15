...
public class OppoDaemonListHelper extends RomUpdateHelper {
    ...
    public static final String[] TAG_MODULE = new String[]{"dirac", "volume", "control", "zenmode", "record-conflict", "change-streamtype", "wechat-encode", "oppo-getstreamvolume", "setvoipmode-incall", "not-addplayerbase"};
