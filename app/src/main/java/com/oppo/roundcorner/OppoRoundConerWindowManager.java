...
public class OppoRoundConerWindowManager {
    ...
    private static OppoRoundConerView sLandBottomWindow;
    private static LayoutParams sLandTopParams;
    private static OppoRoundConerView sLandTopWindow;
    private static int sOrientation = 0;
    private static LayoutParams sPortBottomParams;
    private static OppoRoundConerView sPortBottomWindow;
    private static LayoutParams sPortTopParams;
    private static OppoRoundConerView sPortTopWindow;
    ...
    public static void getScreenInfo(Context context) {
        ...
        mHandler = new Handler(mContext.getMainLooper()) {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 101:
                        OppoRoundConerWindowManager.setOrientation(OppoRoundConerWindowManager.sTempOrientation);
                        OppoRoundConerWindowManager.updateLayout(OppoRoundConerWindowManager.mContext);
                        return;
                    default:
                        return;
                }
        ...
        Log.d("OPPORoundConer", "sScreenWidth=" + sScreenWidth + ", sScreenHeight=" + sScreenHeight + " mHeteromorphism=" + mHeteromorphism);
    }
    ...
    public static void createPortraitWindow(Context context) {
        ...
        if (sPortTopWindow == null) {
            sPortTopWindow = new OppoRoundConerView(context, 1);
            sPortTopWindow.setFlag(1);
            sPortTopWindow.setConerType(1);
        ...
        if (sPortBottomWindow == null) {
            sPortBottomWindow = new OppoRoundConerView(context, 2);
            sPortBottomWindow.setFlag(2);
            sPortBottomWindow.setConerType(2);
    ...
    public static void createLandscapeWindow(Context context) {
        ...
        if (sLandTopWindow == null) {
            sLandTopWindow = new OppoRoundConerView(context, 3);
            sLandTopWindow.setFlag(3);
            sLandTopWindow.setConerType(3);
        ...
        if (sLandBottomWindow == null) {
            sLandBottomWindow = new OppoRoundConerView(context, 4);
            sLandBottomWindow.setFlag(4);
            sLandBottomWindow.setConerType(4);
    ...
    public static void setOrientation(int orientation) {
        if (sOrientation != orientation) {
            ...
            if (orientation == 0) {
                ...
                sPortTopWindow.setConerType(2);
                sPortBottomWindow.setConerType(1);
                sPortTopWindow.setVisibility(0);
                sPortBottomWindow.setVisibility(0);
                sLandTopWindow.setVisibility(8);
                sLandBottomWindow.setVisibility(8);
            } else if (orientation == 3) {
                sLandTopWindow.setConerType(4);
                sLandBottomWindow.setConerType(3);
                sLandTopWindow.setVisibility(0);
                sLandBottomWindow.setVisibility(0);
                sPortTopWindow.setVisibility(8);
                sPortBottomWindow.setVisibility(8);
    ...
    public static void UpdateOrientation(int orientation) {
        if (mHeteromorphism) {
            Log.d("OPPORoundConer", "UpdateOrientation orientation= " + orientation + " sTempOrientation= " + sTempOrientation);
