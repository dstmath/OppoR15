...
public class EmbmsOemHook extends Handler {
    ...
    public class ActDeactRequest extends BaseQmiStructType {
        ...
        public short[] getTypes() {
            return new short[]{(short) 1, (short) 2, (short) 3, (short) 4, (short) 5, (short) 16, EmbmsOemHook.SIZE_OF_EACH_PLMN_IN_BYTES};
        }
    }
    ...
    public class TmgiActivateRequest extends BaseQmiStructType {
        ...
        public short[] getTypes() {
            return new short[]{(short) 1, (short) 2, (short) 3, (short) 4, (short) 16, (short) 5};
        }
    }
                ...
                try {
                    ...
                    switch (type) {
                        case 1:
                            ...
                            continue;
                        case 2:
                            if (msgId == (short) 4 || msgId == (short) 5) {
                                this.code = buf.getInt();
                                Log.i(EmbmsOemHook.LOG_TAG, "response code = " + this.code);
                                continue;
                            }
    ...
    private void handleResponse(HashMap<Integer, Object> map) {
        ...
        switch (msgId) {
            ...
            case (short) 29:
                ...
                return;
            case QtiSubscriptionInfoUpdater.EVENT_SIM_READ_DELAY /*30*/:
    ...
    public int getActiveTMGIList(int traceId, byte callId, int phoneId) {
        ...
        GenericRequest req = new GenericRequest(traceId, callId);
        try {
            this.mQmiOemHook.sendQmiMessageAsync((short) 2, (short) 5, req.getTypes(), req.getItems(), null, phoneId);
            return 0;
        } catch (IOException e) {
    ...
    public int getActiveLogPacketIDs(int traceId, int[] supportedLogPacketIdList, Message msg, int phoneId) {
        ...
        try {
            this.mQmiOemHook.sendQmiMessageAsync((short) 2, (short) 21, req.getTypes(), req.getItems(), msg, phoneId);
            return 0;
        } catch (IOException e) {
    ...
    public int deliverLogPacket(int traceId, int logPacketId, byte[] logPacket, int phoneId) {
        ...
        try {
            this.mQmiOemHook.sendQmiMessageAsync((short) 2, (short) 22, req.getTypes(), req.getItems(), null, phoneId);
            return 0;
        } catch (IOException e) {
