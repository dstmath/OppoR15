...
public final class ExtendedRemoteDisplay {
    ...
    class ExtendedRemoteDisplayHandler extends Handler {
        private static final /* synthetic */ int[] -com-qualcomm-wfd-ERDConstantsSwitchesValues = null;
        final /* synthetic */ int[] $SWITCH_TABLE$com$qualcomm$wfd$ERDConstants;

        private static /* synthetic */ int[] -getcom-qualcomm-wfd-ERDConstantsSwitchesValues() {
            if (-com-qualcomm-wfd-ERDConstantsSwitchesValues != null) {
                return -com-qualcomm-wfd-ERDConstantsSwitchesValues;
            }
            ...
            -com-qualcomm-wfd-ERDConstantsSwitchesValues = iArr;
            return iArr;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (-getcom-qualcomm-wfd-ERDConstantsSwitchesValues()[cmd.ordinal()]) {
                case 1:
