...
class WfdActionListenerImpl extends Stub {
    private static final /* synthetic */ int[] -com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues = null;
    private static final String TAG = "ExtendedRemoteDisplay.WfdActionListenerImpl";
    Handler mCallbackHandler;

    private static /* synthetic */ int[] -getcom-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues() {
        if (-com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues != null) {
            return -com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues;
        }
        ...
        -com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues = iArr;
        return iArr;
    }
    ...
    public void onStateUpdate(int newState, int sessionId) throws RemoteException {
        ...
        switch (-getcom-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues()[state.ordinal()]) {
            case 1:
