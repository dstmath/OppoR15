...
public interface IWfdSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWfdSession {
        ...
        static final int TRANSACTION_audioPause = 41;
        static final int TRANSACTION_audioResume = 42;
        static final int TRANSACTION_deinit = 8;
        static final int TRANSACTION_enableDynamicBitRateAdaptation = 31;
        static final int TRANSACTION_execRuntimeCommand = 38;
        static final int TRANSACTION_getCommonCapabilities = 24;
        static final int TRANSACTION_getCommonResolution = 29;
        static final int TRANSACTION_getConfigItems = 26;
        static final int TRANSACTION_getNegotiatedResolution = 30;
        static final int TRANSACTION_getStatus = 3;
        static final int TRANSACTION_getSupportedTypes = 2;
        static final int TRANSACTION_getUIBCStatus = 28;
        ...
        static final int TRANSACTION_queryTCPTransportSupport = 16;
        static final int TRANSACTION_registerHIDEventListener = 32;
        static final int TRANSACTION_registerListener = 6;
        static final int TRANSACTION_sendEvent = 35;
        static final int TRANSACTION_setAvPlaybackMode = 17;
        static final int TRANSACTION_setBitRate = 12;
        static final int TRANSACTION_setDecoderLatency = 15;
        static final int TRANSACTION_setDeviceType = 1;
        static final int TRANSACTION_setNegotiatedCapabilities = 25;
        static final int TRANSACTION_setResolution = 11;
        static final int TRANSACTION_setRtpTransport = 13;
        static final int TRANSACTION_setSurface = 34;
        static final int TRANSACTION_setSurfaceProp = 36;
        static final int TRANSACTION_setSurfacePropEx = 40;
        static final int TRANSACTION_setUIBC = 27;
        static final int TRANSACTION_standby = 21;
        static final int TRANSACTION_startUibcSession = 22;
        static final int TRANSACTION_startWfdSession = 9;
        static final int TRANSACTION_stopUibcSession = 23;
        static final int TRANSACTION_stopWfdSession = 10;
        static final int TRANSACTION_tcpPlaybackControl = 14;
        static final int TRANSACTION_teardown = 20;
        static final int TRANSACTION_toggleDSMode = 39;
        static final int TRANSACTION_uibcRotate = 37;
        static final int TRANSACTION_unregisterHIDEventListener = 33;
        static final int TRANSACTION_unregisterListener = 7;
        static final int TRANSACTION_videoPause = 43;
        static final int TRANSACTION_videoResume = 44;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setAvPlaybackMode /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setAvPlaybackMode(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_play /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = play();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_pause /*19*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = pause();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_teardown /*20*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = teardown();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_standby /*21*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = standby();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_startUibcSession /*22*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = startUibcSession();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_stopUibcSession /*23*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = stopUibcSession();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getCommonCapabilities /*24*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = new Bundle();
                    ...
                    return true;
                case TRANSACTION_setNegotiatedCapabilities /*25*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getConfigItems /*26*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = new Bundle();
                    ...
                    return true;
                case TRANSACTION_setUIBC /*27*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setUIBC();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_getUIBCStatus /*28*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result3 = getUIBCStatus();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case TRANSACTION_getCommonResolution /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = new Bundle();
                    ...
                    return true;
                case TRANSACTION_getNegotiatedResolution /*30*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = new Bundle();
                    ...
                    return true;
                case TRANSACTION_enableDynamicBitRateAdaptation /*31*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_sendEvent /*35*/:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setSurfaceProp /*36*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setSurfaceProp(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_uibcRotate /*37*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = uibcRotate(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_execRuntimeCommand /*38*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = execRuntimeCommand(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_toggleDSMode /*39*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = toggleDSMode(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_setSurfacePropEx /*40*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_audioPause /*41*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = audioPause();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_audioResume /*42*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = audioResume();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_videoPause /*43*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = videoPause();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_videoResume /*44*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = videoResume();
                    reply.writeNoException();
                    reply.writeInt(_result);
