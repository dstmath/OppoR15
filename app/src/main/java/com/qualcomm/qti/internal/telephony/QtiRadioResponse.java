...
public class QtiRadioResponse extends Stub {
    ...
    private void responseTxRxInfo(RadioResponseInfo responseInfo, OPPO_RIL_Tx_Rx_info ret) {
        ...
        Object info = new OppoTxRxInfo(ret.rx_chain_0_valid, oppoRxChainInfo, ret.rx_chain_1_valid, oppoRxChainInfo2, ret.tx_valid, new OppoTxInfo(ret.tx.is_in_traffic, ret.tx.tx_pwr));
        if (result != null && responseInfo.error == 0) {
