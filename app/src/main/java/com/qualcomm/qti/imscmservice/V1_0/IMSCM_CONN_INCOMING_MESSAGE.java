...
public final class IMSCM_CONN_INCOMING_MESSAGE {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.iMessageLen == other.iMessageLen && HidlSupport.deepEquals(this.pMessage, other.pMessage) && HidlSupport.deepEquals(this.recdAddr, other.recdAddr);
    }

    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.iMessageLen))), Integer.valueOf(HidlSupport.deepHashCode(this.pMessage)), Integer.valueOf(HidlSupport.deepHashCode(this.recdAddr))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.iMessageLen = _hidl_blob.getInt32(0 + _hidl_offset);
        this.pMessage = _hidl_blob.getString(8 + _hidl_offset);
        parcel.readEmbeddedBuffer((long) (this.pMessage.getBytes().length + 1), _hidl_blob.handle(), 0 + (8 + _hidl_offset), false);
        this.recdAddr = _hidl_blob.getString(24 + _hidl_offset);
        parcel.readEmbeddedBuffer((long) (this.recdAddr.getBytes().length + 1), _hidl_blob.handle(), 0 + (24 + _hidl_offset), false);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMSCM_CONN_INCOMING_MESSAGE> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((IMSCM_CONN_INCOMING_MESSAGE) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(0 + _hidl_offset, this.iMessageLen);
        _hidl_blob.putString(8 + _hidl_offset, this.pMessage);
        _hidl_blob.putString(24 + _hidl_offset, this.recdAddr);
    }
}
