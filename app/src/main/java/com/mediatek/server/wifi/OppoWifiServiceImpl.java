...
public abstract class OppoWifiServiceImpl extends Stub {
    ...
    public List<OppoWifiDevice> getConnectedStations() {
        if (this.mContext.getResources().getBoolean(17957022)) {
            return OppoHotspotClientInfo.getInstance(this.mContext).getConnectedStations();
        }
        return Collections.emptyList();
    }
        ...
        try {
            ...
            try {
                ...
                if (fstream != null) {
                    try {
                        ...
                        Slog.e(TAG, "IOException:" + ex22222);
                    }
                }
                throw th;
            }
            ...
            if (fstream != null) {
                try {
                    ...
                    Slog.e(TAG, "IOException:" + ex222222);
                }
            }
            return list;
        }
