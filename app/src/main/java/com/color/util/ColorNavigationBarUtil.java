...
public class ColorNavigationBarUtil {
    ...
    private static final String[] mNotFullScreenPackageName = new String[]{"com.srcb.mbank", "com.winsafe.mobilephone.syngenta", "com.city78.zipai.nearme.gamecenter", "cxboy.android.game.puzzle"};
