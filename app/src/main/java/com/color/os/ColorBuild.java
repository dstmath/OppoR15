...
public class ColorBuild {
    ...
    private static final String[] VERSIONS = new String[]{"V1.0", "V1.2", "V1.4", "V2.0", "V2.1", "V3.0", "V3.1", "V3.2", "V5.0", null};
    ...
    public static String getDeviceName(Context context) {
        ...
        name = Secure.getString(context.getContentResolver(), SECURE_SETTINGS_BLUETOOTH_NAME);
