...
import com.color.widget.ColorChildHelper.Callback;
...
public class ColorRecyclerView extends ViewGroup {
    ...
    public final class Recycler {
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            if (dryRun) {
                View view2 = ColorRecyclerView.this.mChildHelper.findHiddenNonRemovedView(position, type);
                if (view2 != null) {
                    ViewHolder vh2 = ColorRecyclerView.getChildViewHolderInt(view2);
                    ColorRecyclerView.this.mChildHelper.unhide(view2);
                    int layoutIndex2 = ColorRecyclerView.this.mChildHelper.indexOfChild(view2);
                    if (layoutIndex2 == -1) {
                        throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + vh2);
                    }
                    ColorRecyclerView.this.mChildHelper.detachViewFromParent(layoutIndex2);
                    scrapView(view2);
                    vh2.addFlags(8224);
                    return vh2;
                }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new ColorAdapterHelper(new ColorAdapterHelper.Callback() {
