...
public class ColorMultiChoiceAdapter extends ColorDecoratorAdapter implements ColorActionModeCallback, OnTouchListener {
    private static final /* synthetic */ int[] -com-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] -getcom-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues() {
        if (-com-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues != null) {
            return -com-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues;
        }
        ...
        -com-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public AnimatorMaker getAnimatorMaker(AnimatorType type) {
        switch (-getcom-color-widget-ColorMultiChoiceAdapter$AnimatorTypeSwitchesValues()[type.ordinal()]) {
            case 1:
