...
public abstract class ColorBottomMenuView extends View implements ColorBottomMenuCallback {
    ...
    private static final int[] MENU_VIEW_STATE_IDS = new int[]{R.attr.state_window_focused, 1, R.attr.state_selected, 2, R.attr.state_focused, 4, R.attr.state_enabled, 8, R.attr.state_pressed, 16, R.attr.state_activated, 32, R.attr.state_accelerated, 64, R.attr.state_hovered, 128, R.attr.state_drag_can_accept, 256, R.attr.state_drag_hovered, 512};
    ...
    private static final int MENU_VIEW_STYLEABLE_LENGTH = android.R.styleable.ViewDrawableStates.length;
    ...
    private class CheckForLongPress extends ItemStateRunnable {
        ...
        public void run() {
            ...
            if (ColorBottomMenuView.this.isItemPressedInternal(ColorBottomMenuView.this.getDrawItem(position)) && ColorBottomMenuView.this.getParent() != null && this.mOriginalWindowAttachCount == ColorBottomMenuView.this.getWindowAttachCount()) {
                ColorLog.d(BottomMenu.PRESS, ColorBottomMenuView.this.mTagClass, "CheckForLongPress : run");
    ...
    private class CheckForTap extends ItemStateRunnable {
        public CheckForTap(int position) {
            super(position);
        }
        ...
        public void run() {
            ...
            if (drawItem != null) {
                ColorLog.d(BottomMenu.PRESS, ColorBottomMenuView.this.mTagClass, "CheckForTap : run");
    ...
    private class DirectAnimator extends ColorFakeAnimator {
        /* synthetic */ DirectAnimator(ColorBottomMenuView this$0, DirectAnimator -this1) {
            this();
        }
        ...
        protected void onStart() {
            if (ColorBottomMenuView.this.mNextItems.size() > 0) {
                ColorLog.d(BottomMenu.ANIM, ColorBottomMenuView.this.mTagClass, "----------------------------DirectAnimator : onStart");
                for (DrawItem drawItem : ColorBottomMenuView.this.mCurrItems) {
    ...
    private class DirectUpdater implements Updater {
        /* synthetic */ DirectUpdater(ColorBottomMenuView this$0, DirectUpdater -this1) {
            this();
        }
        ...
        public Animator getUpdater(int currCount, int nextCount) {
            ColorLog.d(BottomMenu.ANIM, ColorBottomMenuView.this.mTagClass, "----------------------------getDirectUpdater : ", Integer.valueOf(currCount), "=>", Integer.valueOf(nextCount));
            ColorBottomMenuView.this.updateCurrItems();
            return new DirectAnimator(ColorBottomMenuView.this, null);
        }
    ...
    private class PerformClick extends ItemStateRunnable {
        ...
        public void run() {
            ColorLog.d(BottomMenu.PRESS, ColorBottomMenuView.this.mTagClass, "PerformClick : run");
    ...
    private class UnsetPressedState extends ItemStateRunnable {
        ...
        public void run() {
            ...
            if (drawItem != null) {
                ColorLog.d(BottomMenu.PRESS, ColorBottomMenuView.this.mTagClass, "UnsetPressedState : run");
    ...
    static {
        ...
        for (i = 0; i < MENU_VIEW_STYLEABLE_LENGTH; i++) {
            int menuViewState = android.R.styleable.ViewDrawableStates[i];
    ...
    private String getDisplayText(String rawString, DrawItem drawItem, int maxWidth) {
        ...
        return rawString.substring(0, breakIndex - 1) + Session.TRUNCATE_STRING;
    }
    ...
    public void updateMenuScrollState(int state) {
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "updateMenuScrollState : state=", Integer.valueOf(state));
        switch (state) {
            case 0:
                setMenuUpdateMode(0);
    ...
    public void updateMenuScrollData() {
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "updateMenuScrollData");
        updateCurrItems();
    }

    public void setMenuUpdateMode(int updateMode) {
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "------------------setUpdateMode=", Integer.valueOf(updateMode));
        switch (updateMode) {
            case 0:
    ...
    public void lockMenuUpdate() {
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "------------------lockMenuUpdate");
        this.mIsUpdateLocked = true;
    }

    public void unlockMenuUpdate() {
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "------------------unlockMenuUpdate");
        this.mIsUpdateLocked = false;
    }
    ...
    public void update(List<MenuItem> menuItems, boolean cleared) {
        ...
        if (this.mUpdateAnimator != null) {
            this.mUpdateAnimator.addListener(new AnimatorListenerAdapter() {
    ...
    public Animator getUpdater(List<MenuItem> menuItems, boolean cleared) {
        ...
        ColorLog.d(BottomMenu.UPDATE, this.mTagClass, "getUpdater : menuItems=", Integer.valueOf(getMenuCount(menuItems)), ", cleared=", Boolean.valueOf(cleared), ", mIsUpdateLocked=", Boolean.valueOf(this.mIsUpdateLocked), ", anim=", anim);
        return anim;
    }
    ...
    public boolean performClick(int position) {
        ...
        ColorLog.d(BottomMenu.PRESS, this.mTagClass, "performClick=", Integer.valueOf(position));
        playSoundEffect(0);
    ...
    void updateNextItems(List<MenuItem> menuItems) {
        ...
        if (menuItems != null) {
            synchronized (this.mNextItems) {
                ...
                ColorLog.d(BottomMenu.ITEM, this.mTagClass, (Object[]) new Object[]{"-----------------updateNextItems from MenuItems : ", Integer.valueOf(this.mNextItems.size())});
            }
        }
    }
    ...
    void onPerformClick(int position) {
        ColorLog.d(BottomMenu.PRESS, this.mTagClass, "onPerformClick");
    ...
    private void setItemPrepressedInternal(DrawItem drawItem, boolean prepressed) {
        if (drawItem != null && drawItem.hasMenuPrivateFlags(33554432) != prepressed) {
            if (prepressed) {
                drawItem.addMenuPrivateFlags(33554432);
            } else {
                drawItem.removeMenuPrivateFlags(33554432);
            }
        }
    }
    ...
    private void removeUnsetPressCallback() {
        if (this.mUnsetPressedState != null) {
            ColorLog.d(BottomMenu.PRESS, this.mTagClass, "removeUnsetPressCallback");
    ...
    private void removeTapCallback() {
        if (this.mPendingCheckForTap != null) {
            ColorLog.d(BottomMenu.PRESS, this.mTagClass, "removeTapCallback");
    ...
    private void removeLongPressCallback() {
        if (this.mPendingCheckForLongPress != null) {
            ColorLog.d(BottomMenu.PRESS, this.mTagClass, "removeLongPressCallback");
    ...
    private void removePerformClickCallback() {
        if (this.mPerformClick != null) {
            ColorLog.d(BottomMenu.PRESS, this.mTagClass, "removePerformClickCallback");
    ...
    private void updateTapCallback(int position) {
        if (this.mPendingCheckForTap == null) {
            this.mPendingCheckForTap = new CheckForTap(position);
    ...
    private void updateLongPressCallback(int position) {
        if (this.mPendingCheckForLongPress == null) {
            this.mPendingCheckForLongPress = new CheckForLongPress(position);
    ...
    private void updateCurrItems() {
        ...
        synchronized (this.mCurrItems) {
            ...
            ColorLog.d(BottomMenu.ITEM, this.mTagClass, "-----------------updateCurrItems from NextItems : ", Integer.valueOf(this.mCurrItems.size()));
        }
        requestLayout();
    }
    ...
    private void resetNextItems() {
        synchronized (this.mNextItems) {
            ...
            ColorLog.d(BottomMenu.ITEM, this.mTagClass, "-----------------resetNextItems from CurrItems : ", Integer.valueOf(this.mNextItems.size()));
        }
    }
