        ...
        if (this.mAdapter == null) {
            ...
            if (curItem != null) {
                ...
                if (extraWidthRight2 < 2.0f) {
                    ...
                    if (clientWidth2 <= 0) {
                        rightWidthNeeded2 = DURATION_SCALE;
                    } else {
            ...
            for (i = 0; i < childCount; i++) {
                ...
                lp2.childIndex = i;
                if (!lp2.isDecor && lp2.widthFactor == DURATION_SCALE) {
                    ii = infoForChild(child);
                    if (ii != null) {
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (dx == DURATION_SCALE || (isGutterDrag(this.mLastMotionX, dx) ^ 1) == 0 || !canScroll(this, false, (int) dx, (int) x2, (int) y)) {
