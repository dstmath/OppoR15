...
public interface ICameraService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraService {
        ...
        static final int TRANSACTION_registerVideoCallCallbacks = 16;
        static final int TRANSACTION_removeListener = 7;
        static final int TRANSACTION_setOtherAppStickerSelect = 18;
        static final int TRANSACTION_setOtherAppVideoBeauty = 19;
        static final int TRANSACTION_setTorchMode = 13;
        static final int TRANSACTION_supportsCameraApi = 12;
        static final int TRANSACTION_unregisterVideoCallCallbacks = 17;
        ...
        private static class Proxy implements ICameraService {
            ...
            public void registerVideoCallCallbacks(IVideoCallCallbacks videoCb) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void unregisterVideoCallCallbacks() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    registerVideoCallCallbacks(android.hardware.IVideoCallCallbacks.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterVideoCallCallbacks();
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void registerVideoCallCallbacks(IVideoCallCallbacks iVideoCallCallbacks) throws RemoteException;
    ...
    void unregisterVideoCallCallbacks() throws RemoteException;
}
