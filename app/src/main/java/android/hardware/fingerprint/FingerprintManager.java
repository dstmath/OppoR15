...
public class FingerprintManager {
    ...
    private class MyHandler extends Handler {
        /* synthetic */ MyHandler(FingerprintManager this$0, Context context, MyHandler -this2) {
            this(context);
        }

        /* synthetic */ MyHandler(FingerprintManager this$0, Looper looper, MyHandler -this2) {
            this(looper);
        }
