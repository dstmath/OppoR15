    ...
    public static int compareUTF16(char[] table, char[] primaries, int options, CharSequence left, CharSequence right, int startIndex) {
        ...
        if ((options & 1024) != 0) {
            ...
            while (true) {
                ...
                if (leftPair == rightPair) {
                    int leftCase2 = leftPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                    int rightCase2 = rightPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                    if (leftCase2 != rightCase2) {
                        if ((options & 256) == 0) {
                            return leftCase2 < rightCase2 ? -1 : 1;
                        }
                        return leftCase2 < rightCase2 ? 1 : -1;
                    } else if (leftPair == 2) {
                        rightIndex2 = rightIndex;
        ...
        while (true) {
            ...
            if (leftPair == rightPair) {
                int leftTertiary2 = leftPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                int rightTertiary2 = rightPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                if (leftTertiary2 != rightTertiary2) {
                    if (CollationSettings.sortsTertiaryUpperCaseFirst(options)) {
                        if (leftTertiary2 > 3) {
                            leftTertiary2 ^= 24;
                        }
                    ...
                    return leftTertiary2 < rightTertiary2 ? -1 : 1;
                } else if (leftPair == 2) {
                    break;
                } else {
                    leftPair >>>= 16;
        ...
        while (true) {
            ...
            if (leftPair == rightPair) {
                int leftQuaternary2 = leftPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                int rightQuaternary2 = rightPair & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                if (leftQuaternary2 != rightQuaternary2) {
                    return leftQuaternary2 < rightQuaternary2 ? -1 : 1;
                } else if (leftPair == 2) {
                    break;
                } else {
                    leftPair >>>= 16;
