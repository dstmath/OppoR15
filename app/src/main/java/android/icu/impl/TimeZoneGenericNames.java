...
public class TimeZoneGenericNames implements Serializable, Freezable<TimeZoneGenericNames> {
    ...
    public static class GenericMatchInfo {
        ...
        /* synthetic */ GenericMatchInfo(GenericNameType nameType, String tzID, int matchLength, GenericMatchInfo -this3) {
            this(nameType, tzID, matchLength);
        }
    ...
    /* synthetic */ TimeZoneGenericNames(ULocale locale, TimeZoneGenericNames -this1) {
        this(locale);
    }
