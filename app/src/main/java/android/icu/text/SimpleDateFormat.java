            ...
            while (start < text.length()) {
                ...
                if (UCharacter.isUWhiteSpace(c) && (PatternProps.isWhiteSpace(c) ^ 1) == 0) {
                    ...
                    switch (patternCharIndex) {
                        ...
                        case 2:
                        case 26:
                            if (count <= 2 || (number != null && getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC))) {
                                cal.set(2, value - 1);
                        ...
                        case 9:
                            break;
                        case 14:
                            if (this.formatData.ampmsNarrow == null || count < 5 || getBooleanAttribute(BooleanAttribute.PARSE_MULTIPLE_PATTERNS_FOR_MATCH)) {
                        ...
                        case 24:
                            ...
                            return pos.getIndex();
                        case 25:
                            if (count == 1 || (number != null && getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC))) {
                                cal.set(field, value);
                                return pos.getIndex();
                            }
                            newStart = 0;
                        ...
                        case 30:
                            ...
                            if (number == null || (!getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_NUMERIC) && this.formatData.shortYearNames != null && value <= this.formatData.shortYearNames.length)) {
                                return ~start;
                            }
                            cal.set(1, value);
                            return pos.getIndex();
