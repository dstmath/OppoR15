...
public class FontsContract {
    ...
    static /* synthetic */ void lambda$-android_provider_FontsContract_20965(Context context, CancellationSignal cancellationSignal, FontRequest request, Handler callerThreadHandler, FontRequestCallback callback) {
        int i = 0;
        try {
    ...
    static /* synthetic */ int lambda$-android_provider_FontsContract_31229(byte[] l, byte[] r) {
