...
public final class Settings {
    ...
    private static class NameValueCache {
        ...
        /* synthetic */ void lambda$-android_provider_Settings$NameValueCache_71783() {
            synchronized (this) {
    ...
    public static final class System extends NameValueTable implements Mtk_System, Qcom_System, Oppo_System {
        ...
        private static final Validator SCREEN_AUTO_BRIGHTNESS_ADJ_VALIDATOR = new InclusiveFloatRangeValidator(-1.0f, 4096.0f);
        ...
        private static final Validator SCREEN_BRIGHTNESS_VALIDATOR = new InclusiveIntegerRangeValidator(0, 4096);
