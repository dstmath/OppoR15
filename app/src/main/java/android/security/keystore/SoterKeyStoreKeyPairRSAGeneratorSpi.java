...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.security.keystore.SoterKeyStoreKeyPairRSAGeneratorSpi.initialize(java.security.spec.AlgorithmParameterSpec, java.security.SecureRandom):void, dom blocks: [B:2:0x0006, B:22:0x00db]
...
*/
    ...
    L_0x017f:
        ...
        r7 = 1;	 Catch:{ IllegalArgumentException -> 0x0157, IllegalArgumentException -> 0x0157 }
    ...
    public KeyPair generateKeyPair() {
        ...
        if ((flags & 1) == 0 || this.mKeyStore.state() == State.UNLOCKED) {
            ...
            KeymasterUtils.addUserAuthArgs(args, this.mSpec.isUserAuthenticationRequired(), this.mSpec.getUserAuthenticationValidityDurationSeconds(), false, true, 0);
