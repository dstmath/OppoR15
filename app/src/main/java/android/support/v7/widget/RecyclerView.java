...
public class RecyclerView extends ViewGroup {
    ...
    public final class Recycler {
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            if (dryRun) {
                View view2 = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(position, type);
                if (view2 != null) {
                    RecyclerView.this.mItemAnimator.endAnimation(RecyclerView.this.getChildViewHolder(view2));
                }
            }
            cacheSize = this.mCachedViews.size();
            i = 0;
