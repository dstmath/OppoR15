...
public abstract class ColorSpace {
    ...
    public static class Rgb extends ColorSpace {
        ...
        /* synthetic */ Rgb(Rgb colorSpace, float[] transform, float[] whitePoint, Rgb -this3) {
            this(colorSpace, transform, whitePoint);
        }

        /* synthetic */ Rgb(String name, float[] primaries, float[] whitePoint, double gamma, float min, float max, int id, Rgb -this7) {
            this(name, primaries, whitePoint, gamma, min, max, id);
        }
