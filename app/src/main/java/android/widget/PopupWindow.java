...
public class PopupWindow {
    ...
    private class PopupDecorView extends FrameLayout {
        ...
        /* synthetic */ void lambda$-android_widget_PopupWindow$PopupDecorView_94265(TransitionListener listener, Transition transition, View anchorRoot) {
    ...
    /* synthetic */ void lambda$-android_widget_PopupWindow_9628(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        alignToAnchor();
    }
