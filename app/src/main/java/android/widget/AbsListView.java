    ...
    private class CheckForLongPress extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            if (child != null) {
                ...
                boolean handled = false;
                if (sameWindow() && (AbsListView.this.mDataChanged ^ 1) != 0) {
            ...
            if (AbsListView.this.mTouchMode == 0) {
                ...
                if (child != null && (child.hasExplicitFocusable() ^ 1) != 0) {
                    ...
                    if (!AbsListView.this.mIsMutiPoint) {
                        -wrap2 = AbsListView.this.isInIgnoreArea(AbsListView.this.mDownX);
                    } else if (AbsListView.this.isInIgnoreArea(AbsListView.this.mDownX)) {
                        -wrap2 = AbsListView.this.isInIgnoreArea(AbsListView.this.mPointDownX);
                    } else {
                        runTap = false;
                ...
                if (child != null) {
                    ...
                    if (this.mIsMutiPoint) {
                        if ((isInIgnoreArea(this.mPointUpX) ^ 1) != 0) {
                            ...
                            if (this.mTouchMode == 0) {
                                Object checkForTap22 = this.mPendingCheckForLongPress;
                            } else {
                                checkForTap22 = this.mPendingCheckForTap;
                            }
                            removeCallbacks(checkForTap22);
                            this.mLayoutMode = 0;
                            if (this.mDataChanged) {
                                break;
                            }
                    ...
                    if (this.mTouchMode == 0) {
                        ...
                        Object checkForTap222 = this.mPendingCheckForLongPress;
                    }
                    removeCallbacks(checkForTap222);
                    this.mLayoutMode = 0;
                    if (this.mDataChanged) {
                        break;
                    }
