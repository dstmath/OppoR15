                ...
                if (this.mItemCount == 0) {
                    ...
                    if (viewRootImpl2 != null) {
                        ...
                        if (focusHost2 != null) {
                            ...
                            if (focusChild2 != null) {
                                if (!dataChanged || isDirectChildHeaderOrFooter(focusChild2) || (focusChild2.hasTransientState() && this.mAdapterHasStableIds)) {
                    ...
                    if (focusedChild2 != null) {
                        if (!dataChanged || isDirectChildHeaderOrFooter(focusedChild2) || focusedChild2.hasTransientState() || this.mAdapterHasStableIds) {
                            focusLayoutRestoreDirectChild2 = focusedChild2;
                    ...
                    switch (this.mLayoutMode) {
                        ...
                        case 2:
                            if (newSel != null) {
                                ...
                                sel2 = fillFromMiddle(childrenTop, childrenBottom);
                                break;
                            }
                        case 3:
                            ...
                            break;
                        case 4:
                            int selectedPosition2 = reconcileSelectedPosition();
                            sel2 = fillSpecific(selectedPosition2, this.mSpecificTop);
                            if (sel2 == null && this.mFocusSelector != null) {
                                Runnable focusRunnable2 = this.mFocusSelector.setupFocusIfValid(selectedPosition2);
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            sel2 = moveSelection(oldSel, newSel, delta, childrenTop, childrenBottom);
                            break;
                        default:
                            int i22;
                            if (childCount == 0) {
                    ...
                    removeUnusedFixedViews(this.mFooterViewInfos);
                    if (sel2 != null) {
                        if (this.mItemsCanFocus && hasFocus() && (sel2.hasFocus() ^ 1) != 0) {
                            boolean focusWasTaken2;
                            if (sel2 == focusLayoutRestoreDirectChild2 && focusLayoutRestoreView2 != null && focusLayoutRestoreView2.requestFocus()) {
                                focusWasTaken2 = true;
                            } else {
                                focusWasTaken2 = sel2.requestFocus();
                            }
                            if (focusWasTaken2) {
                                sel2.setSelected(false);
                                this.mSelectorRect.setEmpty();
                            } else {
                                View focused2 = getFocusedChild();
                                if (focused2 != null) {
                                    focused2.clearFocus();
                                }
                        ...
                        boolean inTouchMode2 = this.mTouchMode != 1 ? this.mTouchMode == 2 : true;
                        View child2;
                        if (inTouchMode2) {
