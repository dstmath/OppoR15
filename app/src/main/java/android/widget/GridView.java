...
public class GridView extends AbsListView {
    ...
    protected void layoutChildren() {
        ...
        try {
                ...
                case 6:
                    ...
                    if (this.mItemCount == 0) {
                        ...
                        if (viewRootImpl2 != null) {
                            View focusHost2 = viewRootImpl2.getAccessibilityFocusedHost();
                            if (focusHost2 != null) {
                                View focusChild2 = getAccessibilityFocusedChild(focusHost2);
                                if (focusChild2 != null) {
                                    if (!dataChanged || focusChild2.hasTransientState() || this.mAdapterHasStableIds) {
                                        accessibilityFocusLayoutRestoreView2 = focusHost2;
                                        accessibilityFocusLayoutRestoreNode2 = viewRootImpl2.getAccessibilityFocusedVirtualView();
                                    }
                                    accessibilityFocusPosition2 = getPositionForView(focusChild2);
                                }
                            }
                        }
                        ...
                        if (dataChanged) {
                            for (int i3 = 0; i3 < childCount; i3++) {
                                recycleBin2.addScrapView(getChildAt(i3), firstPosition2 + i3);
                            }
                        } else {
                            recycleBin2.fillActiveViews(childCount, firstPosition2);
                        }
                        detachAllViewsFromParent();
                        ...
                        switch (this.mLayoutMode) {
                            case 1:
                                this.mFirstPosition = 0;
                                sel2 = fillFromTop(childrenTop);
                                adjustViewsUpOrDown();
                                break;
                            case 2:
                                if (newSel == null) {
                                    sel2 = fillSelection(childrenTop, childrenBottom);
                                    break;
                                } else {
                                    sel2 = fillFromSelection(newSel.getTop(), childrenTop, childrenBottom);
                                    break;
                                }
                            case 3:
                                sel2 = fillUp(this.mItemCount - 1, childrenBottom);
                                adjustViewsUpOrDown();
                                break;
                            case 4:
                                sel2 = fillSpecific(this.mSelectedPosition, this.mSpecificTop);
                                break;
                            case 5:
                                sel2 = fillSpecific(this.mSyncPosition, this.mSpecificTop);
                                break;
                            case 6:
                                sel2 = moveSelection(delta, childrenTop, childrenBottom);
                                break;
                            default:
                                int i22;
                                if (childCount != 0) {
                                    if (this.mSelectedPosition >= 0 && this.mSelectedPosition < this.mItemCount) {
                                        i22 = this.mSelectedPosition;
                                        if (oldSel != null) {
                                            childrenTop = oldSel.getTop();
                                        }
                                        sel2 = fillSpecific(i22, childrenTop);
                                        break;
                                    } else {
                                        if (this.mFirstPosition >= this.mItemCount) {
                                    ...
                                    i22 = (this.mAdapter == null || isInTouchMode()) ? -1 : 0;
                                    setSelectedPositionInt(i22);
                                    sel2 = fillFromTop(childrenTop);
                                    break;
                                } else {
                                    int last2 = this.mItemCount - 1;
                                    if (this.mAdapter == null || isInTouchMode()) {
                                        i22 = -1;
                                    } else {
                                        i22 = last2;
                                    ...
                                    setSelectedPositionInt(i22);
                                    sel2 = fillFromBottom(last2, childrenBottom);
                                    break;
                                }
                                break;
                        }
                        ...
                        if (sel2 != null) {
                            positionSelector(-1, sel2);
                            this.mSelectedTop = sel2.getTop();
                        } else {
                            boolean inTouchMode2 = this.mTouchMode > 0 ? this.mTouchMode < 3 : false;
                            View child2;
                            if (inTouchMode2) {
                                child2 = getChildAt(this.mMotionPosition - this.mFirstPosition);
                                if (child2 != null) {
                                    positionSelector(this.mMotionPosition, child2);
                                }
                            } else if (this.mSelectedPosition != -1) {
                                child2 = getChildAt(this.mSelectorPosition - this.mFirstPosition);
                                if (child2 != null) {
                        ...
                        if (viewRootImpl2 != null && viewRootImpl2.getAccessibilityFocusedHost() == null) {
                            if (accessibilityFocusLayoutRestoreView2 != null && accessibilityFocusLayoutRestoreView2.isAttachedToWindow()) {
                                AccessibilityNodeProvider provider2 = accessibilityFocusLayoutRestoreView2.getAccessibilityNodeProvider();
                                if (accessibilityFocusLayoutRestoreNode2 == null || provider2 == null) {
                                    accessibilityFocusLayoutRestoreView2.requestAccessibilityFocus();
                                } else {
                                    provider2.performAction(AccessibilityNodeInfo.getVirtualDescendantId(accessibilityFocusLayoutRestoreNode2.getSourceNodeId()), 64, null);
                                }
                            } else if (accessibilityFocusPosition2 != -1) {
                                View restoreView2 = getChildAt(MathUtils.constrain(accessibilityFocusPosition2 - this.mFirstPosition, 0, getChildCount() - 1));
                                if (restoreView2 != null) {
                                    restoreView2.requestAccessibilityFocus();
                                }
                            }
                        }
                        this.mLayoutMode = 0;
            ...
            View sel22;
            setSelectedPositionInt(this.mNextSelectedPosition);
            AccessibilityNodeInfo accessibilityFocusLayoutRestoreNode22 = null;
            View accessibilityFocusLayoutRestoreView22 = null;
            int accessibilityFocusPosition22 = -1;
            ViewRootImpl viewRootImpl22 = getViewRootImpl();
            if (viewRootImpl22 != null) {
                View focusHost22 = viewRootImpl22.getAccessibilityFocusedHost();
                if (focusHost22 != null) {
                    View focusChild22 = getAccessibilityFocusedChild(focusHost22);
                    if (focusChild22 != null) {
                        if (!dataChanged || focusChild22.hasTransientState() || this.mAdapterHasStableIds) {
                            accessibilityFocusLayoutRestoreView22 = focusHost22;
                            accessibilityFocusLayoutRestoreNode22 = viewRootImpl22.getAccessibilityFocusedVirtualView();
                        }
                        accessibilityFocusPosition22 = getPositionForView(focusChild22);
                    }
                }
            }
            int firstPosition22 = this.mFirstPosition;
            RecycleBin recycleBin22 = this.mRecycler;
            if (dataChanged) {
                for (int i32 = 0; i32 < childCount; i32++) {
                    recycleBin22.addScrapView(getChildAt(i32), firstPosition22 + i32);
                }
            } else {
                recycleBin22.fillActiveViews(childCount, firstPosition22);
            }
            detachAllViewsFromParent();
            recycleBin22.removeSkippedScrap();
            switch (this.mLayoutMode) {
                case 1:
                    this.mFirstPosition = 0;
                    sel22 = fillFromTop(childrenTop);
                    adjustViewsUpOrDown();
                    break;
                case 2:
                    if (newSel == null) {
                        sel22 = fillSelection(childrenTop, childrenBottom);
                        break;
                    } else {
                        sel22 = fillFromSelection(newSel.getTop(), childrenTop, childrenBottom);
                        break;
                    }
                case 3:
                    sel22 = fillUp(this.mItemCount - 1, childrenBottom);
                    adjustViewsUpOrDown();
                    break;
                case 4:
                    sel22 = fillSpecific(this.mSelectedPosition, this.mSpecificTop);
                    break;
                case 5:
                    sel22 = fillSpecific(this.mSyncPosition, this.mSpecificTop);
                    break;
                case 6:
                    sel22 = moveSelection(delta, childrenTop, childrenBottom);
                    break;
                default:
                    int i222;
                    if (childCount != 0) {
                        if (this.mSelectedPosition >= 0 && this.mSelectedPosition < this.mItemCount) {
                            i222 = this.mSelectedPosition;
                            if (oldSel != null) {
                                childrenTop = oldSel.getTop();
                            }
                            sel22 = fillSpecific(i222, childrenTop);
                            break;
                        } else {
                            if (this.mFirstPosition >= this.mItemCount) {
                                sel22 = fillSpecific(0, childrenTop);
                                break;
                            }
                            i222 = this.mFirstPosition;
                            if (oldFirst != null) {
                                childrenTop = oldFirst.getTop();
                            }
                            sel22 = fillSpecific(i222, childrenTop);
                        ...
                        i222 = (this.mAdapter == null || isInTouchMode()) ? -1 : 0;
                        setSelectedPositionInt(i222);
                        sel22 = fillFromTop(childrenTop);
                        break;
                    } else {
                        int last22 = this.mItemCount - 1;
                        if (this.mAdapter == null || isInTouchMode()) {
                            i222 = -1;
                        } else {
                            i222 = last22;
                        ...
                        setSelectedPositionInt(i222);
                        sel22 = fillFromBottom(last22, childrenBottom);
                        break;
                    }
                    break;
            }
            recycleBin22.scrapActiveViews();
            if (sel22 != null) {
                positionSelector(-1, sel22);
                this.mSelectedTop = sel22.getTop();
            } else {
                boolean inTouchMode22 = this.mTouchMode > 0 ? this.mTouchMode < 3 : false;
                View child22;
                if (inTouchMode22) {
                    child22 = getChildAt(this.mMotionPosition - this.mFirstPosition);
                    if (child22 != null) {
                        positionSelector(this.mMotionPosition, child22);
                    }
                } else if (this.mSelectedPosition != -1) {
                    child22 = getChildAt(this.mSelectorPosition - this.mFirstPosition);
                    if (child22 != null) {
                        positionSelector(this.mSelectorPosition, child22);
                    }
                } else {
                    this.mSelectedTop = 0;
                    this.mSelectorRect.setEmpty();
            ...
            if (viewRootImpl22 != null && viewRootImpl22.getAccessibilityFocusedHost() == null) {
                if (accessibilityFocusLayoutRestoreView22 != null && accessibilityFocusLayoutRestoreView22.isAttachedToWindow()) {
                    AccessibilityNodeProvider provider22 = accessibilityFocusLayoutRestoreView22.getAccessibilityNodeProvider();
                    if (accessibilityFocusLayoutRestoreNode22 == null || provider22 == null) {
                        accessibilityFocusLayoutRestoreView22.requestAccessibilityFocus();
                    } else {
                        provider22.performAction(AccessibilityNodeInfo.getVirtualDescendantId(accessibilityFocusLayoutRestoreNode22.getSourceNodeId()), 64, null);
                    }
                } else if (accessibilityFocusPosition22 != -1) {
                    View restoreView22 = getChildAt(MathUtils.constrain(accessibilityFocusPosition22 - this.mFirstPosition, 0, getChildCount() - 1));
                    if (restoreView22 != null) {
                        restoreView22.requestAccessibilityFocus();
                    }
                }
            }
            this.mLayoutMode = 0;
