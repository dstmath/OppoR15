...
public interface IPackageManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPackageManager {
        ...
        static final int TRANSACTION_addDisallowUninstallApps = 203;
        static final int TRANSACTION_addInstallPackageBlacklist = 207;
        static final int TRANSACTION_addInstallPackageWhitelist = 206;
        static final int TRANSACTION_addInstallSource = 202;
        ...
        static final int TRANSACTION_checkEMMApkRuntimePermission = 197;
        ...
        static final int TRANSACTION_deleteInstallSource = 201;
        ...
        static final int TRANSACTION_enableInstallSource = 200;
        ...
        static final int TRANSACTION_getActivityIconsCache = 193;
        ...
        static final int TRANSACTION_getAppIconBitmap = 190;
        static final int TRANSACTION_getAppIconsCache = 191;
        ...
        static final int TRANSACTION_getDisallowUninstallApps = 205;
        ...
        static final int TRANSACTION_getInstallSourceList = 199;
        ...
        static final int TRANSACTION_getOppoSystemAvailableFeatures = 189;
        ...
        static final int TRANSACTION_inPmsWhiteList = 196;
        static final int TRANSACTION_installExistingPackageAsUser = 133;
        static final int TRANSACTION_installPackageAsUser = 60;
        static final int TRANSACTION_isClosedSuperFirewall = 187;
        static final int TRANSACTION_isFirstBoot = 144;
        static final int TRANSACTION_isFullFunctionMode = 186;
        static final int TRANSACTION_isInstallSourceEnable = 198;
        ...
        static final int TRANSACTION_isSecurePayApp = 192;
        static final int TRANSACTION_isStorageLow = 149;
        static final int TRANSACTION_isSystemDataApp = 194;
        static final int TRANSACTION_isUidPrivileged = 40;
        static final int TRANSACTION_isUpgrade = 146;
        static final int TRANSACTION_loadRegionFeature = 188;
        ...
        static final int TRANSACTION_prohibitChildInstallation = 195;
        ...
        static final int TRANSACTION_removeDisallowUninstallApps = 204;
