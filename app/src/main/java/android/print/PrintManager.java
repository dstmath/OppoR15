...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.print.PrintManager.PrintDocumentAdapterDelegate.MyLayoutResultCallback.onLayoutFinished(android.print.PrintDocumentInfo, boolean):void, dom blocks: [B:12:0x001b, B:18:0x0029]
...
*/
        ...
        private final class MyWriteResultCallback extends WriteResultCallback implements DestroyableCallback {
            ...
            public void onWriteFinished(android.print.PageRange[] r5) {
                /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:android.print.PrintManager.PrintDocumentAdapterDelegate.MyWriteResultCallback.onWriteFinished(android.print.PageRange[]):void, dom blocks: [B:12:0x001b, B:23:0x0035]
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:89)
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.process(ProcessTryCatchRegions.java:45)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.postProcessRegions(RegionMakerVisitor.java:63)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:58)
