...
public final class ActivityThread {
    ...
    static final class ActivityClientRecord {
        ...
        /* synthetic */ void lambda$-android_app_ActivityThread$ActivityClientRecord_17618(Configuration overrideConfig, int newDisplayId) {
    ...
    private android.app.Activity performLaunchActivity(android.app.ActivityThread.ActivityClientRecord r26, android.content.Intent r27) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Unknown predecessor block by arg (r21_3 'component' android.content.ComponentName) in PHI: PHI: (r21_4 'component' android.content.ComponentName) = (r21_2 'component' android.content.ComponentName), (r21_3 'component' android.content.ComponentName) binds: {(r21_2 'component' android.content.ComponentName)=B:7:0x0048, (r21_3 'component' android.content.ComponentName)=B:8:0x004a}
...
*/
    ...
    L_0x0029:
        ...
        r3 = r0.intent;
        r0 = r25;
        r4 = r0.mInitialApplication;
        r4 = r4.getPackageManager();
        r21 = r3.resolveActivity(r4);
        r0 = r26;
        r3 = r0.intent;
        r0 = r21;
        r3.setComponent(r0);
    ...
    L_0x004a:
        ...
        r0 = r26;
        r4 = r0.activityInfo;
        r4 = r4.targetActivity;
        r0 = r21;
        r0.<init>(r3, r4);
    L_0x005d:
        r2 = r25.createBaseContextForActivity(r26);
        r1 = 0;
        r20 = r2.getClassLoader();	 Catch:{ Exception -> 0x024f }
        r0 = r25;	 Catch:{ Exception -> 0x024f }
        r3 = r0.mInstrumentation;	 Catch:{ Exception -> 0x024f }
        r4 = r21.getClassName();	 Catch:{ Exception -> 0x024f }
        r0 = r26;	 Catch:{ Exception -> 0x024f }
        r5 = r0.intent;	 Catch:{ Exception -> 0x024f }
        r0 = r20;	 Catch:{ Exception -> 0x024f }
        r1 = r3.newActivity(r0, r4, r5);	 Catch:{ Exception -> 0x024f }
        r3 = r1.getClass();	 Catch:{ Exception -> 0x024f }
        android.os.StrictMode.incrementExpectedActivityCount(r3);	 Catch:{ Exception -> 0x024f }
        r0 = r26;	 Catch:{ Exception -> 0x024f }
        r3 = r0.intent;	 Catch:{ Exception -> 0x024f }
        r0 = r20;	 Catch:{ Exception -> 0x024f }
        r3.setExtrasClassLoader(r0);	 Catch:{ Exception -> 0x024f }
        r0 = r26;	 Catch:{ Exception -> 0x024f }
        r3 = r0.intent;	 Catch:{ Exception -> 0x024f }
        r3.prepareToEnterProcess();	 Catch:{ Exception -> 0x024f }
        r0 = r26;	 Catch:{ Exception -> 0x024f }
        r3 = r0.state;	 Catch:{ Exception -> 0x024f }
        if (r3 == 0) goto L_0x009e;	 Catch:{ Exception -> 0x024f }
    L_0x0095:
        r0 = r26;	 Catch:{ Exception -> 0x024f }
        r3 = r0.state;	 Catch:{ Exception -> 0x024f }
        r0 = r20;	 Catch:{ Exception -> 0x024f }
        r3.setClassLoader(r0);	 Catch:{ Exception -> 0x024f }
    L_0x009e:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.packageInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.mInstrumentation;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r7 = r3.makeApplication(r5, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = localLOGV;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x00cb;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x00af:
        r3 = "ActivityThread";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = new java.lang.StringBuilder;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4.<init>();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = "Performing launch of ";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r0);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.toString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        android.util.Slog.v(r3, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x00cb:
        r3 = localLOGV;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x013b;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x00cf:
        r3 = "ActivityThread";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = new java.lang.StringBuilder;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4.<init>();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r0);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = ": app=";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r7);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = ", appName=";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r7.getPackageName();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = ", pkg=";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.packageInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.getPackageName();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = ", comp=";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.intent;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.getComponent();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.toShortString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = ", dir=";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.packageInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.getAppDir();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.toString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        android.util.Slog.v(r3, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x013b:
        if (r1 == 0) goto L_0x0380;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x013d:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.activityInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r2.getPackageManager();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r10 = r3.loadLabel(r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r14 = new android.content.res.Configuration;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mCompatConfiguration;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r14.<init>(r3);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.overrideConfig;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x015f;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0158:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.overrideConfig;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r14.updateFrom(r3);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x015f:
        r3 = DEBUG_CONFIGURATION;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x018e;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0163:
        r3 = "ActivityThread";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = new java.lang.StringBuilder;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4.<init>();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = "Launching activity ";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.activityInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.name;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = " with config ";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r14);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.toString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        android.util.Slog.v(r3, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x018e:
        r17 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mPendingRemoveWindow;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x01ac;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0196:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mPreserveWindow;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x01ac;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x019c:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r0.mPendingRemoveWindow;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r17 = r0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.mPendingRemoveWindow = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.mPendingRemoveWindowManager = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x01ac:
        r2.setOuterContext(r1);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r25.getInstrumentation();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.token;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r6 = r0.ident;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r8 = r0.intent;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r9 = r0.activityInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r11 = r0.parent;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r12 = r0.embeddedID;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r13 = r0.lastNonConfigurationInstances;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r15 = r0.referrer;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r0.voiceInteractor;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r16 = r0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r0.configCallback;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r18 = r0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.attach(r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r27 == 0) goto L_0x01ea;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x01e6:
        r0 = r27;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.mIntent = r0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x01ea:
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.lastNonConfigurationInstances = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r25.checkAndBlockForNetworkAccess();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.mStartedActivity = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.activityInfo;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r24 = r3.getThemeResource();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r24 == 0) goto L_0x0204;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x01ff:
        r0 = r24;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.setTheme(r0);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0204:
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.mCalled = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r26.isPersistable();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x0289;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x020d:
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mInstrumentation;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.state;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.persistentState;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnCreate(r1, r4, r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x021c:
        r3 = r1.mCalled;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x02cf;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0220:
        r3 = new android.util.SuperNotCalledException;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = new java.lang.StringBuilder;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4.<init>();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = "Activity ";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.intent;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.getComponent();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r5.toShortString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = " did not call through to super.onCreate()";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.toString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.<init>(r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        throw r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x024d:
        r22 = move-exception;
        throw r22;
    L_0x024f:
        r23 = move-exception;
        r0 = r25;
        r3 = r0.mInstrumentation;
        r0 = r23;
        r3 = r3.onException(r1, r0);
        if (r3 != 0) goto L_0x009e;
    L_0x025c:
        r3 = new java.lang.RuntimeException;
        r4 = new java.lang.StringBuilder;
        r4.<init>();
        r5 = "Unable to instantiate activity ";
        r4 = r4.append(r5);
        r0 = r21;
        r4 = r4.append(r0);
        r5 = ": ";
    ...
    L_0x0289:
        ...
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.state;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnCreate(r1, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        goto L_0x021c;
    L_0x0295:
        r23 = move-exception;
        r0 = r25;
    ...
    L_0x02cf:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.activity = r1;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = 1;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.stopped = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.activity;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r3.mFinished;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x02e8;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x02e0:
        r1.performStart();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.stopped = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x02e8:
        ...
        r3 = r0.activity;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r3.mFinished;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x0311;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x02f0:
        r3 = r26.isPersistable();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x0362;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x02f6:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.state;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x0302;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x02fc:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.persistentState;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x0311;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0302:
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mInstrumentation;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        ...
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.persistentState;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnRestoreInstanceState(r1, r4, r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0311:
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.activity;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r3.mFinished;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x0380;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0319:
        r3 = 0;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r1.mCalled = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r26.isPersistable();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 == 0) goto L_0x0374;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0322:
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mInstrumentation;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        ...
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = r0.persistentState;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnPostCreate(r1, r4, r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0331:
        r3 = r1.mCalled;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        if (r3 != 0) goto L_0x0380;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0335:
        ...
        r5 = r5.toShortString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r5 = " did not call through to super.onPostCreate()";	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.append(r5);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r4.toString();	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.<init>(r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        throw r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    ...
    L_0x0368:
        ...
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.state;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnRestoreInstanceState(r1, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        goto L_0x0311;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0374:
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mInstrumentation;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.state;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.callActivityOnPostCreate(r1, r4);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        goto L_0x0331;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0380:
        r3 = 1;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0.paused = r3;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r25;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3 = r0.mActivities;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r4 = r0.token;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r0 = r26;	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
        r3.put(r4, r0);	 Catch:{ SuperNotCalledException -> 0x024d, Exception -> 0x0295 }
    L_0x0392:
        return r1;
        */
    ...
    private void handleLaunchActivity(ActivityClientRecord r, Intent customIntent, String reason) {
        ...
        if (localLOGV || this.mIsDebugTarget) {
    ...
    private void handleReceiver(android.app.ActivityThread.ReceiverData r15) {
        /* JADX: method processing error */
/*
...
*/
        ...
        r14 = this;
        r13 = 0;
        r14.unscheduleGcIdler();
        r10 = r15.intent;
        r10 = r10.getComponent();
        r2 = r10.getClassName();
        r10 = r15.info;
        r10 = r10.applicationInfo;
        r11 = r15.compatInfo;
        r8 = r14.getPackageInfoNoCheck(r10, r11);
        r7 = android.app.ActivityManager.getService();
        r10 = r14.mInstrumentation;	 Catch:{ Exception -> 0x00ff }
        r11 = 0;	 Catch:{ Exception -> 0x00ff }
        r0 = r8.makeApplication(r11, r10);	 Catch:{ Exception -> 0x00ff }
        r3 = r0.getBaseContext();	 Catch:{ Exception -> 0x00ff }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x00ff }
        r10 = r15.info;	 Catch:{ Exception -> 0x00ff }
        r10 = r10.splitName;	 Catch:{ Exception -> 0x00ff }
        if (r10 == 0) goto L_0x0039;	 Catch:{ Exception -> 0x00ff }
    L_0x002f:
        r10 = r15.info;	 Catch:{ Exception -> 0x00ff }
        r10 = r10.splitName;	 Catch:{ Exception -> 0x00ff }
        r3 = r3.createContextForSplit(r10);	 Catch:{ Exception -> 0x00ff }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x00ff }
    L_0x0039:
        r1 = r3.getClassLoader();	 Catch:{ Exception -> 0x00ff }
        r10 = r15.intent;	 Catch:{ Exception -> 0x00ff }
        r10.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x00ff }
        r10 = r15.intent;	 Catch:{ Exception -> 0x00ff }
        r10.prepareToEnterProcess();	 Catch:{ Exception -> 0x00ff }
        r15.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x00ff }
        r10 = r1.loadClass(r2);	 Catch:{ Exception -> 0x00ff }
        r9 = r10.newInstance();	 Catch:{ Exception -> 0x00ff }
        r9 = (android.content.BroadcastReceiver) r9;	 Catch:{ Exception -> 0x00ff }
        r10 = DEBUG_BROADCAST;	 Catch:{ Exception -> 0x0150 }
        if (r10 == 0) goto L_0x00c1;	 Catch:{ Exception -> 0x0150 }
    L_0x0058:
        r10 = "ActivityThread";	 Catch:{ Exception -> 0x0150 }
        r11 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0150 }
        r11.<init>();	 Catch:{ Exception -> 0x0150 }
        r12 = "Performing receive of ";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = ": app=";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r0);	 Catch:{ Exception -> 0x0150 }
        r12 = ", appName=";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = r0.getPackageName();	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = ", pkg=";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = r8.getPackageName();	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = ", comp=";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r12 = r12.getComponent();	 Catch:{ Exception -> 0x0150 }
        r12 = r12.toShortString();	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = ", dir=";	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r12 = r8.getAppDir();	 Catch:{ Exception -> 0x0150 }
        r11 = r11.append(r12);	 Catch:{ Exception -> 0x0150 }
        r11 = r11.toString();	 Catch:{ Exception -> 0x0150 }
        android.util.Slog.v(r10, r11);	 Catch:{ Exception -> 0x0150 }
    L_0x00c1:
        r6 = r15.getOrder();	 Catch:{ Exception -> 0x0150 }
        if (r6 == 0) goto L_0x00d1;	 Catch:{ Exception -> 0x0150 }
    L_0x00c7:
        r10 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r5 = r10.getFlags();	 Catch:{ Exception -> 0x0150 }
        r10 = 2;	 Catch:{ Exception -> 0x0150 }
        r15.setBroadcastState(r5, r10);	 Catch:{ Exception -> 0x0150 }
    L_0x00d1:
        r10 = sCurrentBroadcastIntent;	 Catch:{ Exception -> 0x0150 }
        r11 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r10.set(r11);	 Catch:{ Exception -> 0x0150 }
        r9.setPendingResult(r15);	 Catch:{ Exception -> 0x0150 }
        r10 = r3.getReceiverRestrictedContext();	 Catch:{ Exception -> 0x0150 }
        r11 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r9.onReceive(r10, r11);	 Catch:{ Exception -> 0x0150 }
        if (r6 == 0) goto L_0x00f0;	 Catch:{ Exception -> 0x0150 }
    L_0x00e6:
        r10 = r15.intent;	 Catch:{ Exception -> 0x0150 }
        r5 = r10.getFlags();	 Catch:{ Exception -> 0x0150 }
        r10 = 3;	 Catch:{ Exception -> 0x0150 }
        r15.setBroadcastState(r5, r10);	 Catch:{ Exception -> 0x0150 }
    L_0x00f0:
        r10 = sCurrentBroadcastIntent;
        r10.set(r13);
    L_0x00f5:
        r10 = r9.getPendingResult();
    ...
    L_0x0104:
        ...
        r11.<init>();
        r12 = "Finishing failed broadcast to ";
        r11 = r11.append(r12);
        r12 = r15.intent;
        r12 = r12.getComponent();
        r11 = r11.append(r12);
        r11 = r11.toString();
        android.util.Slog.i(r10, r11);
    L_0x0124:
        r15.sendFinished(r7);
        r10 = new java.lang.RuntimeException;
        r11 = new java.lang.StringBuilder;
        r11.<init>();
        r12 = "Unable to instantiate receiver ";
        r11 = r11.append(r12);
        r11 = r11.append(r2);
        r12 = ": ";
        r11 = r11.append(r12);
    ...
    L_0x0150:
        r4 = move-exception;
        r10 = DEBUG_BROADCAST;	 Catch:{ all -> 0x01a9 }
        if (r10 == 0) goto L_0x0175;	 Catch:{ all -> 0x01a9 }
    L_0x0155:
        r10 = "ActivityThread";	 Catch:{ all -> 0x01a9 }
        r11 = new java.lang.StringBuilder;	 Catch:{ all -> 0x01a9 }
        r11.<init>();	 Catch:{ all -> 0x01a9 }
        r12 = "Finishing failed broadcast to ";	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r12);	 Catch:{ all -> 0x01a9 }
        r12 = r15.intent;	 Catch:{ all -> 0x01a9 }
        r12 = r12.getComponent();	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r12);	 Catch:{ all -> 0x01a9 }
        r11 = r11.toString();	 Catch:{ all -> 0x01a9 }
        android.util.Slog.i(r10, r11);	 Catch:{ all -> 0x01a9 }
    L_0x0175:
        r15.sendFinished(r7);	 Catch:{ all -> 0x01a9 }
        r10 = r14.mInstrumentation;	 Catch:{ all -> 0x01a9 }
        r10 = r10.onException(r9, r4);	 Catch:{ all -> 0x01a9 }
        if (r10 != 0) goto L_0x01b0;	 Catch:{ all -> 0x01a9 }
    L_0x0180:
        r10 = new java.lang.RuntimeException;	 Catch:{ all -> 0x01a9 }
        r11 = new java.lang.StringBuilder;	 Catch:{ all -> 0x01a9 }
        r11.<init>();	 Catch:{ all -> 0x01a9 }
        r12 = "Unable to start receiver ";	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r12);	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r2);	 Catch:{ all -> 0x01a9 }
        r12 = ": ";	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r12);	 Catch:{ all -> 0x01a9 }
        r12 = r4.toString();	 Catch:{ all -> 0x01a9 }
        r11 = r11.append(r12);	 Catch:{ all -> 0x01a9 }
        r11 = r11.toString();	 Catch:{ all -> 0x01a9 }
        r10.<init>(r11, r4);	 Catch:{ all -> 0x01a9 }
        throw r10;	 Catch:{ all -> 0x01a9 }
    L_0x01a9:
        r10 = move-exception;
        r11 = sCurrentBroadcastIntent;
        r11.set(r13);
        throw r10;
    L_0x01b0:
        r10 = sCurrentBroadcastIntent;
        ...
        synchronized (this.mResourcesManager) {
            ...
            if (target2 != null) {
                ...
                try {
                    ...
                    target.mPreserveWindow = preserveWindow;
                    if (!fromServer) {
                        ActivityClientRecord existing2 = (ActivityClientRecord) this.mActivities.get(token);
                        if (existing2 != null) {
                            target.startsNotResumed = existing2.paused;
                            target.overrideConfig = existing2.overrideConfig;
                        }
                        target.onlyLocalRequest = true;
                    }
                    this.mRelaunchingActivities.add(target);
    ...
    void handleActivityConfigurationChanged(ActivityConfigChangeData data, int displayId) {
        ...
        if (DEBUG_CONFIGURATION || this.mIsDebugTarget) {
            String str = TAG;
    ...
    public static void appDexOptNotify(long start) {
        try {
            ActivityManager.getService().appDexOpt(start > 0);
        } catch (Exception e) {
        } catch (LinkageError e2) {
        }
    }
    ...
    /* synthetic */ void lambda$-android_app_ActivityThread_302017(Configuration globalConfig) {
        synchronized (this.mResourcesManager) {
