...
public class ActivityManager {
    ...
    public static class StackId {
        ...
        public static boolean isDynamicStacksVisibleBehindAllowed(int stackId) {
            return stackId == 4 || stackId == 6 || stackId == 7;
        }
        ...
        public static boolean isTaskResizeableByDockedStack(int stackId) {
            if (!isStaticStack(stackId) || stackId == 2 || stackId == 3 || stackId == 4 || stackId == 6 || stackId == 7) {
                return false;
            }
            return true;
        }
        ...
        public static boolean keepVisibleDeadAppWindowOnScreen(int stackId) {
            return (stackId == 4 || stackId == 7) ? false : true;
        }
        ...
        public static boolean normallyFullscreenWindows(int stackId) {
            if (stackId == 4 || stackId == 2 || stackId == 3 || stackId == 7) {
                return false;
            }
            return true;
        }
    ...
    public static class TaskDescription implements Parcelable {
        ...
        /* synthetic */ TaskDescription(Parcel source, TaskDescription -this1) {
            this(source);
        }
