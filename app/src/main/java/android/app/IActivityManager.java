...
public interface IActivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityManager {
        ...
        static final int TRANSACTION_adjustSplitScreen = 302;
        ...
        static final int TRANSACTION_finishNotOrderReceiver = 300;
        ...
        static final int TRANSACTION_getAllTopPkgName = 305;
        ...
        static final int TRANSACTION_getDockTopAppName = 303;
        static final int TRANSACTION_getFocusedStackId = 211;
        static final int TRANSACTION_getFreeFormAppInfo = 306;
        ...
        static final int TRANSACTION_getTopAppName = 293;
        ...
        static final int TRANSACTION_reportJunkFromApp = 301;
        ...
        static final int TRANSACTION_setOppoKinectActivityController = 294;
        ...
        static final int TRANSACTION_startActivityForFreeform = 304;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_setShowWhenLocked /*292*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getTopAppName /*293*/:
                    data.enforceInterface("android.app.IActivityManager");
                    ...
                    return true;
                case TRANSACTION_setOppoKinectActivityController /*294*/:
                    data.enforceInterface("android.app.IActivityManager");
                ...
                case 301:
                    data.enforceInterface("android.app.IActivityManager");
                    reportJunkFromApp(data.readString(), data.readString(), data.readString(), data.readInt() != 0);
                    return true;
                case 302:
                    data.enforceInterface("android.app.IActivityManager");
