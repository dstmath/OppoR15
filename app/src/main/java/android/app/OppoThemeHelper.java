        ...
        synchronized (OppoThemeHelper.class) {
            ...
            try {
                        ...
                        try {
                            ...
                            if (drawable != null) {
                                try {
                                    ...
                                    Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo.packageName + ": " + e6.getMessage());
                                    return null;
                            ...
                            if (drawable != null) {
                                try {
                                    ((ApplicationPackageManager) packagemanager).putCachedIcon(rName, drawable);
                                } catch (NotFoundException e62) {
                                    Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo.packageName + ": " + e62.getMessage());
                                    return null;
                                } catch (RuntimeException e222) {
                                    Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e222);
                                    return null;
                                }
                            }
                            return drawable;
                ...
                if (drawable != null) {
                    try {
                        ((ApplicationPackageManager) packagemanager).putCachedIcon(rName, drawable);
                    } catch (NotFoundException e622) {
                        Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo.packageName + ": " + e622.getMessage());
                        return null;
                    } catch (RuntimeException e2222) {
                        Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e2222);
                        return null;
                    }
                }
                return drawable;
                ...
                if (drawable != null) {
                    try {
                        ((ApplicationPackageManager) packagemanager).putCachedIcon(rName, drawable);
                    } catch (NotFoundException e6222) {
                        Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo.packageName + ": " + e6222.getMessage());
                        return null;
                    } catch (RuntimeException e22222) {
                        Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e22222);
                        return null;
                    }
                }
                return drawable;
            ...
            if (drawable != null) {
                try {
                    ((ApplicationPackageManager) packagemanager).putCachedIcon(rName, drawable);
                } catch (NotFoundException e62222) {
                    Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo.packageName + ": " + e62222.getMessage());
                    return null;
                } catch (RuntimeException e222222) {
                    Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e222222);
                    return null;
                }
            }
        }
