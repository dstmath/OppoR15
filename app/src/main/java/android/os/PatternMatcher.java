            ...
            while (ip < LP) {
                ...
                switch (c) {
                    ...
                    case ']':
                        ...
                        if (inSet) {
                            if (inRange) {
                                int endOfSet2 = pattern.indexOf(125, ip);
                                if (endOfSet2 >= 0) {
                                    int rangeMax2;
                                    int rangeMin2;
                                    String rangeString2 = pattern.substring(ip, endOfSet2);
                                    int commaIndex2 = rangeString2.indexOf(44);
                                    if (commaIndex2 < 0) {
                                        try {
                                            int parsedRange2 = Integer.parseInt(rangeString2);
                                            rangeMax2 = parsedRange2;
                                            rangeMin2 = parsedRange2;
                                    ...
                                    rangeMin2 = Integer.parseInt(rangeString2.substring(0, commaIndex2));
                                    if (commaIndex2 == rangeString2.length() - 1) {
                                        rangeMax2 = Integer.MAX_VALUE;
                                    } else {
                                        rangeMax2 = Integer.parseInt(rangeString2.substring(commaIndex2 + 1));
                                    }
                                    if (rangeMin2 <= rangeMax2) {
                                        it2 = it + 1;
                                        try {
                                            sParsedPatternScratch[it] = rangeMin2;
                                            it = it2 + 1;
                                            sParsedPatternScratch[it2] = rangeMax2;
                                            ip = endOfSet2;
                                            break;
                    ...
                    case '{':
                        ...
                        if (inSet) {
                            ...
                            int endOfSet22 = pattern.indexOf(125, ip);
                            if (endOfSet22 >= 0) {
                                int rangeMax22;
                                int rangeMin22;
                                String rangeString22 = pattern.substring(ip, endOfSet22);
                                int commaIndex22 = rangeString22.indexOf(44);
                                if (commaIndex22 < 0) {
                                    try {
                                        int parsedRange22 = Integer.parseInt(rangeString22);
                                        rangeMax22 = parsedRange22;
                                        rangeMin22 = parsedRange22;
                                ...
                                rangeMin22 = Integer.parseInt(rangeString22.substring(0, commaIndex22));
                                if (commaIndex22 == rangeString22.length() - 1) {
                                    rangeMax22 = Integer.MAX_VALUE;
                                } else {
                                    rangeMax22 = Integer.parseInt(rangeString22.substring(commaIndex22 + 1));
                                }
                                if (rangeMin22 <= rangeMax22) {
                                    it2 = it + 1;
                                    try {
                                        sParsedPatternScratch[it] = rangeMin22;
                                        it = it2 + 1;
                                        sParsedPatternScratch[it2] = rangeMax22;
                                        ip = endOfSet22;
                                        break;
                    ...
                    case '}':
                        ...
                        if (inSet) {
                            if (inRange) {
                                int endOfSet222 = pattern.indexOf(125, ip);
                                if (endOfSet222 >= 0) {
                                    int rangeMax222;
                                    int rangeMin222;
                                    String rangeString222 = pattern.substring(ip, endOfSet222);
                                    int commaIndex222 = rangeString222.indexOf(44);
                                    if (commaIndex222 < 0) {
                                        try {
                                            int parsedRange222 = Integer.parseInt(rangeString222);
                                            rangeMax222 = parsedRange222;
                                            rangeMin222 = parsedRange222;
                                    ...
                                    rangeMin222 = Integer.parseInt(rangeString222.substring(0, commaIndex222));
                                    if (commaIndex222 == rangeString222.length() - 1) {
                                        rangeMax222 = Integer.MAX_VALUE;
                                    } else {
                                        rangeMax222 = Integer.parseInt(rangeString222.substring(commaIndex222 + 1));
                                    }
                                    if (rangeMin222 <= rangeMax222) {
                                        it2 = it + 1;
                                        try {
                                            sParsedPatternScratch[it] = rangeMin222;
                                            it = it2 + 1;
                                            sParsedPatternScratch[it2] = rangeMax222;
                                            ip = endOfSet222;
                                            break;
                ...
                if (inSet) {
                    ...
                    int endOfSet2222 = pattern.indexOf(125, ip);
                    if (endOfSet2222 >= 0) {
                        int rangeMax2222;
                        int rangeMin2222;
                        String rangeString2222 = pattern.substring(ip, endOfSet2222);
                        int commaIndex2222 = rangeString2222.indexOf(44);
                        if (commaIndex2222 < 0) {
                            try {
                                int parsedRange2222 = Integer.parseInt(rangeString2222);
                                rangeMax2222 = parsedRange2222;
                                rangeMin2222 = parsedRange2222;
                        ...
                        rangeMin2222 = Integer.parseInt(rangeString2222.substring(0, commaIndex2222));
                        if (commaIndex2222 == rangeString2222.length() - 1) {
                            rangeMax2222 = Integer.MAX_VALUE;
                        } else {
                            rangeMax2222 = Integer.parseInt(rangeString2222.substring(commaIndex2222 + 1));
                        }
                        if (rangeMin2222 <= rangeMax2222) {
                            it2 = it + 1;
                            try {
                                sParsedPatternScratch[it] = rangeMin2222;
                                it = it2 + 1;
                                sParsedPatternScratch[it2] = rangeMax2222;
                                ip = endOfSet2222;
                                break;
