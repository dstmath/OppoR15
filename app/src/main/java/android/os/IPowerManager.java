...
public interface IPowerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPowerManager {
        ...
        static final int TRANSACTION_getDefaultScreenBrightnessSetting = 32;
        static final int TRANSACTION_getFrameworksBlockedTime = 36;
        static final int TRANSACTION_getLastShutdownReason = 22;
        static final int TRANSACTION_getMaximumScreenBrightnessSetting = 31;
        static final int TRANSACTION_getMinimumScreenBrightnessSetting = 30;
        static final int TRANSACTION_getPowerSaveState = 14;
        static final int TRANSACTION_getScreenState = 33;
        static final int TRANSACTION_getTopAppBlocked = 37;
        static final int TRANSACTION_goToSleep = 10;
        static final int TRANSACTION_isColorOsPowerSaveMode = 34;
        ...
        static final int TRANSACTION_setColorOsPowerSaveMode = 35;
