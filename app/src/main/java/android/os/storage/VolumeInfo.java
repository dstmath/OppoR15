...
public class VolumeInfo implements Parcelable {
    ...
    static {
        ...
        sStateToDescrip.put(0, 17039880);
        sStateToDescrip.put(1, 17039872);
        sStateToDescrip.put(2, 17039876);
        sStateToDescrip.put(3, 17039877);
        sStateToDescrip.put(4, 17039874);
        sStateToDescrip.put(5, 17039873);
        sStateToDescrip.put(6, 17039879);
        sStateToDescrip.put(7, 17039878);
        sStateToDescrip.put(8, 17039871);
    }
    ...
    public String getDescription() {
        if (ID_PRIVATE_INTERNAL.equals(this.id) || ID_EMULATED_INTERNAL.equals(this.id)) {
            return Resources.getSystem().getString(17040936);
        }
