...
public class SurfaceView extends View implements WindowStoppedCallback {
    ...
    public SurfaceView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSurfaceHolder = new SurfaceHolder() {
            ...
            /* synthetic */ void lambda$-android_view_SurfaceView$3_42869(boolean screenOn) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (!(this.mSurfaceControl == null || (this.mSurfaceCreated ^ 1) == 0)) {
                                ...
                                if (!(this.mWindowStopped || viewRoot.getTitle() == null || (viewRoot.getTitle().toString().contains("com.oppo.camera") ^ 1) == 0)) {
                                    this.mSurfaceControl.destroy();
                                    this.mSurfaceControl = null;
                                }
                            }
    ...
    /* synthetic */ void lambda$-android_view_SurfaceView_34602() {
        performDrawFinished();
    }
