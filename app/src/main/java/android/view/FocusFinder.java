...
public class FocusFinder {
    ...
    static final class FocusSorter {
        ...
        /* synthetic */ int lambda$-android_view_FocusFinder$FocusSorter_31343(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        /* synthetic */ int lambda$-android_view_FocusFinder$FocusSorter_31803(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = (Rect) this.mRectByView.get(first);
    ...
    static /* synthetic */ View lambda$-android_view_FocusFinder_1877(View r, View v) {
        return isValidId(v.getNextFocusForwardId()) ? v.findUserSetNextFocus(r, 2) : null;
    }

    static /* synthetic */ View lambda$-android_view_FocusFinder_2135(View r, View v) {
