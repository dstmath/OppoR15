...
public final class ViewRootImpl implements ViewParent, Callbacks, DrawCallbacks {
    ...
    static class W extends Stub {
        @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@ROM.SDK, 2016-03-03 : [-private] Modify for Longshot", property = OppoRomType.ROM)
        ...
        if (host != null && (this.mAdded ^ 1) == 0) {
            ...
            if (didLayout) {
                ...
                if ((host.mPrivateFlags & 512) != 0) {
                    ...
                    if ((host instanceof ViewGroup) && getChildCount((ViewGroup) host) < 10) {
                        try {
