...
public class ColorLongshotViewHelper implements IColorLongshotWindow {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (viewAncestor == null) {
                        ColorLog.e("LongshotDump", "longshotDump : viewAncestor is null");
                        return;
                        ...
                        ColorLog.e("LongshotDump", "longshotDump : viewAncestor.mView is null");
                        return;
                    }
                default:
                    return;
    ...
    public void longshotNotifyConnected(boolean isConnected) {
        ...
        if (viewAncestor != null && viewAncestor.mView != null) {
            viewAncestor.mViewRootHooks.getLongshotViewRoot().setLongshotConnected(isConnected);
        }
    }
    ...
    public void longshotDump(FileDescriptor fd, List<ColorWindowNode> systemWindows, List<ColorWindowNode> floatWindows) {
        try {
            ...
            ColorLog.e("LongshotDump", "dumpViewHierarchy failed : " + e);
        }
    }
