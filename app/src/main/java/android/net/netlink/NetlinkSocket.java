    ...
    public static void sendOneShotKernelMessage(int nlProto, byte[] msg) throws ErrnoException {
        ...
        try {
            ...
            try {
                ...
                throw new ErrnoException("Error in NetlinkSocket.sendOneShotKernelMessage", OsConstants.ETIMEDOUT, e3);
            } catch (SocketException e22) {
                Log.e(TAG, "Error in NetlinkSocket.sendOneShotKernelMessage", e22);
                throw new ErrnoException("Error in NetlinkSocket.sendOneShotKernelMessage", OsConstants.EIO, e22);
            }
        }
    }
