...
public class WifiConfiguration implements Parcelable {
    ...
    public static class KeyMgmt {
        ...
        public static final String[] strings = new String[]{"NONE", "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN", "FT_PSK", "FT_EAP", "FILS_SHA256", "FILS_SHA384", "WAPI_PSK", "WAPI_CERT"};
    ...
    public int getAuthType() {
        if (this.allowedKeyManagement.cardinality() > 1) {
            if (!this.allowedKeyManagement.get(10) || !this.allowedKeyManagement.get(11)) {
    ...
    public static String configKey(ScanResult result) {
        ...
        if (result.capabilities.contains("WAPI-KEY")) {
            return key + "-" + KeyMgmt.strings[10];
        }
        if (result.capabilities.contains("WAPI-CERT")) {
            return key + "-" + KeyMgmt.strings[11];
        }
    ...
    public String configKey(boolean allowCached) {
        ...
        if (this.allowedKeyManagement.get(1)) {
            ...
            key = key + "-" + KeyMgmt.strings[10];
        } else if (this.allowedKeyManagement.get(11)) {
            key = key + "-" + KeyMgmt.strings[11];
        } else {
