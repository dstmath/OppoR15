        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 41:
                    ...
                    ParcelFileDescriptor _result16 = establishVpn(_arg06);
                    reply.writeNoException();
                    if (_result16 != null) {
                        reply.writeInt(1);
                ...
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    VpnConfig _result17 = getVpnConfig(data.readInt());
                    reply.writeNoException();
                    if (_result17 != null) {
                        reply.writeInt(1);
                ...
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    LegacyVpnInfo _result18 = getLegacyVpnInfo(data.readInt());
                    reply.writeNoException();
                    if (_result18 != null) {
                        reply.writeInt(1);
                ...
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    VpnInfo[] _result19 = getAllVpnInfo();
                    reply.writeNoException();
                ...
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    double _result20 = getTelephonyPowerLost();
                    reply.writeNoException();
