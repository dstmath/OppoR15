...
public class ApfFilter {
    ...
    private final String mBpfProgram = "(000) ld       [2]\n(001) jeq      #0xffffffff      jt 2    jf 4\n(002) ldh      [0]\n(003) jeq      #0xffff          jt 52   jf 4\n(004) ldh      [12]\n(005) jeq      #0x86dd          jt 6    jf 14\n(006) ldb      [38]\n(007) jeq      #0xff            jt 52   jf 8\n(008) ldb      [20]\n(009) jeq      #0x84            jt 12   jf 10\n(010) jeq      #0x6             jt 12   jf 11\n(011) jeq      #0x11            jt 12   jf 39\n(012) ldh      [56]\n(013) jge      #0x89            jt 30   jf 39\n(014) jeq      #0x800           jt 15   jf 32\n(015) ld       [30]\n(016) jeq      #0x0             jt 52   jf 17\n(017) jeq      #0xffffffff      jt 52   jf 18\n(018) jeq      #0xe00000fb      jt 52   jf 19\n(019) jeq      #0xe00000fc      jt 52   jf 20\n(020) jeq      #0xeffffffa      jt 52   jf 21\n(021) ldb      [23]\n(022) jeq      #0x84            jt 25   jf 23\n(023) jeq      #0x6             jt 25   jf 24\n(024) jeq      #0x11            jt 25   jf 31\n(025) ldh      [20]\n(026) jset     #0x1fff          jt 39   jf 27\n(027) ldxb     4*([14]&0xf)\n(028) ldh      [x + 16]\n(029) jge      #0x89            jt 30   jf 39\n(030) jgt      #0x8b            jt 39   jf 52\n(031) jeq      #0x2             jt 52   jf 39\n(032) jeq      #0x806           jt 34   jf 33\n(033) jeq      #0x8035          jt 34   jf 38\n(034) ld       [38]\n(035) jeq      #0xe00000fb      jt 52   jf 36\n(036) jeq      #0xe00000fc      jt 52   jf 37\n(037) jeq      #0xeffffffa      jt 52   jf 39\n(038) jeq      #0xbeef          jt 52   jf 39\n(039) ldh      [12]\n(040) jgt      #0x5dc           jt 44   jf 41\n(041) ldb      [14]\n(042) jeq      #0x27            jt 52   jf 43\n(043) jeq      #0xc6            jt 52   jf 44\n(044) ldh      [4]\n(045) jeq      #0xc             jt 52   jf 46\n(046) ld       [8]\n(047) jeq      #0x1af81         jt 52   jf 48\n(048) ldh      [12]\n(049) jeq      #0x800           jt 50   jf 53\n(050) ldb      [33]\n(051) jeq      #0xff            jt 52   jf 53\n(052) ret      #0\n(053) ret      #262144\n";
