...
public class DhcpClient extends StateMachine {
    ...
    private boolean sendDiscoverPacket() {
        return transmitPacket(DhcpPacket.buildDiscoverPacket(0, this.mTransactionId, getSecs(), this.mHwAddr, false, REQUESTED_PARAMS, this.mRapidCommit), "DHCPDISCOVER", 0, DhcpPacket.INADDR_BROADCAST);
    }
