            ...
            try {
                ...
                try {
                    ...
                    if (bufferedinputstream != null) {
                        try {
                            ...
                            Log.e(TAG, "bufferedinputstream IOException happened when loadThemeValues, msg = " + e2222222.getMessage());
                        }
                    }
                    if (inputStream != null) {
                        try {
                            ...
                            Log.e(TAG, "in IOException happened when loadThemeValues, msg = " + e22222222.getMessage());
                        }
                    }
                    throw th;
                }
                ...
                if (bufferedinputstream != null) {
                    try {
                        ...
                        Log.e(TAG, "bufferedinputstream IOException happened when loadThemeValues, msg = " + e222222222.getMessage());
                    }
                }
                if (inputStream != null) {
                    try {
                        ...
                        Log.e(TAG, "in IOException happened when loadThemeValues, msg = " + e2222222222.getMessage());
                    }
                }
            }
        }
